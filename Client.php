...
namespace vip9008\googleapisclient;

use vip9008\googleapisclient\auth\AuthAbstract;
use vip9008\googleapisclient\io\Curl;
use vip9008\googleapisclient\Config;
...
class Client
{
  ...
  public function __construct($config = null)
  {
    ...
    if ($config->getIoClass() == Config::USE_AUTO_IO_SELECTION) {
      if (function_exists('curl_version') && function_exists('curl_exec')
          && !$this->isAppEngine()) {
        $config->setIoClass("Curl");
      } else {
        $config->setIoClass("Stream");
      }
    }
   ...
   * @param Abstract $io
   */
  public function setIo(AuthAbstract $io)
  {
   ...
   * @param Abstract $cache
   */
  public function setCache(AuthAbstract $cache)
  {
   ...
   * @param Abstract $logger
   */
  public function setLogger(AuthAbstract $logger)
  {
  ...
  /**
   * @return Abstract IO implementation
   */
  public function getIo()
  {
    if (!isset($this->io)) {
      $class = __NAMESPACE__.'\\io\\'.$this->config->getIoClass();
  ...
  /**
   * @return Abstract Logger implementation
   */
  public function getLogger()
  {
    if (!isset($this->logger)) {
      $class = __NAMESPACE__.'\\logger\\'.$this->config->getLoggerClass();

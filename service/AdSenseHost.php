...
class AdSenseHost extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->accounts = new AdSenseHost_Accounts_Resource(
        $this,
        $this->serviceName,
        'accounts',
        array(
    ...
    $this->accounts_adclients = new AdSenseHost_AccountsAdclients_Resource(
        $this,
        $this->serviceName,
        'adclients',
        array(
    ...
    $this->accounts_adunits = new AdSenseHost_AccountsAdunits_Resource(
        $this,
        $this->serviceName,
        'adunits',
        array(
    ...
    $this->accounts_reports = new AdSenseHost_AccountsReports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
    ...
    $this->adclients = new AdSenseHost_Adclients_Resource(
        $this,
        $this->serviceName,
        'adclients',
        array(
    ...
    $this->associationsessions = new AdSenseHost_Associationsessions_Resource(
        $this,
        $this->serviceName,
        'associationsessions',
        array(
    ...
    $this->customchannels = new AdSenseHost_Customchannels_Resource(
        $this,
        $this->serviceName,
        'customchannels',
        array(
    ...
    $this->reports = new AdSenseHost_Reports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
    ...
    $this->urlchannels = new AdSenseHost_Urlchannels_Resource(
        $this,
        $this->serviceName,
        'urlchannels',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adsensehostService = new AdSenseHost(...);
 *   $accounts = $adsensehostService->accounts;
 *  </code>
 */
class AdSenseHost_Accounts_Resource extends Resource
{
   ...
   * @return AdSenseHost_Account
   */
  public function get($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AdSenseHost_Account");
  }
 ...
 *  </code>
 */
class AdSenseHost_AccountsAdclients_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return AdSenseHost_AdClient
   */
  public function get($accountId, $adClientId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'adClientId' => $adClientId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AdSenseHost_AdClient");
  }
   ...
   * @return AdSenseHost_AdClients
   */
  public function listAccountsAdclients($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AdSenseHost_AdClients");
  }
}
/**
 ...
 *  </code>
 */
class AdSenseHost_AccountsAdunits_Resource extends Resource
{
  ...
  public function get($accountId, $adClientId, $adUnitId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'adUnitId' => $adUnitId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AdSenseHost_AdUnit");
  }
   ...
   * code.
   * @return AdSenseHost_AdCode
   */
  public function getAdCode($accountId, $adClientId, $adUnitId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'adUnitId' => $adUnitId);
    $params = array_merge($params, $optParams);
    return $this->call('getAdCode', array($params), "AdSenseHost_AdCode");
  }
   ...
   * @return AdSenseHost_AdUnit
   */
  public function insert($accountId, $adClientId, AdSenseHost_AdUnit $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AdSenseHost_AdUnit");
  }
   ...
   * @return AdSenseHost_AdUnits
   */
  public function listAccountsAdunits($accountId, $adClientId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'adClientId' => $adClientId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AdSenseHost_AdUnits");
  }
   ...
   * @return AdSenseHost_AdUnit
   */
  public function patch($accountId, $adClientId, $adUnitId, AdSenseHost_AdUnit $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'adUnitId' => $adUnitId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AdSenseHost_AdUnit");
  }
   ...
   * @return AdSenseHost_AdUnit
   */
  public function update($accountId, $adClientId, AdSenseHost_AdUnit $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AdSenseHost_AdUnit");
  }
}
/**
 ...
 *  </code>
 */
class AdSenseHost_AccountsReports_Resource extends Resource
{
   ...
   * @return AdSenseHost_Report
   */
  public function generate($accountId, $startDate, $endDate, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'startDate' => $startDate, 'endDate' => $endDate);
    $params = array_merge($params, $optParams);
    return $this->call('generate', array($params), "AdSenseHost_Report");
  }
}
 ...
 *  </code>
 */
class AdSenseHost_Adclients_Resource extends Resource
{
 ...
 *  </code>
 */
class AdSenseHost_Associationsessions_Resource extends Resource
{
  ...
  public function verify($token, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('verify', array($params), "AdSenseHost_AssociationSession");
  }
}
 ...
 *  </code>
 */
class AdSenseHost_Customchannels_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return AdSenseHost_CustomChannel
   */
  public function delete($adClientId, $customChannelId, $optParams = array())
  {
    $params = array('adClientId' => $adClientId, 'customChannelId' => $customChannelId);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "AdSenseHost_CustomChannel");
  }
  ...
  public function get($adClientId, $customChannelId, $optParams = array())
  {
    $params = array('adClientId' => $adClientId, 'customChannelId' => $customChannelId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AdSenseHost_CustomChannel");
  }
   ...
   * @return AdSenseHost_CustomChannel
   */
  public function insert($adClientId, AdSenseHost_CustomChannel $postBody, $optParams = array())
  {
    $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AdSenseHost_CustomChannel");
  }
   ...
   * @return AdSenseHost_CustomChannels
   */
  public function listCustomchannels($adClientId, $optParams = array())
  {
    $params = array('adClientId' => $adClientId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AdSenseHost_CustomChannels");
  }
   ...
   * @return AdSenseHost_CustomChannel
   */
  public function patch($adClientId, $customChannelId, AdSenseHost_CustomChannel $postBody, $optParams = array())
  {
    $params = array('adClientId' => $adClientId, 'customChannelId' => $customChannelId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AdSenseHost_CustomChannel");
  }
   ...
   * @return AdSenseHost_CustomChannel
   */
  public function update($adClientId, AdSenseHost_CustomChannel $postBody, $optParams = array())
  {
    $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AdSenseHost_CustomChannel");
  }
}
 ...
 *  </code>
 */
class AdSenseHost_Reports_Resource extends Resource
{
 ...
 *  </code>
 */
class AdSenseHost_Urlchannels_Resource extends Resource
{
  ...
  public function delete($adClientId, $urlChannelId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "AdSenseHost_UrlChannel");
  }
   ...
   * @return AdSenseHost_UrlChannel
   */
  public function insert($adClientId, AdSenseHost_UrlChannel $postBody, $optParams = array())
  {
    $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AdSenseHost_UrlChannel");
  }
   ...
   * the response, used for paging.
   * @return AdSenseHost_UrlChannels
   */
  public function listUrlchannels($adClientId, $optParams = array())
  {
    $params = array('adClientId' => $adClientId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AdSenseHost_UrlChannels");
  }
}
...
class AdSenseHost_Account extends Model
{
...
class AdSenseHost_Accounts extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AdSenseHost_Account';
...
class AdSenseHost_AdClient extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $arcOptIn;
...
class AdSenseHost_AdClients extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AdSenseHost_AdClient';
  protected $itemsDataType = 'array';
  public $kind;
...
class AdSenseHost_AdCode extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $adCode;
...
class AdSenseHost_AdStyle extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $colorsType = 'AdSenseHost_AdStyleColors';
  protected $colorsDataType = '';
  public $corners;
  protected $fontType = 'AdSenseHost_AdStyleFont';
  protected $fontDataType = '';
  public $kind;


  public function setColors(AdSenseHost_AdStyleColors $colors)
  {
    $this->colors = $colors;
  }
  ...
  public function setFont(AdSenseHost_AdStyleFont $font)
  {
    $this->font = $font;
  }
...
class AdSenseHost_AdStyleColors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $background;
...
class AdSenseHost_AdStyleFont extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $family;
...
class AdSenseHost_AdUnit extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
  protected $contentAdsSettingsType = 'AdSenseHost_AdUnitContentAdsSettings';
  protected $contentAdsSettingsDataType = '';
  protected $customStyleType = 'AdSenseHost_AdStyle';
  protected $customStyleDataType = '';
  public $id;
  public $kind;
  protected $mobileContentAdsSettingsType = 'AdSenseHost_AdUnitMobileContentAdsSettings';
  ...
  public function setContentAdsSettings(AdSenseHost_AdUnitContentAdsSettings $contentAdsSettings)
  {
  ...
  public function setCustomStyle(AdSenseHost_AdStyle $customStyle)
  {
  ...
  public function setMobileContentAdsSettings(AdSenseHost_AdUnitMobileContentAdsSettings $mobileContentAdsSettings)
  {
...
class AdSenseHost_AdUnitContentAdsSettings extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $backupOptionType = 'AdSenseHost_AdUnitContentAdsSettingsBackupOption';
  protected $backupOptionDataType = '';
  public $size;
  public $type;


  public function setBackupOption(AdSenseHost_AdUnitContentAdsSettingsBackupOption $backupOption)
  {
...
class AdSenseHost_AdUnitContentAdsSettingsBackupOption extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $color;
...
class AdSenseHost_AdUnitMobileContentAdsSettings extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class AdSenseHost_AdUnits extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AdSenseHost_AdUnit';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class AdSenseHost_AssociationSession extends Collection
{
...
class AdSenseHost_CustomChannel extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class AdSenseHost_CustomChannels extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AdSenseHost_CustomChannel';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class AdSenseHost_Report extends Collection
{
  protected $collection_key = 'warnings';
  protected $internal_gapi_mappings = array(
  );
  public $averages;
  protected $headersType = 'AdSenseHost_ReportHeaders';
...
class AdSenseHost_ReportHeaders extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $currency;
...
class AdSenseHost_UrlChannel extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class AdSenseHost_UrlChannels extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AdSenseHost_UrlChannel';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;

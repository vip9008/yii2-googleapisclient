...
class Admin extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->mail = new Admin_Mail_Resource(
        $this,
        $this->serviceName,
        'mail',
        array(
 ...
 *  </code>
 */
class Admin_Mail_Resource extends Resource
{
   ...
   */
  public function insert($userKey, Admin_MailItem $postBody, $optParams = array())
  {
...
class Admin_MailItem extends Collection
{

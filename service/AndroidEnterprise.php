 ...
 * @author Google, Inc.
 */
class AndroidEnterprise extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->collections = new AndroidEnterprise_Collections_Resource(
        $this,
        $this->serviceName,
        'collections',
        array(
    ...
    $this->collectionviewers = new AndroidEnterprise_Collectionviewers_Resource(
        $this,
        $this->serviceName,
        'collectionviewers',
        array(
    ...
    $this->devices = new AndroidEnterprise_Devices_Resource(
        $this,
        $this->serviceName,
        'devices',
        array(
    ...
    $this->enterprises = new AndroidEnterprise_Enterprises_Resource(
        $this,
        $this->serviceName,
        'enterprises',
        array(
    ...
    $this->entitlements = new AndroidEnterprise_Entitlements_Resource(
        $this,
        $this->serviceName,
        'entitlements',
        array(
    ...
    $this->grouplicenses = new AndroidEnterprise_Grouplicenses_Resource(
        $this,
        $this->serviceName,
        'grouplicenses',
        array(
    ...
    $this->grouplicenseusers = new AndroidEnterprise_Grouplicenseusers_Resource(
        $this,
        $this->serviceName,
        'grouplicenseusers',
        array(
    ...
    $this->installs = new AndroidEnterprise_Installs_Resource(
        $this,
        $this->serviceName,
        'installs',
        array(
    ...
    $this->permissions = new AndroidEnterprise_Permissions_Resource(
        $this,
        $this->serviceName,
        'permissions',
        array(
    ...
    $this->products = new AndroidEnterprise_Products_Resource(
        $this,
        $this->serviceName,
        'products',
        array(
    ...
    $this->users = new AndroidEnterprise_Users_Resource(
        $this,
        $this->serviceName,
        'users',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $androidenterpriseService = new AndroidEnterprise(...);
 *   $collections = $androidenterpriseService->collections;
 *  </code>
 */
class AndroidEnterprise_Collections_Resource extends Resource
{
   ...
   * @param string $collectionId The ID of the collection.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_Collection
   */
  public function get($enterpriseId, $collectionId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'collectionId' => $collectionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_Collection");
  }
   ...
   * @return AndroidEnterprise_Collection
   */
  public function insert($enterpriseId, AndroidEnterprise_Collection $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AndroidEnterprise_Collection");
  }
   ...
   * @param string $enterpriseId The ID of the enterprise.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_CollectionsListResponse
   */
  public function listCollections($enterpriseId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_CollectionsListResponse");
  }
   ...
   * @return AndroidEnterprise_Collection
   */
  public function patch($enterpriseId, $collectionId, AndroidEnterprise_Collection $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'collectionId' => $collectionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AndroidEnterprise_Collection");
  }
   ...
   * @return AndroidEnterprise_Collection
   */
  public function update($enterpriseId, $collectionId, AndroidEnterprise_Collection $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'collectionId' => $collectionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AndroidEnterprise_Collection");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Collectionviewers_Resource extends Resource
{
   ...
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_User
   */
  public function get($enterpriseId, $collectionId, $userId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'collectionId' => $collectionId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_User");
  }
   ...
   * @param string $collectionId The ID of the collection.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_CollectionViewersListResponse
   */
  public function listCollectionviewers($enterpriseId, $collectionId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'collectionId' => $collectionId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_CollectionViewersListResponse");
  }
   ...
   * @return AndroidEnterprise_User
   */
  public function patch($enterpriseId, $collectionId, $userId, AndroidEnterprise_User $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'collectionId' => $collectionId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AndroidEnterprise_User");
  }
   ...
   * @return AndroidEnterprise_User
   */
  public function update($enterpriseId, $collectionId, $userId, AndroidEnterprise_User $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'collectionId' => $collectionId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AndroidEnterprise_User");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Devices_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_Device
   */
  public function get($enterpriseId, $userId, $deviceId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_Device");
  }
   ...
   * @param string $deviceId The ID of the device.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_DeviceState
   */
  public function getState($enterpriseId, $userId, $deviceId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'deviceId' => $deviceId);
    $params = array_merge($params, $optParams);
    return $this->call('getState', array($params), "AndroidEnterprise_DeviceState");
  }
   ...
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_DevicesListResponse
   */
  public function listDevices($enterpriseId, $userId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_DevicesListResponse");
  }
   ...
   * @return AndroidEnterprise_DeviceState
   */
  public function setState($enterpriseId, $userId, $deviceId, AndroidEnterprise_DeviceState $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'deviceId' => $deviceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setState', array($params), "AndroidEnterprise_DeviceState");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Enterprises_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_Enterprise
   */
  public function enroll($token, AndroidEnterprise_Enterprise $postBody, $optParams = array())
  {
    $params = array('token' => $token, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('enroll', array($params), "AndroidEnterprise_Enterprise");
  }
  ...
  public function get($enterpriseId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_Enterprise");
  }
   ...
   * @return AndroidEnterprise_Enterprise
   */
  public function insert($token, AndroidEnterprise_Enterprise $postBody, $optParams = array())
  {
    $params = array('token' => $token, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AndroidEnterprise_Enterprise");
  }
   ...
   * up.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_EnterprisesListResponse
   */
  public function listEnterprises($domain, $optParams = array())
  {
    $params = array('domain' => $domain);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_EnterprisesListResponse");
  }
   ...
   * @param string $enterpriseId The ID of the enterprise.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_EnterprisesSendTestPushNotificationResponse
   */
  public function sendTestPushNotification($enterpriseId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId);
    $params = array_merge($params, $optParams);
    return $this->call('sendTestPushNotification', array($params), "AndroidEnterprise_EnterprisesSendTestPushNotificationResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_EnterpriseAccount
   */
  public function setAccount($enterpriseId, AndroidEnterprise_EnterpriseAccount $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setAccount', array($params), "AndroidEnterprise_EnterpriseAccount");
  }
 ...
 *  </code>
 */
class AndroidEnterprise_Entitlements_Resource extends Resource
{
   ...
   * "app:com.google.android.gm".
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_Entitlement
   */
  public function get($enterpriseId, $userId, $entitlementId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'entitlementId' => $entitlementId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_Entitlement");
  }
   ...
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_EntitlementsListResponse
   */
  public function listEntitlements($enterpriseId, $userId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_EntitlementsListResponse");
  }
   ...
   * @return AndroidEnterprise_Entitlement
   */
  public function patch($enterpriseId, $userId, $entitlementId, AndroidEnterprise_Entitlement $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'entitlementId' => $entitlementId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AndroidEnterprise_Entitlement");
  }
   ...
   * @return AndroidEnterprise_Entitlement
   */
  public function update($enterpriseId, $userId, $entitlementId, AndroidEnterprise_Entitlement $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'entitlementId' => $entitlementId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AndroidEnterprise_Entitlement");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Grouplicenses_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_GroupLicense
   */
  public function get($enterpriseId, $groupLicenseId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_GroupLicense");
  }
   ...
   * @param string $enterpriseId The ID of the enterprise.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_GroupLicensesListResponse
   */
  public function listGrouplicenses($enterpriseId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_GroupLicensesListResponse");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Grouplicenseusers_Resource extends Resource
{
   ...
   * e.g. "app:com.google.android.gm".
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_GroupLicenseUsersListResponse
   */
  public function listGrouplicenseusers($enterpriseId, $groupLicenseId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'groupLicenseId' => $groupLicenseId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_GroupLicenseUsersListResponse");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Installs_Resource extends Resource
{
   ...
   * e.g. "app:com.google.android.gm".
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_Install
   */
  public function get($enterpriseId, $userId, $deviceId, $installId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'deviceId' => $deviceId, 'installId' => $installId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_Install");
  }
   ...
   * @param string $deviceId The Android ID of the device.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_InstallsListResponse
   */
  public function listInstalls($enterpriseId, $userId, $deviceId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'deviceId' => $deviceId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_InstallsListResponse");
  }
   ...
   * @return AndroidEnterprise_Install
   */
  public function patch($enterpriseId, $userId, $deviceId, $installId, AndroidEnterprise_Install $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'deviceId' => $deviceId, 'installId' => $installId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AndroidEnterprise_Install");
  }
   ...
   * @return AndroidEnterprise_Install
   */
  public function update($enterpriseId, $userId, $deviceId, $installId, AndroidEnterprise_Install $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'deviceId' => $deviceId, 'installId' => $installId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AndroidEnterprise_Install");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Permissions_Resource extends Resource
{
   ...
   * (e.g. "en-US", "de")
   * @return AndroidEnterprise_Permission
   */
  public function get($permissionId, $optParams = array())
  {
    $params = array('permissionId' => $permissionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_Permission");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Products_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function approve($enterpriseId, $productId, AndroidEnterprise_ProductsApproveRequest $postBody, $optParams = array())
  {
   ...
   * @return AndroidEnterprise_ProductsGenerateApprovalUrlResponse
   */
  public function generateApprovalUrl($enterpriseId, $productId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('generateApprovalUrl', array($params), "AndroidEnterprise_ProductsGenerateApprovalUrlResponse");
  }
   ...
   * @opt_param string language The BCP47 tag for the user's preferred language
   * (e.g. "en-US", "de").
   * @return AndroidEnterprise_Product
   */
  public function get($enterpriseId, $productId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'productId' => $productId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AndroidEnterprise_Product");
  }
   ...
   * @opt_param string language The BCP47 tag for the user's preferred language
   * (e.g. "en-US", "de").
   * @return AndroidEnterprise_AppRestrictionsSchema
   */
  public function getAppRestrictionsSchema($enterpriseId, $productId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'productId' => $productId);
    $params = array_merge($params, $optParams);
    return $this->call('getAppRestrictionsSchema', array($params), "AndroidEnterprise_AppRestrictionsSchema");
  }
   ...
   * @param string $productId The ID of the product.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_ProductPermissions
   */
  public function getPermissions($enterpriseId, $productId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'productId' => $productId);
    $params = array_merge($params, $optParams);
    return $this->call('getPermissions', array($params), "AndroidEnterprise_ProductPermissions");
  }
   ...
   * @return AndroidEnterprise_ProductPermissions
   */
  public function updatePermissions($enterpriseId, $productId, AndroidEnterprise_ProductPermissions $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'productId' => $productId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('updatePermissions', array($params), "AndroidEnterprise_ProductPermissions");
  }
}
 ...
 *  </code>
 */
class AndroidEnterprise_Users_Resource extends Resource
{
   ...
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_UserToken
   */
  public function generateToken($enterpriseId, $userId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('generateToken', array($params), "AndroidEnterprise_UserToken");
  }
   ...
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_ProductSet
   */
  public function getAvailableProductSet($enterpriseId, $userId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('getAvailableProductSet', array($params), "AndroidEnterprise_ProductSet");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return AndroidEnterprise_UsersListResponse
   */
  public function listUsers($enterpriseId, $email, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'email' => $email);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AndroidEnterprise_UsersListResponse");
  }
   ...
   * @return AndroidEnterprise_ProductSet
   */
  public function setAvailableProductSet($enterpriseId, $userId, AndroidEnterprise_ProductSet $postBody, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setAvailableProductSet', array($params), "AndroidEnterprise_ProductSet");
  }
}
...
class AndroidEnterprise_AppRestrictionsSchema extends Collection
{
  protected $collection_key = 'restrictions';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $restrictionsType = 'AndroidEnterprise_AppRestrictionsSchemaRestriction';
...
class AndroidEnterprise_AppRestrictionsSchemaRestriction extends Collection
{
  protected $collection_key = 'entryValue';
  protected $internal_gapi_mappings = array(
  );
  protected $defaultValueType = 'AndroidEnterprise_AppRestrictionsSchemaRestrictionRestrictionValue';
  ...
  public function setDefaultValue(AndroidEnterprise_AppRestrictionsSchemaRestrictionRestrictionValue $defaultValue)
  {
...
class AndroidEnterprise_AppRestrictionsSchemaRestrictionRestrictionValue extends Collection
{
...
class AndroidEnterprise_AppVersion extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $versionCode;
...
class AndroidEnterprise_ApprovalUrlInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $approvalUrl;
...
class AndroidEnterprise_Collection extends Collection
{
...
class AndroidEnterprise_CollectionViewersListResponse extends Collection
{
  protected $collection_key = 'user';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $userType = 'AndroidEnterprise_User';
...
class AndroidEnterprise_CollectionsListResponse extends Collection
{
  protected $collection_key = 'collection';
  protected $internal_gapi_mappings = array(
  );
  protected $collectionType = 'AndroidEnterprise_Collection';
...
class AndroidEnterprise_Device extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $androidId;
...
class AndroidEnterprise_DeviceState extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accountState;
...
class AndroidEnterprise_DevicesListResponse extends Collection
{
  protected $collection_key = 'device';
  protected $internal_gapi_mappings = array(
  );
  protected $deviceType = 'AndroidEnterprise_Device';
...
class AndroidEnterprise_Enterprise extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class AndroidEnterprise_EnterpriseAccount extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accountEmail;
...
class AndroidEnterprise_EnterprisesListResponse extends Collection
{
  protected $collection_key = 'enterprise';
  protected $internal_gapi_mappings = array(
  );
  protected $enterpriseType = 'AndroidEnterprise_Enterprise';
...
class AndroidEnterprise_EnterprisesSendTestPushNotificationResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $messageId;
...
class AndroidEnterprise_Entitlement extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class AndroidEnterprise_EntitlementsListResponse extends Collection
{
  protected $collection_key = 'entitlement';
  protected $internal_gapi_mappings = array(
  );
  protected $entitlementType = 'AndroidEnterprise_Entitlement';
...
class AndroidEnterprise_GroupLicense extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class AndroidEnterprise_GroupLicenseUsersListResponse extends Collection
{
  protected $collection_key = 'user';
  protected $internal_gapi_mappings = array(
  );
...
class AndroidEnterprise_GroupLicensesListResponse extends Collection
{
  protected $collection_key = 'groupLicense';
  protected $internal_gapi_mappings = array(
  );
  protected $groupLicenseType = 'AndroidEnterprise_GroupLicense';
...
class AndroidEnterprise_Install extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $installState;
...
class AndroidEnterprise_InstallsListResponse extends Collection
{
  protected $collection_key = 'install';
  protected $internal_gapi_mappings = array(
  );
  protected $installType = 'AndroidEnterprise_Install';
...
class AndroidEnterprise_Permission extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class AndroidEnterprise_Product extends Collection
{
  protected $collection_key = 'appVersion';
  protected $internal_gapi_mappings = array(
  );
  protected $appVersionType = 'AndroidEnterprise_AppVersion';
...
class AndroidEnterprise_ProductPermission extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $permissionId;
...
class AndroidEnterprise_ProductPermissions extends Collection
{
  protected $collection_key = 'permission';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $permissionType = 'AndroidEnterprise_ProductPermission';
...
class AndroidEnterprise_ProductSet extends Collection
{
  protected $collection_key = 'productId';
  protected $internal_gapi_mappings = array(
  );
...
class AndroidEnterprise_ProductsApproveRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $approvalUrlInfoType = 'AndroidEnterprise_ApprovalUrlInfo';
  protected $approvalUrlInfoDataType = '';


  public function setApprovalUrlInfo(AndroidEnterprise_ApprovalUrlInfo $approvalUrlInfo)
  {
...
class AndroidEnterprise_ProductsGenerateApprovalUrlResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $url;
...
class AndroidEnterprise_User extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class AndroidEnterprise_UserToken extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class AndroidEnterprise_UsersListResponse extends Collection
{
  protected $collection_key = 'user';
  protected $internal_gapi_mappings = array(
  );

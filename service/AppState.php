 ...
 * @author Google, Inc.
 */
class AppState extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->states = new AppState_States_Resource(
        $this,
        $this->serviceName,
        'states',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appstateService = new AppState(...);
 *   $states = $appstateService->states;
 *  </code>
 */
class AppState_States_Resource extends Resource
{
   ...
   * @return AppState_WriteResult
   */
  public function clear($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('clear', array($params), "AppState_WriteResult");
  }
   ...
   * @param int $stateKey The key for the data to be retrieved.
   * @param array $optParams Optional parameters.
   * @return AppState_GetResponse
   */
  public function get($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AppState_GetResponse");
  }
   ...
   * the version number
   * @return AppState_ListResponse
   */
  public function listStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AppState_ListResponse");
  }
   ...
   * @return AppState_WriteResult
   */
  public function update($stateKey, AppState_UpdateRequest $postBody, $optParams = array())
  {
    $params = array('stateKey' => $stateKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AppState_WriteResult");
  }
}
...
class AppState_GetResponse extends Model
{
...
class AppState_ListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'AppState_GetResponse';
...
class AppState_UpdateRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $data;
...
class AppState_WriteResult extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $currentStateVersion;

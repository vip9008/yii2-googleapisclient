 ...
 * @author Google, Inc.
 */
class Appsactivity extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->activities = new Appsactivity_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appsactivityService = new Appsactivity(...);
 *   $activities = $appsactivityService->activities;
 *  </code>
 */
class Appsactivity_Activities_Resource extends Resource
{
   ...
   * @return Appsactivity_ListActivitiesResponse
   */
  public function listActivities($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Appsactivity_ListActivitiesResponse");
  }
}
...
class Appsactivity_Activity extends Collection
{
  protected $collection_key = 'singleEvents';
  protected $internal_gapi_mappings = array(
  );
  protected $combinedEventType = 'Appsactivity_Event';
  protected $combinedEventDataType = '';
  protected $singleEventsType = 'Appsactivity_Event';
  protected $singleEventsDataType = 'array';


  public function setCombinedEvent(Appsactivity_Event $combinedEvent)
  {
...
class Appsactivity_Event extends Collection
{
  ...
  protected $moveType = 'Appsactivity_Move';
  protected $moveDataType = '';
  protected $permissionChangesType = 'Appsactivity_PermissionChange';
  protected $permissionChangesDataType = 'array';
  public $primaryEventType;
  protected $renameType = 'Appsactivity_Rename';
  protected $renameDataType = '';
  protected $targetType = 'Appsactivity_Target';
  protected $targetDataType = '';
  protected $userType = 'Appsactivity_User';
  ...
  public function setMove(Appsactivity_Move $move)
  {
    $this->move = $move;
  }
  ...
  public function setRename(Appsactivity_Rename $rename)
  {
    $this->rename = $rename;
  }
  ...
  public function setTarget(Appsactivity_Target $target)
  {
    $this->target = $target;
  }
  ...
  public function setUser(Appsactivity_User $user)
  {
    $this->user = $user;
  }
...
class Appsactivity_ListActivitiesResponse extends Collection
{
  protected $collection_key = 'activities';
  protected $internal_gapi_mappings = array(
  );
  protected $activitiesType = 'Appsactivity_Activity';
...
class Appsactivity_Move extends Collection
{
  protected $collection_key = 'removedParents';
  protected $internal_gapi_mappings = array(
  );
  protected $addedParentsType = 'Appsactivity_Parent';
  protected $addedParentsDataType = 'array';
  protected $removedParentsType = 'Appsactivity_Parent';
...
class Appsactivity_Parent extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Appsactivity_Permission extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class Appsactivity_PermissionChange extends Collection
{
  protected $collection_key = 'removedPermissions';
  protected $internal_gapi_mappings = array(
  );
  protected $addedPermissionsType = 'Appsactivity_Permission';
  protected $addedPermissionsDataType = 'array';
  protected $removedPermissionsType = 'Appsactivity_Permission';
...
class Appsactivity_Photo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $url;
...
class Appsactivity_Rename extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $newTitle;
...
class Appsactivity_Target extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Appsactivity_User extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
  protected $photoType = 'Appsactivity_Photo';
  ...
  public function setPhoto(Appsactivity_Photo $photo)
  {
    $this->photo = $photo;
  }

...
class Audit extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->activities = new Audit_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 *  </code>
 */
class Audit_Activities_Resource extends Resource
{
  ...
  public function listActivities($customerId, $applicationId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Audit_Activities");
  }
}
...
class Audit_Activities extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Audit_Activity';
...
class Audit_Activity extends Collection
{
  protected $collection_key = 'events';
  protected $internal_gapi_mappings = array(
  );
  protected $actorType = 'Audit_ActivityActor';
  protected $actorDataType = '';
  protected $eventsType = 'Audit_ActivityEvents';
  protected $eventsDataType = 'array';
  protected $idType = 'Audit_ActivityId';
  ...
  public function setActor(Audit_ActivityActor $actor)
  {
    $this->actor = $actor;
  }
  ...
  public function setId(Audit_ActivityId $id)
  {
    $this->id = $id;
  }
...
class Audit_ActivityActor extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Audit_ActivityEvents extends Collection
{
  ...
  public $eventType;
  public $name;
  protected $parametersType = 'Audit_ActivityEventsParameters';
...
class Audit_ActivityEventsParameters extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class Audit_ActivityId extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $applicationId;

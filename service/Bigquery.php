...
class Bigquery extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->datasets = new Bigquery_Datasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
    ...
    $this->jobs = new Bigquery_Jobs_Resource(
        $this,
        $this->serviceName,
        'jobs',
        array(
    ...
    $this->projects = new Bigquery_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->tabledata = new Bigquery_Tabledata_Resource(
        $this,
        $this->serviceName,
        'tabledata',
        array(
    ...
    $this->tables = new Bigquery_Tables_Resource(
        $this,
        $this->serviceName,
        'tables',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $bigqueryService = new Bigquery(...);
 *   $datasets = $bigqueryService->datasets;
 *  </code>
 */
class Bigquery_Datasets_Resource extends Resource
{
  ...
  public function get($projectId, $datasetId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Bigquery_Dataset");
  }
   ...
   * @return Bigquery_Dataset
   */
  public function insert($projectId, Bigquery_Dataset $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Bigquery_Dataset");
  }
   ...
   * @return Bigquery_DatasetList
   */
  public function listDatasets($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Bigquery_DatasetList");
  }
   ...
   * @return Bigquery_Dataset
   */
  public function patch($projectId, $datasetId, Bigquery_Dataset $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Bigquery_Dataset");
  }
   ...
   * @return Bigquery_Dataset
   */
  public function update($projectId, $datasetId, Bigquery_Dataset $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Bigquery_Dataset");
  }
}
 ...
 *  </code>
 */
class Bigquery_Jobs_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Bigquery_JobCancelResponse
   */
  public function cancel($projectId, $jobId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Bigquery_JobCancelResponse");
  }
  ...
  public function get($projectId, $jobId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Bigquery_Job");
  }
   ...
   * @return Bigquery_GetQueryResultsResponse
   */
  public function getQueryResults($projectId, $jobId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('getQueryResults', array($params), "Bigquery_GetQueryResultsResponse");
  }
   ...
   * @return Bigquery_Job
   */
  public function insert($projectId, Bigquery_Job $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Bigquery_Job");
  }
   ...
   * @opt_param string pageToken Page token, returned by a previous call, to
   * request the next page of results
   * @return Bigquery_JobList
   */
  public function listJobs($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Bigquery_JobList");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Bigquery_QueryResponse
   */
  public function query($projectId, Bigquery_QueryRequest $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Bigquery_QueryResponse");
  }
}
 ...
 *  </code>
 */
class Bigquery_Projects_Resource extends Resource
{
   ...
   * request the next page of results
   * @opt_param string maxResults Maximum number of results to return
   * @return Bigquery_ProjectList
   */
  public function listProjects($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Bigquery_ProjectList");
  }
}
 ...
 *  </code>
 */
class Bigquery_Tabledata_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Bigquery_TableDataInsertAllResponse
   */
  public function insertAll($projectId, $datasetId, $tableId, Bigquery_TableDataInsertAllRequest $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insertAll', array($params), "Bigquery_TableDataInsertAllResponse");
  }
  ...
  public function listTabledata($projectId, $datasetId, $tableId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Bigquery_TableDataList");
  }
}
 ...
 *  </code>
 */
class Bigquery_Tables_Resource extends Resource
{
  ...
  public function get($projectId, $datasetId, $tableId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Bigquery_Table");
  }
   ...
   * @return Bigquery_Table
   */
  public function insert($projectId, $datasetId, Bigquery_Table $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Bigquery_Table");
  }
   ...
   * request the next page of results
   * @opt_param string maxResults Maximum number of results to return
   * @return Bigquery_TableList
   */
  public function listTables($projectId, $datasetId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Bigquery_TableList");
  }
   ...
   * @return Bigquery_Table
   */
  public function patch($projectId, $datasetId, $tableId, Bigquery_Table $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Bigquery_Table");
  }
   ...
   * @return Bigquery_Table
   */
  public function update($projectId, $datasetId, $tableId, Bigquery_Table $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Bigquery_Table");
  }
}
...
class Bigquery_CsvOptions extends Model
{
...
class Bigquery_Dataset extends Collection
{
  protected $collection_key = 'access';
  protected $internal_gapi_mappings = array(
  );
  protected $accessType = 'Bigquery_DatasetAccess';
  protected $accessDataType = 'array';
  public $creationTime;
  protected $datasetReferenceType = 'Bigquery_DatasetReference';
  ...
  public function setDatasetReference(Bigquery_DatasetReference $datasetReference)
  {
...
class Bigquery_DatasetAccess extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $domain;
  ...
  public $specialGroup;
  public $userByEmail;
  protected $viewType = 'Bigquery_TableReference';
  ...
  public function setView(Bigquery_TableReference $view)
  {
    $this->view = $view;
  }
...
class Bigquery_DatasetList extends Collection
{
  protected $collection_key = 'datasets';
  protected $internal_gapi_mappings = array(
  );
  protected $datasetsType = 'Bigquery_DatasetListDatasets';
...
class Bigquery_DatasetListDatasets extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $datasetReferenceType = 'Bigquery_DatasetReference';
...
class Bigquery_DatasetReference extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $datasetId;
...
class Bigquery_ErrorProto extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $debugInfo;
...
class Bigquery_ExternalDataConfiguration extends Collection
{
  protected $collection_key = 'sourceUris';
  protected $internal_gapi_mappings = array(
  );
  public $compression;
  protected $csvOptionsType = 'Bigquery_CsvOptions';
  protected $csvOptionsDataType = '';
  public $ignoreUnknownValues;
  public $maxBadRecords;
  protected $schemaType = 'Bigquery_TableSchema';
  ...
  public function setCsvOptions(Bigquery_CsvOptions $csvOptions)
  {
  ...
  public function setSchema(Bigquery_TableSchema $schema)
  {
    $this->schema = $schema;
  }
...
class Bigquery_GetQueryResultsResponse extends Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
  public $cacheHit;
  protected $errorsType = 'Bigquery_ErrorProto';
  protected $errorsDataType = 'array';
  public $etag;
  public $jobComplete;
  protected $jobReferenceType = 'Bigquery_JobReference';
  protected $jobReferenceDataType = '';
  public $kind;
  public $pageToken;
  protected $rowsType = 'Bigquery_TableRow';
  ...
  public function setJobReference(Bigquery_JobReference $jobReference)
  {
...
class Bigquery_Job extends Model
{
  protected $internal_gapi_mappings = array(
        "userEmail" => "user_email",
  );
  protected $configurationType = 'Bigquery_JobConfiguration';
  ...
  public $kind;
  public $selfLink;
  protected $statisticsType = 'Bigquery_JobStatistics';
  protected $statisticsDataType = '';
  protected $statusType = 'Bigquery_JobStatus';
  protected $statusDataType = '';
  public $userEmail;


  public function setConfiguration(Bigquery_JobConfiguration $configuration)
  {
  ...
  public function setStatistics(Bigquery_JobStatistics $statistics)
  {
  ...
  public function setStatus(Bigquery_JobStatus $status)
  {
    $this->status = $status;
  }
...
class Bigquery_JobCancelResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $jobType = 'Bigquery_Job';
  protected $jobDataType = '';
  public $kind;


  public function setJob(Bigquery_Job $job)
  {
    $this->job = $job;
  }
...
class Bigquery_JobConfiguration extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $copyType = 'Bigquery_JobConfigurationTableCopy';
  protected $copyDataType = '';
  public $dryRun;
  protected $extractType = 'Bigquery_JobConfigurationExtract';
  protected $extractDataType = '';
  protected $linkType = 'Bigquery_JobConfigurationLink';
  protected $linkDataType = '';
  protected $loadType = 'Bigquery_JobConfigurationLoad';
  protected $loadDataType = '';
  protected $queryType = 'Bigquery_JobConfigurationQuery';
  protected $queryDataType = '';


  public function setCopy(Bigquery_JobConfigurationTableCopy $copy)
  {
    $this->copy = $copy;
  }
  ...
  public function setExtract(Bigquery_JobConfigurationExtract $extract)
  {
  ...
  public function setLink(Bigquery_JobConfigurationLink $link)
  {
    $this->link = $link;
  }
  ...
  public function setLoad(Bigquery_JobConfigurationLoad $load)
  {
    $this->load = $load;
  }
  ...
  public function setQuery(Bigquery_JobConfigurationQuery $query)
  {
    $this->query = $query;
  }
...
class Bigquery_JobConfigurationExtract extends Collection
{
  ...
  public $fieldDelimiter;
  public $printHeader;
  protected $sourceTableType = 'Bigquery_TableReference';
  ...
  public function setSourceTable(Bigquery_TableReference $sourceTable)
  {
...
class Bigquery_JobConfigurationLink extends Collection
{
  protected $collection_key = 'sourceUri';
  protected $internal_gapi_mappings = array(
  );
  public $createDisposition;
  protected $destinationTableType = 'Bigquery_TableReference';
  ...
  public function setDestinationTable(Bigquery_TableReference $destinationTable)
  {
...
class Bigquery_JobConfigurationLoad extends Collection
{
  protected $collection_key = 'sourceUris';
  protected $internal_gapi_mappings = array(
  );
...
class Bigquery_JobConfigurationQuery extends Collection
{
  ...
  public $createDisposition;
  protected $defaultDatasetType = 'Bigquery_DatasetReference';
  ...
  public $priority;
  public $query;
  protected $tableDefinitionsType = 'Bigquery_ExternalDataConfiguration';
  protected $tableDefinitionsDataType = 'map';
  public $useQueryCache;
  protected $userDefinedFunctionResourcesType = 'Bigquery_UserDefinedFunctionResource';
  ...
  public function setDefaultDataset(Bigquery_DatasetReference $defaultDataset)
  {
...
class Bigquery_JobConfigurationQueryTableDefinitions extends Model
{
}

class Bigquery_JobConfigurationTableCopy extends Collection
{
  ...
  protected $sourceTableType = 'Bigquery_TableReference';
  protected $sourceTableDataType = '';
  protected $sourceTablesType = 'Bigquery_TableReference';
...
class Bigquery_JobList extends Collection
{
  protected $collection_key = 'jobs';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $jobsType = 'Bigquery_JobListJobs';
...
class Bigquery_JobListJobs extends Model
{
  protected $internal_gapi_mappings = array(
        "userEmail" => "user_email",
  );
  protected $configurationType = 'Bigquery_JobConfiguration';
  protected $configurationDataType = '';
  protected $errorResultType = 'Bigquery_ErrorProto';
  ...
  public function setErrorResult(Bigquery_ErrorProto $errorResult)
  {
...
class Bigquery_JobReference extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $jobId;
...
class Bigquery_JobStatistics extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $creationTime;
  public $endTime;
  protected $extractType = 'Bigquery_JobStatistics4';
  protected $extractDataType = '';
  protected $loadType = 'Bigquery_JobStatistics3';
  protected $loadDataType = '';
  protected $queryType = 'Bigquery_JobStatistics2';
  protected $queryDataType = '';
  public $startTime;
  public $totalBytesProcessed;
  ...
  public function setExtract(Bigquery_JobStatistics4 $extract)
  {
    $this->extract = $extract;
  }
  public function getExtract()
  ...
  public function setLoad(Bigquery_JobStatistics3 $load)
  {
    $this->load = $load;
  }
  public function getLoad()
  ...
  public function setQuery(Bigquery_JobStatistics2 $query)
  {
    $this->query = $query;
  }
  public function getQuery()
...
class Bigquery_JobStatistics2 extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $billingTier;
...
class Bigquery_JobStatistics3 extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Bigquery_JobStatistics4 extends Collection
{
...
class Bigquery_JobStatus extends Collection
{
...
class Bigquery_JsonObject extends Model
{
}

class Bigquery_ProjectList extends Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $projectsType = 'Bigquery_ProjectListProjects';
...
class Bigquery_ProjectListProjects extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $friendlyName;
  ...
  public $kind;
  public $numericId;
  protected $projectReferenceType = 'Bigquery_ProjectReference';
  ...
  public function setProjectReference(Bigquery_ProjectReference $projectReference)
  {
...
class Bigquery_ProjectReference extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $projectId;
...
class Bigquery_QueryRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $defaultDatasetType = 'Bigquery_DatasetReference';
...
class Bigquery_QueryResponse extends Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
...
class Bigquery_Streamingbuffer extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Bigquery_Table extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $creationTime;
  ...
  protected $externalDataConfigurationType = 'Bigquery_ExternalDataConfiguration';
  ...
  protected $schemaDataType = '';
  public $selfLink;
  protected $streamingBufferType = 'Bigquery_Streamingbuffer';
  protected $streamingBufferDataType = '';
  protected $tableReferenceType = 'Bigquery_TableReference';
  protected $tableReferenceDataType = '';
  public $type;
  protected $viewType = 'Bigquery_ViewDefinition';
  protected $viewDataType = '';
  ...
  public function setExternalDataConfiguration(Bigquery_ExternalDataConfiguration $externalDataConfiguration)
  {
  ...
  public function setStreamingBuffer(Bigquery_Streamingbuffer $streamingBuffer)
  {
  ...
  public function setTableReference(Bigquery_TableReference $tableReference)
  {
  ...
  public function setView(Bigquery_ViewDefinition $view)
  {
    $this->view = $view;
  }
  public function getView()
...
class Bigquery_TableCell extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $v;
...
class Bigquery_TableDataInsertAllRequest extends Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
  public $ignoreUnknownValues;
  public $kind;
  protected $rowsType = 'Bigquery_TableDataInsertAllRequestRows';
  protected $rowsDataType = 'array';
...
class Bigquery_TableDataInsertAllRequestRows extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $insertId;
...
class Bigquery_TableDataInsertAllResponse extends Collection
{
  protected $collection_key = 'insertErrors';
  protected $internal_gapi_mappings = array(
  );
  protected $insertErrorsType = 'Bigquery_TableDataInsertAllResponseInsertErrors';
...
class Bigquery_TableDataInsertAllResponseInsertErrors extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
...
class Bigquery_TableDataList extends Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
...
class Bigquery_TableFieldSchema extends Collection
{
  protected $collection_key = 'fields';
  protected $internal_gapi_mappings = array(
  );
  public $description;
  protected $fieldsType = 'Bigquery_TableFieldSchema';
...
class Bigquery_TableList extends Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $tablesType = 'Bigquery_TableListTables';
...
class Bigquery_TableListTables extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $friendlyName;
...
class Bigquery_TableReference extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $datasetId;
...
class Bigquery_TableRow extends Collection
{
  protected $collection_key = 'f';
  protected $internal_gapi_mappings = array(
  );
  protected $fType = 'Bigquery_TableCell';
...
class Bigquery_TableSchema extends Collection
{
  protected $collection_key = 'fields';
  protected $internal_gapi_mappings = array(
  );
...
class Bigquery_UserDefinedFunctionResource extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $inlineCode;
...
class Bigquery_ViewDefinition extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $query;

...
class Blogger extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->blogUserInfos = new Blogger_BlogUserInfos_Resource(
        $this,
        $this->serviceName,
        'blogUserInfos',
        array(
    ...
    $this->blogs = new Blogger_Blogs_Resource(
        $this,
        $this->serviceName,
        'blogs',
        array(
    ...
    $this->comments = new Blogger_Comments_Resource(
        $this,
        $this->serviceName,
        'comments',
        array(
    ...
    $this->pageViews = new Blogger_PageViews_Resource(
        $this,
        $this->serviceName,
        'pageViews',
        array(
    ...
    $this->pages = new Blogger_Pages_Resource(
        $this,
        $this->serviceName,
        'pages',
        array(
    ...
    $this->postUserInfos = new Blogger_PostUserInfos_Resource(
        $this,
        $this->serviceName,
        'postUserInfos',
        array(
    ...
    $this->posts = new Blogger_Posts_Resource(
        $this,
        $this->serviceName,
        'posts',
        array(
    ...
    $this->users = new Blogger_Users_Resource(
        $this,
        $this->serviceName,
        'users',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $bloggerService = new Blogger(...);
 *   $blogUserInfos = $bloggerService->blogUserInfos;
 *  </code>
 */
class Blogger_BlogUserInfos_Resource extends Resource
{
 ...
 *  </code>
 */
class Blogger_Blogs_Resource extends Resource
{
  ...
  public function get($blogId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Blogger_Blog");
  }
  ...
  public function getByUrl($url, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('getByUrl', array($params), "Blogger_Blog");
  }
   ...
   * some fields require elevated access.
   * @return Blogger_BlogList
   */
  public function listByUser($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('listByUser', array($params), "Blogger_BlogList");
  }
}
 ...
 *  </code>
 */
class Blogger_Comments_Resource extends Resource
{
  ...
  public function approve($blogId, $postId, $commentId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('approve', array($params), "Blogger_Comment");
  }
  ...
  public function get($blogId, $postId, $commentId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId, 'commentId' => $commentId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Blogger_Comment");
  }
  ...
  public function listByBlog($blogId, $optParams = array())
  {
    $params = array('blogId' => $blogId);
    $params = array_merge($params, $optParams);
    return $this->call('listByBlog', array($params), "Blogger_CommentList");
  }
  ...
  public function markAsSpam($blogId, $postId, $commentId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId, 'commentId' => $commentId);
    $params = array_merge($params, $optParams);
    return $this->call('markAsSpam', array($params), "Blogger_Comment");
  }
  ...
  public function removeContent($blogId, $postId, $commentId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId, 'commentId' => $commentId);
    $params = array_merge($params, $optParams);
    return $this->call('removeContent', array($params), "Blogger_Comment");
  }
}
 ...
 *  </code>
 */
class Blogger_PageViews_Resource extends Resource
{
   ...
   * @return Blogger_Pageviews
   */
  public function get($blogId, $optParams = array())
  {
    $params = array('blogId' => $blogId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Blogger_Pageviews");
  }
}
 ...
 *  </code>
 */
class Blogger_Pages_Resource extends Resource
{
  ...
  public function get($blogId, $pageId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Blogger_Page");
  }
   ...
   * @return Blogger_Page
   */
  public function insert($blogId, Blogger_Page $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Blogger_Page");
  }
   ...
   * @opt_param string view Access level with which to view the returned result.
   * Note that some fields require elevated access.
   * @return Blogger_PageList
   */
  public function listPages($blogId, $optParams = array())
  {
    $params = array('blogId' => $blogId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Blogger_PageList");
  }
   ...
   * @return Blogger_Page
   */
  public function patch($blogId, $pageId, Blogger_Page $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Blogger_Page");
  }
  ...
  public function publish($blogId, $pageId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId);
    $params = array_merge($params, $optParams);
    return $this->call('publish', array($params), "Blogger_Page");
  }
  ...
  public function revert($blogId, $pageId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId);
    $params = array_merge($params, $optParams);
    return $this->call('revert', array($params), "Blogger_Page");
  }
   ...
   * @return Blogger_Page
   */
  public function update($blogId, $pageId, Blogger_Page $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'pageId' => $pageId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Blogger_Page");
  }
}
 ...
 *  </code>
 */
class Blogger_PostUserInfos_Resource extends Resource
{
   ...
   * @opt_param string view Access level with which to view the returned result.
   * Note that some fields require elevated access.
   * @return Blogger_PostUserInfosList
   */
  public function listPostUserInfos($userId, $blogId, $optParams = array())
  {
    $params = array('userId' => $userId, 'blogId' => $blogId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Blogger_PostUserInfosList");
  }
}
 ...
 *  </code>
 */
class Blogger_Posts_Resource extends Resource
{
  ...
  public function get($blogId, $postId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Blogger_Post");
  }
  ...
  public function getByPath($blogId, $path, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('getByPath', array($params), "Blogger_Post");
  }
   ...
   * @return Blogger_Post
   */
  public function insert($blogId, Blogger_Post $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Blogger_Post");
  }
   ...
   * @return Blogger_PostList
   */
  public function listPosts($blogId, $optParams = array())
  {
    $params = array('blogId' => $blogId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Blogger_PostList");
  }
   ...
   * @return Blogger_Post
   */
  public function patch($blogId, $postId, Blogger_Post $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Blogger_Post");
  }
  ...
  public function publish($blogId, $postId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId);
    $params = array_merge($params, $optParams);
    return $this->call('publish', array($params), "Blogger_Post");
  }
  ...
  public function revert($blogId, $postId, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId);
    $params = array_merge($params, $optParams);
    return $this->call('revert', array($params), "Blogger_Post");
  }
  ...
  public function search($blogId, $q, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Blogger_PostList");
  }
   ...
   * @return Blogger_Post
   */
  public function update($blogId, $postId, Blogger_Post $postBody, $optParams = array())
  {
    $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Blogger_Post");
  }
}
 ...
 *  </code>
 */
class Blogger_Users_Resource extends Resource
{
  ...
  public function get($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Blogger_User");
  }
}
...
class Blogger_Blog extends Model
{
  ...
  public $id;
  public $kind;
  protected $localeType = 'Blogger_BlogLocale';
  protected $localeDataType = '';
  public $name;
  protected $pagesType = 'Blogger_BlogPages';
  protected $pagesDataType = '';
  protected $postsType = 'Blogger_BlogPosts';
  ...
  public function setLocale(Blogger_BlogLocale $locale)
  {
    $this->locale = $locale;
  }
  ...
  public function setPages(Blogger_BlogPages $pages)
  {
    $this->pages = $pages;
  }
  ...
  public function setPosts(Blogger_BlogPosts $posts)
  {
    $this->posts = $posts;
  }
...
class Blogger_BlogList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $blogUserInfosType = 'Blogger_BlogUserInfo';
  protected $blogUserInfosDataType = 'array';
  protected $itemsType = 'Blogger_Blog';
...
class Blogger_BlogLocale extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $country;
...
class Blogger_BlogPages extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $selfLink;
...
class Blogger_BlogPerUserInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $blogId;
...
class Blogger_BlogPosts extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Blogger_Post';
  protected $itemsDataType = 'array';
  public $selfLink;
  public $totalItems;
...
class Blogger_BlogUserInfo extends Model
{
  protected $internal_gapi_mappings = array(
        "blogUserInfo" => "blog_user_info",
  );
  protected $blogType = 'Blogger_Blog';
  protected $blogDataType = '';
  protected $blogUserInfoType = 'Blogger_BlogPerUserInfo';
  protected $blogUserInfoDataType = '';
  public $kind;


  public function setBlog(Blogger_Blog $blog)
  {
    $this->blog = $blog;
  }
  ...
  public function setBlogUserInfo(Blogger_BlogPerUserInfo $blogUserInfo)
  {
...
class Blogger_Comment extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $authorType = 'Blogger_CommentAuthor';
  protected $authorDataType = '';
  protected $blogType = 'Blogger_CommentBlog';
  protected $blogDataType = '';
  public $content;
  public $id;
  protected $inReplyToType = 'Blogger_CommentInReplyTo';
  protected $inReplyToDataType = '';
  public $kind;
  protected $postType = 'Blogger_CommentPost';
  ...
  public function setAuthor(Blogger_CommentAuthor $author)
  {
    $this->author = $author;
  }
  ...
  public function setBlog(Blogger_CommentBlog $blog)
  {
    $this->blog = $blog;
  }
  public function getBlog()
  ...
  public function setInReplyTo(Blogger_CommentInReplyTo $inReplyTo)
  {
  ...
  public function setPost(Blogger_CommentPost $post)
  {
    $this->post = $post;
  }
...
class Blogger_CommentAuthor extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
  public $id;
  protected $imageType = 'Blogger_CommentAuthorImage';
  ...
  public function setImage(Blogger_CommentAuthorImage $image)
  {
    $this->image = $image;
  }
...
class Blogger_CommentAuthorImage extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $url;
...
class Blogger_CommentBlog extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Blogger_CommentInReplyTo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Blogger_CommentList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Blogger_Comment';
  protected $itemsDataType = 'array';
  public $kind;
...
class Blogger_CommentPost extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Blogger_Page extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $authorType = 'Blogger_PageAuthor';
  protected $authorDataType = '';
  protected $blogType = 'Blogger_PageBlog';
  protected $blogDataType = '';
  public $content;
  public $etag;
  public $id;
  ...
  public function setAuthor(Blogger_PageAuthor $author)
  {
    $this->author = $author;
  }
  public function getAuthor()
  ...
  public function setBlog(Blogger_PageBlog $blog)
  {
    $this->blog = $blog;
  }
  public function getBlog()
...
class Blogger_PageAuthor extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
  public $id;
  protected $imageType = 'Blogger_PageAuthorImage';
  protected $imageDataType = '';
  public $url;
  ...
  public function setImage(Blogger_PageAuthorImage $image)
  {
    $this->image = $image;
  }
  public function getImage()
...
class Blogger_PageAuthorImage extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $url;
...
class Blogger_PageBlog extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Blogger_PageList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Blogger_Page';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class Blogger_Pageviews extends Collection
{
  protected $collection_key = 'counts';
  protected $internal_gapi_mappings = array(
  );
  public $blogId;
  protected $countsType = 'Blogger_PageviewsCounts';
...
class Blogger_PageviewsCounts extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Blogger_Post extends Collection
{
  protected $collection_key = 'labels';
  protected $internal_gapi_mappings = array(
  );
  protected $authorType = 'Blogger_PostAuthor';
  protected $authorDataType = '';
  protected $blogType = 'Blogger_PostBlog';
  protected $blogDataType = '';
  public $content;
  public $customMetaData;
  public $etag;
  public $id;
  protected $imagesType = 'Blogger_PostImages';
  protected $imagesDataType = 'array';
  public $kind;
  public $labels;
  protected $locationType = 'Blogger_PostLocation';
  protected $locationDataType = '';
  public $published;
  public $readerComments;
  protected $repliesType = 'Blogger_PostReplies';
  ...
  public function setAuthor(Blogger_PostAuthor $author)
  {
    $this->author = $author;
  }
  public function getAuthor()
  ...
  public function setBlog(Blogger_PostBlog $blog)
  {
    $this->blog = $blog;
  }
  public function getBlog()
  ...
  public function setLocation(Blogger_PostLocation $location)
  {
  ...
  public function setReplies(Blogger_PostReplies $replies)
  {
...
class Blogger_PostAuthor extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
  public $id;
  protected $imageType = 'Blogger_PostAuthorImage';
  protected $imageDataType = '';
  public $url;
  ...
  public function setImage(Blogger_PostAuthorImage $image)
  {
    $this->image = $image;
  }
  public function getImage()
...
class Blogger_PostAuthorImage extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $url;
...
class Blogger_PostBlog extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Blogger_PostImages extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $url;
...
class Blogger_PostList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Blogger_PostLocation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $lat;
...
class Blogger_PostPerUserInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $blogId;
...
class Blogger_PostReplies extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Blogger_PostUserInfo extends Model
{
  protected $internal_gapi_mappings = array(
        "postUserInfo" => "post_user_info",
  );
  public $kind;
  protected $postType = 'Blogger_Post';
  protected $postDataType = '';
  protected $postUserInfoType = 'Blogger_PostPerUserInfo';
  ...
  public function setPost(Blogger_Post $post)
  {
    $this->post = $post;
  }
  public function getPost()
  ...
  public function setPostUserInfo(Blogger_PostPerUserInfo $postUserInfo)
  {
...
class Blogger_PostUserInfosList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Blogger_PostUserInfo';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class Blogger_User extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $about;
  protected $blogsType = 'Blogger_UserBlogs';
  protected $blogsDataType = '';
  public $created;
  public $displayName;
  public $id;
  public $kind;
  protected $localeType = 'Blogger_UserLocale';
  protected $localeDataType = '';
  public $selfLink;
  public $url;
  ...
  public function setBlogs(Blogger_UserBlogs $blogs)
  {
    $this->blogs = $blogs;
  }
  ...
  public function setLocale(Blogger_UserLocale $locale)
  {
    $this->locale = $locale;
  }
  public function getLocale()
...
class Blogger_UserBlogs extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $selfLink;
...
class Blogger_UserLocale extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $country;

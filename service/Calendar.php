...
class Calendar extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->acl = new Calendar_Acl_Resource(
        $this,
        $this->serviceName,
        'acl',
        array(
    ...
    $this->calendarList = new Calendar_CalendarList_Resource(
        $this,
        $this->serviceName,
        'calendarList',
        array(
    ...
    $this->calendars = new Calendar_Calendars_Resource(
        $this,
        $this->serviceName,
        'calendars',
        array(
    ...
    $this->channels = new Calendar_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->colors = new Calendar_Colors_Resource(
        $this,
        $this->serviceName,
        'colors',
        array(
    ...
    $this->events = new Calendar_Events_Resource(
        $this,
        $this->serviceName,
        'events',
        array(
    ...
    $this->freebusy = new Calendar_Freebusy_Resource(
        $this,
        $this->serviceName,
        'freebusy',
        array(
    ...
    $this->settings = new Calendar_Settings_Resource(
        $this,
        $this->serviceName,
        'settings',
        array(
 ...
 *  </code>
 */
class Calendar_Acl_Resource extends Resource
{
   ...
   * @param string $ruleId ACL rule identifier.
   * @param array $optParams Optional parameters.
   * @return Calendar_AclRule
   */
  public function get($calendarId, $ruleId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Calendar_AclRule");
  }
   ...
   * @return Calendar_AclRule
   */
  public function insert($calendarId, Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Calendar_AclRule");
  }
  ...
  public function listAcl($calendarId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Calendar_Acl");
  }
   ...
   * @return Calendar_AclRule
   */
  public function patch($calendarId, $ruleId, Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Calendar_AclRule");
  }
   ...
   * @return Calendar_AclRule
   */
  public function update($calendarId, $ruleId, Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Calendar_AclRule");
  }
   ...
   */
  public function watch($calendarId, Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Calendar_Channel");
  }
}
 ...
 *  </code>
 */
class Calendar_CalendarList_Resource extends Resource
{
   ...
   * the currently logged in user, use the "primary" keyword.
   * @param array $optParams Optional parameters.
   * @return Calendar_CalendarListEntry
   */
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Calendar_CalendarListEntry");
  }
   ...
   * @return Calendar_CalendarListEntry
   */
  public function insert(Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Calendar_CalendarListEntry");
  }
   ...
   * default is False.
   * @return Calendar_CalendarList
   */
  public function listCalendarList($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Calendar_CalendarList");
  }
   ...
   * @return Calendar_CalendarListEntry
   */
  public function patch($calendarId, Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Calendar_CalendarListEntry");
  }
   ...
   * @return Calendar_CalendarListEntry
   */
  public function update($calendarId, Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Calendar_CalendarListEntry");
  }
   ...
   * @return Calendar_Channel
   */
  public function watch(Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Calendar_Channel");
 ...
 *  </code>
 */
class Calendar_Calendars_Resource extends Resource
{
  ...
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Calendar_Calendar");
  }
   ...
   * @return Calendar_Calendar
   */
  public function insert(Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Calendar_Calendar");
  }
   ...
   * @return Calendar_Calendar
   */
  public function patch($calendarId, Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Calendar_Calendar");
  }
   ...
   * @return Calendar_Calendar
   */
  public function update($calendarId, Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Calendar_Calendar");
  }
}
 ...
 *  </code>
 */
class Calendar_Channels_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class Calendar_Colors_Resource extends Resource
{
  ...
  public function get($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Calendar_Colors");
  }
}
 ...
 *  </code>
 */
class Calendar_Events_Resource extends Resource
{
  ...
  public function get($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Calendar_Event");
  }
   ...
   * @return Calendar_Event
   */
  public function import($calendarId, Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('import', array($params), "Calendar_Event");
  }
   ...
   * @return Calendar_Event
   */
  public function insert($calendarId, Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Calendar_Event");
  }
  ...
  public function instances($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('instances', array($params), "Calendar_Events");
  }
  ...
  public function listEvents($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Calendar_Events");
  }
  ...
  public function move($calendarId, $eventId, $destination, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "Calendar_Event");
  }
   ...
   * @return Calendar_Event
   */
  public function patch($calendarId, $eventId, Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Calendar_Event");
  }
  ...
  public function quickAdd($calendarId, $text, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('quickAdd', array($params), "Calendar_Event");
  }
   ...
   * @return Calendar_Event
   */
  public function update($calendarId, $eventId, Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Calendar_Event");
  }
 ...
 *  </code>
 */
class Calendar_Freebusy_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Calendar_FreeBusyResponse
   */
  public function query(Calendar_FreeBusyRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Calendar_FreeBusyResponse");
  }
}
 ...
 *  </code>
 */
class Calendar_Settings_Resource extends Resource
{
  ...
  public function get($setting, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Calendar_Setting");
  }
  ...
  public function listSettings($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Calendar_Settings");
  }
...
class Calendar_Acl extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Calendar_AclRule';
...
class Calendar_AclRule extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  ...
  public $kind;
  public $role;
  protected $scopeType = 'Calendar_AclRuleScope';
  ...
  public function setScope(Calendar_AclRuleScope $scope)
  {
    $this->scope = $scope;
  }
...
class Calendar_AclRuleScope extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class Calendar_Calendar extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Calendar_CalendarList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Calendar_CalendarListEntry';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Calendar_CalendarListEntry extends Collection
{
  ...
  public $colorId;
  protected $defaultRemindersType = 'Calendar_EventReminder';
  ...
  public $kind;
  public $location;
  protected $notificationSettingsType = 'Calendar_CalendarListEntryNotificationSettings';
  ...
  public function setNotificationSettings(Calendar_CalendarListEntryNotificationSettings $notificationSettings)
  {
...
class Calendar_CalendarListEntryNotificationSettings extends Collection
{
  protected $collection_key = 'notifications';
  protected $internal_gapi_mappings = array(
  );
  protected $notificationsType = 'Calendar_CalendarNotification';
...
class Calendar_CalendarNotification extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class Calendar_Channel extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class Calendar_ChannelParams extends Model
{
}

class Calendar_ColorDefinition extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $background;
...
class Calendar_Colors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarType = 'Calendar_ColorDefinition';
  protected $calendarDataType = 'map';
  protected $eventType = 'Calendar_ColorDefinition';
...
class Calendar_ColorsCalendar extends Model
{
}

class Calendar_ColorsEvent extends Model
{
}

class Calendar_Error extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $domain;
...
class Calendar_Event extends Collection
{
  protected $collection_key = 'recurrence';
  protected $internal_gapi_mappings = array(
  );
  public $anyoneCanAddSelf;
  protected $attachmentsType = 'Calendar_EventAttachment';
  protected $attachmentsDataType = 'array';
  protected $attendeesType = 'Calendar_EventAttendee';
  protected $attendeesDataType = 'array';
  public $attendeesOmitted;
  public $colorId;
  public $created;
  protected $creatorType = 'Calendar_EventCreator';
  protected $creatorDataType = '';
  public $description;
  protected $endType = 'Calendar_EventDateTime';
  protected $endDataType = '';
  public $endTimeUnspecified;
  public $etag;
  protected $extendedPropertiesType = 'Calendar_EventExtendedProperties';
  protected $extendedPropertiesDataType = '';
  protected $gadgetType = 'Calendar_EventGadget';
  ...
  public $location;
  public $locked;
  protected $organizerType = 'Calendar_EventOrganizer';
  protected $organizerDataType = '';
  protected $originalStartTimeType = 'Calendar_EventDateTime';
  protected $originalStartTimeDataType = '';
  public $privateCopy;
  public $recurrence;
  public $recurringEventId;
  protected $remindersType = 'Calendar_EventReminders';
  protected $remindersDataType = '';
  public $sequence;
  protected $sourceType = 'Calendar_EventSource';
  protected $sourceDataType = '';
  protected $startType = 'Calendar_EventDateTime';
  ...
  public function setCreator(Calendar_EventCreator $creator)
  {
  ...
  public function setEnd(Calendar_EventDateTime $end)
  {
    $this->end = $end;
  }
  ...
  public function setExtendedProperties(Calendar_EventExtendedProperties $extendedProperties)
  {
  ...
  public function setGadget(Calendar_EventGadget $gadget)
  {
    $this->gadget = $gadget;
  }
  ...
  public function setOrganizer(Calendar_EventOrganizer $organizer)
  {
  ...
  public function setOriginalStartTime(Calendar_EventDateTime $originalStartTime)
  {
  ...
  public function setReminders(Calendar_EventReminders $reminders)
  {
  ...
  public function setSource(Calendar_EventSource $source)
  {
    $this->source = $source;
  }
  ...
  public function setStart(Calendar_EventDateTime $start)
  {
    $this->start = $start;
  }
...
class Calendar_EventAttachment extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fileId;
...
class Calendar_EventAttendee extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Calendar_EventCreator extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class Calendar_EventDateTime extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $date;
...
class Calendar_EventExtendedProperties extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $private;
...
class Calendar_EventExtendedPropertiesPrivate extends Model
{
}

class Calendar_EventExtendedPropertiesShared extends Model
{
}

class Calendar_EventGadget extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $display;
...
class Calendar_EventGadgetPreferences extends Model
{
}

class Calendar_EventOrganizer extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class Calendar_EventReminder extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class Calendar_EventReminders extends Collection
{
  protected $collection_key = 'overrides';
  protected $internal_gapi_mappings = array(
  );
  protected $overridesType = 'Calendar_EventReminder';
...
class Calendar_EventSource extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $title;
...
class Calendar_Events extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $description;
  public $etag;
  protected $itemsType = 'Calendar_Event';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Calendar_FreeBusyCalendar extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $busyType = 'Calendar_TimePeriod';
  protected $busyDataType = 'array';
  protected $errorsType = 'Calendar_Error';
...
class Calendar_FreeBusyGroup extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
...
class Calendar_FreeBusyRequest extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $itemsType = 'Calendar_FreeBusyRequestItem';
  protected $itemsDataType = 'array';
  public $timeMax;
  public $timeMin;
  public $timeZone;
...
class Calendar_FreeBusyRequestItem extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Calendar_FreeBusyResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarsType = 'Calendar_FreeBusyCalendar';
  protected $calendarsDataType = 'map';
  protected $groupsType = 'Calendar_FreeBusyGroup';
...
class Calendar_FreeBusyResponseCalendars extends Model
{
}

class Calendar_FreeBusyResponseGroups extends Model
{
}

class Calendar_Setting extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class Calendar_Settings extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Calendar_Setting';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Calendar_TimePeriod extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $end;

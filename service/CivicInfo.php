 ...
 * @author Google, Inc.
 */
class CivicInfo extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->divisions = new CivicInfo_Divisions_Resource(
        $this,
        $this->serviceName,
        'divisions',
        array(
    ...
    $this->elections = new CivicInfo_Elections_Resource(
        $this,
        $this->serviceName,
        'elections',
        array(
    ...
    $this->representatives = new CivicInfo_Representatives_Resource(
        $this,
        $this->serviceName,
        'representatives',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $civicinfoService = new CivicInfo(...);
 *   $divisions = $civicinfoService->divisions;
 *  </code>
 */
class CivicInfo_Divisions_Resource extends Resource
{
   ...
   * @return CivicInfo_DivisionSearchResponse
   */
  public function search($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "CivicInfo_DivisionSearchResponse");
  }
}
 ...
 *  </code>
 */
class CivicInfo_Elections_Resource extends Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return CivicInfo_ElectionsQueryResponse
   */
  public function electionQuery($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('electionQuery', array($params), "CivicInfo_ElectionsQueryResponse");
  }
   ...
   * @return CivicInfo_VoterInfoResponse
   */
  public function voterInfoQuery($address, $optParams = array())
  {
    $params = array('address' => $address);
    $params = array_merge($params, $optParams);
    return $this->call('voterInfoQuery', array($params), "CivicInfo_VoterInfoResponse");
  }
}
 ...
 *  </code>
 */
class CivicInfo_Representatives_Resource extends Resource
{
   ...
   * @return CivicInfo_RepresentativeInfoResponse
   */
  public function representativeInfoByAddress($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoByAddress', array($params), "CivicInfo_RepresentativeInfoResponse");
  }
   ...
   * fulfilling one of these roles will be returned. Divisions that don't contain
   * a matching office will not be returned.
   * @return CivicInfo_RepresentativeInfoData
   */
  public function representativeInfoByDivision($ocdId, $optParams = array())
  {
    $params = array('ocdId' => $ocdId);
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoByDivision', array($params), "CivicInfo_RepresentativeInfoData");
  }
}
...
class CivicInfo_AdministrationRegion extends Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
        "localJurisdiction" => "local_jurisdiction",
  );
  protected $electionAdministrationBodyType = 'CivicInfo_AdministrativeBody';
  protected $electionAdministrationBodyDataType = '';
  public $id;
  protected $localJurisdictionType = 'CivicInfo_AdministrationRegion';
  protected $localJurisdictionDataType = '';
  public $name;
  protected $sourcesType = 'CivicInfo_Source';
  protected $sourcesDataType = 'array';


  public function setElectionAdministrationBody(CivicInfo_AdministrativeBody $electionAdministrationBody)
  {
  ...
  public function setLocalJurisdiction(CivicInfo_AdministrationRegion $localJurisdiction)
  {
...
class CivicInfo_AdministrativeBody extends Collection
{
  ...
  protected $correspondenceAddressType = 'CivicInfo_SimpleAddressType';
  protected $correspondenceAddressDataType = '';
  public $electionInfoUrl;
  protected $electionOfficialsType = 'CivicInfo_ElectionOfficial';
  ...
  public $name;
  protected $physicalAddressType = 'CivicInfo_SimpleAddressType';
  ...
  public function setCorrespondenceAddress(CivicInfo_SimpleAddressType $correspondenceAddress)
  {
  ...
  public function setPhysicalAddress(CivicInfo_SimpleAddressType $physicalAddress)
  {
...
class CivicInfo_Candidate extends Collection
{
  protected $collection_key = 'channels';
  protected $internal_gapi_mappings = array(
  );
  public $candidateUrl;
  protected $channelsType = 'CivicInfo_Channel';
...
class CivicInfo_Channel extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class CivicInfo_Contest extends Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
  public $ballotPlacement;
  protected $candidatesType = 'CivicInfo_Candidate';
  protected $candidatesDataType = 'array';
  protected $districtType = 'CivicInfo_ElectoralDistrict';
  ...
  public function setDistrict(CivicInfo_ElectoralDistrict $district)
  {
...
class CivicInfo_DivisionSearchResponse extends Collection
{
  protected $collection_key = 'results';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $resultsType = 'CivicInfo_DivisionSearchResult';
...
class CivicInfo_DivisionSearchResult extends Collection
{
...
class CivicInfo_Election extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $electionDay;
...
class CivicInfo_ElectionOfficial extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $emailAddress;
...
class CivicInfo_ElectionsQueryResponse extends Collection
{
  protected $collection_key = 'elections';
  protected $internal_gapi_mappings = array(
  );
  protected $electionsType = 'CivicInfo_Election';
...
class CivicInfo_ElectoralDistrict extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class CivicInfo_GeographicDivision extends Collection
{
...
class CivicInfo_Office extends Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
...
class CivicInfo_Official extends Collection
{
  protected $collection_key = 'urls';
  protected $internal_gapi_mappings = array(
  );
  protected $addressType = 'CivicInfo_SimpleAddressType';
...
class CivicInfo_PollingLocation extends Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
  ...
  public function setAddress(CivicInfo_SimpleAddressType $address)
  {
    $this->address = $address;
  }
  public function getAddress()
...
class CivicInfo_RepresentativeInfoData extends Collection
{
  protected $collection_key = 'officials';
  protected $internal_gapi_mappings = array(
  );
  protected $divisionsType = 'CivicInfo_GeographicDivision';
  protected $divisionsDataType = 'map';
  protected $officesType = 'CivicInfo_Office';
  protected $officesDataType = 'array';
  protected $officialsType = 'CivicInfo_Official';
...
class CivicInfo_RepresentativeInfoDataDivisions extends Model
{
}

class CivicInfo_RepresentativeInfoResponse extends Collection
{
  protected $collection_key = 'officials';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $divisionsDataType = 'map';
  public $kind;
  protected $normalizedInputType = 'CivicInfo_SimpleAddressType';
  ...
  public function setNormalizedInput(CivicInfo_SimpleAddressType $normalizedInput)
  {
...
class CivicInfo_RepresentativeInfoResponseDivisions extends Model
{
}

class CivicInfo_SimpleAddressType extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $city;
...
class CivicInfo_Source extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class CivicInfo_VoterInfoResponse extends Collection
{
  protected $collection_key = 'state';
  protected $internal_gapi_mappings = array(
  );
  protected $contestsType = 'CivicInfo_Contest';
  protected $contestsDataType = 'array';
  protected $dropOffLocationsType = 'CivicInfo_PollingLocation';
  protected $dropOffLocationsDataType = 'array';
  protected $earlyVoteSitesType = 'CivicInfo_PollingLocation';
  protected $earlyVoteSitesDataType = 'array';
  protected $electionType = 'CivicInfo_Election';
  protected $electionDataType = '';
  public $kind;
  public $mailOnly;
  protected $normalizedInputType = 'CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $otherElectionsType = 'CivicInfo_Election';
  protected $otherElectionsDataType = 'array';
  protected $pollingLocationsType = 'CivicInfo_PollingLocation';
  protected $pollingLocationsDataType = 'array';
  public $precinctId;
  protected $stateType = 'CivicInfo_AdministrationRegion';
  ...
  public function setElection(CivicInfo_Election $election)
  {

 ...
 * @author Google, Inc.
 */
class Classroom extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->courses = new Classroom_Courses_Resource(
        $this,
        $this->serviceName,
        'courses',
        array(
    ...
    $this->courses_aliases = new Classroom_CoursesAliases_Resource(
        $this,
        $this->serviceName,
        'aliases',
        array(
    ...
    $this->courses_students = new Classroom_CoursesStudents_Resource(
        $this,
        $this->serviceName,
        'students',
        array(
    ...
    $this->courses_teachers = new Classroom_CoursesTeachers_Resource(
        $this,
        $this->serviceName,
        'teachers',
        array(
    ...
    $this->invitations = new Classroom_Invitations_Resource(
        $this,
        $this->serviceName,
        'invitations',
        array(
    ...
    $this->userProfiles = new Classroom_UserProfiles_Resource(
        $this,
        $this->serviceName,
        'userProfiles',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $classroomService = new Classroom(...);
 *   $courses = $classroomService->courses;
 *  </code>
 */
class Classroom_Courses_Resource extends Resource
{
   ...
   */
  public function create(Classroom_Course $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Classroom_Course");
  }
  ...
  public function delete($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Classroom_Empty");
  }
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Classroom_Course");
  }
   ...
   * @return Classroom_ListCoursesResponse
   */
  public function listCourses($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Classroom_ListCoursesResponse");
  }
   ...
   * @return Classroom_Course
   */
  public function patch($id, Classroom_Course $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Classroom_Course");
  }
   ...
   * @return Classroom_Course
   */
  public function update($id, Classroom_Course $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Classroom_Course");
  }
}
 ...
 *  </code>
 */
class Classroom_CoursesAliases_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Classroom_CourseAlias
   */
  public function create($courseId, Classroom_CourseAlias $postBody, $optParams = array())
  {
    $params = array('courseId' => $courseId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Classroom_CourseAlias");
  }
   ...
   * unspecified indicates that the server may assign a maximum. The server may
   * return fewer than the specified number of results.
   * @return Classroom_ListCourseAliasesResponse
   */
  public function listCoursesAliases($courseId, $optParams = array())
  {
    $params = array('courseId' => $courseId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Classroom_ListCourseAliasesResponse");
  }
}
/**
 ...
 *  </code>
 */
class Classroom_CoursesStudents_Resource extends Resource
{
   ...
   */
  public function create($courseId, Classroom_Student $postBody, $optParams = array())
  {
    $params = array('courseId' => $courseId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Classroom_Student");
  }
  ...
  public function get($courseId, $userId, $optParams = array())
  {
    $params = array('courseId' => $courseId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Classroom_Student");
  }
   ...
   * @return Classroom_ListStudentsResponse
   */
  public function listCoursesStudents($courseId, $optParams = array())
  {
    $params = array('courseId' => $courseId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Classroom_ListStudentsResponse");
  }
}
/**
 ...
 *  </code>
 */
class Classroom_CoursesTeachers_Resource extends Resource
{
   ...
   */
  public function create($courseId, Classroom_Teacher $postBody, $optParams = array())
  {
    $params = array('courseId' => $courseId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Classroom_Teacher");
  }
  ...
  public function get($courseId, $userId, $optParams = array())
  {
    $params = array('courseId' => $courseId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Classroom_Teacher");
  }
   ...
   * @opt_param int pageSize Maximum number of items to return. Zero means no
   * maximum. The server may return fewer than the specified number of results.
   * @return Classroom_ListTeachersResponse
   */
  public function listCoursesTeachers($courseId, $optParams = array())
  {
    $params = array('courseId' => $courseId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Classroom_ListTeachersResponse");
  }
}
 ...
 *  </code>
 */
class Classroom_Invitations_Resource extends Resource
{
  ...
  public function accept($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('accept', array($params), "Classroom_Empty");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Classroom_Invitation
   */
  public function create(Classroom_Invitation $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Classroom_Invitation");
  }
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Classroom_Invitation");
  }
   ...
   * @opt_param int pageSize Maximum number of items to return. Zero means no
   * maximum. The server may return fewer than the specified number of results.
   * @return Classroom_ListInvitationsResponse
   */
  public function listInvitations($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Classroom_ListInvitationsResponse");
  }
}
 ...
 *  </code>
 */
class Classroom_UserProfiles_Resource extends Resource
{
   ...
   * user
   * @param array $optParams Optional parameters.
   * @return Classroom_UserProfile
   */
  public function get($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Classroom_UserProfile");
  }
}
...
class Classroom_CourseAlias extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $alias;
...
class Classroom_Empty extends Model
{
}

class Classroom_GlobalPermission extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $permission;
...
class Classroom_Invitation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $courseId;
...
class Classroom_ListCourseAliasesResponse extends Collection
{
  protected $collection_key = 'aliases';
  protected $internal_gapi_mappings = array(
  );
  protected $aliasesType = 'Classroom_CourseAlias';
...
class Classroom_ListCoursesResponse extends Collection
{
  protected $collection_key = 'courses';
  protected $internal_gapi_mappings = array(
  );
  protected $coursesType = 'Classroom_Course';
...
class Classroom_ListInvitationsResponse extends Collection
{
  protected $collection_key = 'invitations';
  protected $internal_gapi_mappings = array(
  );
  protected $invitationsType = 'Classroom_Invitation';
...
class Classroom_ListStudentsResponse extends Collection
{
  protected $collection_key = 'students';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $studentsType = 'Classroom_Student';
...
class Classroom_ListTeachersResponse extends Collection
{
  protected $collection_key = 'teachers';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $teachersType = 'Classroom_Teacher';
...
class Classroom_Name extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $familyName;
...
class Classroom_Student extends Model
{
  ...
  public $courseId;
  protected $profileType = 'Classroom_UserProfile';
  ...
  public function setProfile(Classroom_UserProfile $profile)
  {
...
class Classroom_UserProfile extends Collection
{
  ...
  public $emailAddress;
  public $id;
  protected $nameType = 'Classroom_Name';
  protected $nameDataType = '';
  protected $permissionsType = 'Classroom_GlobalPermission';
  ...
  public function setName(Classroom_Name $name)
  {
    $this->name = $name;
  }
  public function getName()

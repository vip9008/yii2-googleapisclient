 ...
 * @author Google, Inc.
 */
class CloudMonitoring extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->metricDescriptors = new CloudMonitoring_MetricDescriptors_Resource(
        $this,
        $this->serviceName,
        'metricDescriptors',
        array(
    ...
    $this->timeseries = new CloudMonitoring_Timeseries_Resource(
        $this,
        $this->serviceName,
        'timeseries',
        array(
    ...
    $this->timeseriesDescriptors = new CloudMonitoring_TimeseriesDescriptors_Resource(
        $this,
        $this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $cloudmonitoringService = new CloudMonitoring(...);
 *   $metricDescriptors = $cloudmonitoringService->metricDescriptors;
 *  </code>
 */
class CloudMonitoring_MetricDescriptors_Resource extends Resource
{
   ...
   * @return CloudMonitoring_MetricDescriptor
   */
  public function create($project, CloudMonitoring_MetricDescriptor $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "CloudMonitoring_MetricDescriptor");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return CloudMonitoring_DeleteMetricDescriptorResponse
   */
  public function delete($project, $metric, $optParams = array())
  {
    $params = array('project' => $project, 'metric' => $metric);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "CloudMonitoring_DeleteMetricDescriptorResponse");
  }
   ...
   * @return CloudMonitoring_ListMetricDescriptorsResponse
   */
  public function listMetricDescriptors($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "CloudMonitoring_ListMetricDescriptorsResponse");
  }
}
 ...
 *  </code>
 */
class CloudMonitoring_Timeseries_Resource extends Resource
{
   ...
   * @return CloudMonitoring_ListTimeseriesResponse
   */
  public function listTimeseries($project, $metric, $youngest, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "CloudMonitoring_ListTimeseriesResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return CloudMonitoring_WriteTimeseriesResponse
   */
  public function write($project, CloudMonitoring_WriteTimeseriesRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('write', array($params), "CloudMonitoring_WriteTimeseriesResponse");
  }
}
 ...
 *  </code>
 */
class CloudMonitoring_TimeseriesDescriptors_Resource extends Resource
{
   ...
   * expressed as an RFC 3339 timestamp. If neither oldest nor timespan is
   * specified, the default time interval will be (youngest - 4 hours, youngest]
   * @return CloudMonitoring_ListTimeseriesDescriptorsResponse
   */
  public function listTimeseriesDescriptors($project, $metric, $youngest, $optParams = array())
  {
    $params = array('project' => $project, 'metric' => $metric, 'youngest' => $youngest);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "CloudMonitoring_ListTimeseriesDescriptorsResponse");
  }
}
...
class CloudMonitoring_DeleteMetricDescriptorResponse extends Model
{
...
class CloudMonitoring_ListMetricDescriptorsRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class CloudMonitoring_ListMetricDescriptorsResponse extends Collection
{
  protected $collection_key = 'metrics';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $metricsType = 'CloudMonitoring_MetricDescriptor';
...
class CloudMonitoring_ListTimeseriesDescriptorsRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class CloudMonitoring_ListTimeseriesDescriptorsResponse extends Collection
{
  ...
  public $nextPageToken;
  public $oldest;
  protected $timeseriesType = 'CloudMonitoring_TimeseriesDescriptor';
...
class CloudMonitoring_ListTimeseriesRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class CloudMonitoring_ListTimeseriesResponse extends Collection
{
  protected $collection_key = 'timeseries';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $nextPageToken;
  public $oldest;
  protected $timeseriesType = 'CloudMonitoring_Timeseries';
  protected $timeseriesDataType = 'array';
  public $youngest;
...
class CloudMonitoring_MetricDescriptor extends Collection
{
  protected $collection_key = 'labels';
  protected $internal_gapi_mappings = array(
  );
  public $description;
  protected $labelsType = 'CloudMonitoring_MetricDescriptorLabelDescriptor';
  protected $labelsDataType = 'array';
  public $name;
  public $project;
  protected $typeDescriptorType = 'CloudMonitoring_MetricDescriptorTypeDescriptor';
  ...
  public function setTypeDescriptor(CloudMonitoring_MetricDescriptorTypeDescriptor $typeDescriptor)
  {
...
class CloudMonitoring_MetricDescriptorLabelDescriptor extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class CloudMonitoring_MetricDescriptorTypeDescriptor extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $metricType;
...
class CloudMonitoring_Point extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $boolValue;
  protected $distributionValueType = 'CloudMonitoring_PointDistribution';
  ...
  public function setDistributionValue(CloudMonitoring_PointDistribution $distributionValue)
  {
...
class CloudMonitoring_PointDistribution extends Collection
{
  protected $collection_key = 'buckets';
  protected $internal_gapi_mappings = array(
  );
  protected $bucketsType = 'CloudMonitoring_PointDistributionBucket';
  protected $bucketsDataType = 'array';
  protected $overflowBucketType = 'CloudMonitoring_PointDistributionOverflowBucket';
  protected $overflowBucketDataType = '';
  protected $underflowBucketType = 'CloudMonitoring_PointDistributionUnderflowBucket';
  ...
  public function setOverflowBucket(CloudMonitoring_PointDistributionOverflowBucket $overflowBucket)
  {
  ...
  public function setUnderflowBucket(CloudMonitoring_PointDistributionUnderflowBucket $underflowBucket)
  {
...
class CloudMonitoring_PointDistributionBucket extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class CloudMonitoring_PointDistributionOverflowBucket extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class CloudMonitoring_PointDistributionUnderflowBucket extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class CloudMonitoring_Timeseries extends Collection
{
  protected $collection_key = 'points';
  protected $internal_gapi_mappings = array(
  );
  protected $pointsType = 'CloudMonitoring_Point';
  protected $pointsDataType = 'array';
  protected $timeseriesDescType = 'CloudMonitoring_TimeseriesDescriptor';
  ...
  public function setTimeseriesDesc(CloudMonitoring_TimeseriesDescriptor $timeseriesDesc)
  {
...
class CloudMonitoring_TimeseriesDescriptor extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $labels;
...
class CloudMonitoring_TimeseriesDescriptorLabel extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class CloudMonitoring_TimeseriesDescriptorLabels extends Model
{
}

class CloudMonitoring_TimeseriesPoint extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $pointType = 'CloudMonitoring_Point';
  protected $pointDataType = '';
  protected $timeseriesDescType = 'CloudMonitoring_TimeseriesDescriptor';
  protected $timeseriesDescDataType = '';


  public function setPoint(CloudMonitoring_Point $point)
  {
    $this->point = $point;
  }
...
class CloudMonitoring_WriteTimeseriesRequest extends Collection
{
  protected $collection_key = 'timeseries';
  protected $internal_gapi_mappings = array(
  );
  public $commonLabels;
  protected $timeseriesType = 'CloudMonitoring_TimeseriesPoint';
  protected $timeseriesDataType = 'array';
...
class CloudMonitoring_WriteTimeseriesRequestCommonLabels extends Model
{
}

class CloudMonitoring_WriteTimeseriesResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;

 ...
 * @author Google, Inc.
 */
class Cloudbilling extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->billingAccounts = new Cloudbilling_BillingAccounts_Resource(
        $this,
        $this->serviceName,
        'billingAccounts',
        array(
    ...
    $this->billingAccounts_projects = new Cloudbilling_BillingAccountsProjects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->projects = new Cloudbilling_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $cloudbillingService = new Cloudbilling(...);
 *   $billingAccounts = $cloudbillingService->billingAccounts;
 *  </code>
 */
class Cloudbilling_BillingAccounts_Resource extends Resource
{
   ...
   * @return Cloudbilling_BillingAccount
   */
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Cloudbilling_BillingAccount");
  }
   ...
   * @return Cloudbilling_ListBillingAccountsResponse
   */
  public function listBillingAccounts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Cloudbilling_ListBillingAccountsResponse");
  }
}
 ...
 *  </code>
 */
class Cloudbilling_BillingAccountsProjects_Resource extends Resource
{
   ...
   * @opt_param int pageSize Requested page size. The maximum page size is 100;
   * this is also the default.
   * @return Cloudbilling_ListProjectBillingInfoResponse
   */
  public function listBillingAccountsProjects($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Cloudbilling_ListProjectBillingInfoResponse");
  }
}
 ...
 *  </code>
 */
class Cloudbilling_Projects_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Cloudbilling_ProjectBillingInfo
   */
  public function getBillingInfo($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('getBillingInfo', array($params), "Cloudbilling_ProjectBillingInfo");
  }
   ...
   * @return Cloudbilling_ProjectBillingInfo
   */
  public function updateBillingInfo($name, Cloudbilling_ProjectBillingInfo $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('updateBillingInfo', array($params), "Cloudbilling_ProjectBillingInfo");
  }
}
...
class Cloudbilling_BillingAccount extends Model
{
...
class Cloudbilling_ListBillingAccountsResponse extends Collection
{
  protected $collection_key = 'billingAccounts';
  protected $internal_gapi_mappings = array(
  );
  protected $billingAccountsType = 'Cloudbilling_BillingAccount';
...
class Cloudbilling_ListProjectBillingInfoResponse extends Collection
{
  protected $collection_key = 'projectBillingInfo';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $projectBillingInfoType = 'Cloudbilling_ProjectBillingInfo';
...
class Cloudbilling_ProjectBillingInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );

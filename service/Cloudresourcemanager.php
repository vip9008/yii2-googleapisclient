 ...
 * @author Google, Inc.
 */
class Cloudresourcemanager extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->organizations = new Cloudresourcemanager_Organizations_Resource(
        $this,
        $this->serviceName,
        'organizations',
        array(
    ...
    $this->projects = new Cloudresourcemanager_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $cloudresourcemanagerService = new Cloudresourcemanager(...);
 *   $organizations = $cloudresourcemanagerService->organizations;
 *  </code>
 */
class Cloudresourcemanager_Organizations_Resource extends Resource
{
   ...
   * @return Cloudresourcemanager_Organization
   */
  public function get($organizationId, $optParams = array())
  {
    $params = array('organizationId' => $organizationId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Cloudresourcemanager_Organization");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Cloudresourcemanager_Policy
   */
  public function getIamPolicy($resource, Cloudresourcemanager_GetIamPolicyRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('getIamPolicy', array($params), "Cloudresourcemanager_Policy");
  }
   ...
   * @return Cloudresourcemanager_ListOrganizationsResponse
   */
  public function listOrganizations($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Cloudresourcemanager_ListOrganizationsResponse");
  }
   ...
   * @return Cloudresourcemanager_Policy
   */
  public function setIamPolicy($resource, Cloudresourcemanager_SetIamPolicyRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setIamPolicy', array($params), "Cloudresourcemanager_Policy");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Cloudresourcemanager_TestIamPermissionsResponse
   */
  public function testIamPermissions($resource, Cloudresourcemanager_TestIamPermissionsRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('testIamPermissions', array($params), "Cloudresourcemanager_TestIamPermissionsResponse");
  }
   ...
   * @return Cloudresourcemanager_Organization
   */
  public function update($organizationId, Cloudresourcemanager_Organization $postBody, $optParams = array())
  {
    $params = array('organizationId' => $organizationId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Cloudresourcemanager_Organization");
  }
}
 ...
 *  </code>
 */
class Cloudresourcemanager_Projects_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Cloudresourcemanager_Project
   */
  public function create(Cloudresourcemanager_Project $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Cloudresourcemanager_Project");
  }
   ...
   * Required.
   * @param array $optParams Optional parameters.
   * @return Cloudresourcemanager_Empty
   */
  public function delete($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Cloudresourcemanager_Empty");
  }
  ...
  public function get($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Cloudresourcemanager_Project");
  }
   ...
   * @return Cloudresourcemanager_ListProjectsResponse
   */
  public function listProjects($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Cloudresourcemanager_ListProjectsResponse");
  }
  ...
  public function undelete($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('undelete', array($params), "Cloudresourcemanager_Empty");
  }
   ...
   * @return Cloudresourcemanager_Project
   */
  public function update($projectId, Cloudresourcemanager_Project $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Cloudresourcemanager_Project");
  }
}
...
class Cloudresourcemanager_Binding extends Collection
{
...
class Cloudresourcemanager_Empty extends Model
{
}

class Cloudresourcemanager_GetIamPolicyRequest extends Model
{
}

class Cloudresourcemanager_ListOrganizationsResponse extends Collection
{
  protected $collection_key = 'organizations';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $organizationsType = 'Cloudresourcemanager_Organization';
...
class Cloudresourcemanager_ListProjectsResponse extends Collection
{
  protected $collection_key = 'projects';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $projectsType = 'Cloudresourcemanager_Project';
...
class Cloudresourcemanager_Organization extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
  public $organizationId;
  protected $ownerType = 'Cloudresourcemanager_OrganizationOwner';
  ...
  public function setOwner(Cloudresourcemanager_OrganizationOwner $owner)
  {
    $this->owner = $owner;
  }
...
class Cloudresourcemanager_OrganizationOwner extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Cloudresourcemanager_Policy extends Collection
{
  protected $collection_key = 'bindings';
  protected $internal_gapi_mappings = array(
  );
  protected $bindingsType = 'Cloudresourcemanager_Binding';
...
class Cloudresourcemanager_Project extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $createTime;
  ...
  public $name;
  protected $parentType = 'Cloudresourcemanager_ResourceId';
  ...
  public function setParent(Cloudresourcemanager_ResourceId $parent)
  {
    $this->parent = $parent;
  }
...
class Cloudresourcemanager_ProjectLabels extends Model
{
}

class Cloudresourcemanager_ResourceId extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Cloudresourcemanager_SetIamPolicyRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $policyType = 'Cloudresourcemanager_Policy';
  protected $policyDataType = '';


  public function setPolicy(Cloudresourcemanager_Policy $policy)
  {
    $this->policy = $policy;
  }
...
class Cloudresourcemanager_TestIamPermissionsRequest extends Collection
{
...
class Cloudresourcemanager_TestIamPermissionsResponse extends Collection
{
  protected $collection_key = 'permissions';
  protected $internal_gapi_mappings = array(
  );

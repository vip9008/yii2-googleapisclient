 ...
 * @author Google, Inc.
 */
class Cloudtrace extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->projects = new Cloudtrace_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->projects_traces = new Cloudtrace_ProjectsTraces_Resource(
        $this,
        $this->serviceName,
        'traces',
        array(
    ...
    $this->v1 = new Cloudtrace_V1_Resource(
        $this,
        $this->serviceName,
        'v1',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $cloudtraceService = new Cloudtrace(...);
 *   $projects = $cloudtraceService->projects;
 *  </code>
 */
class Cloudtrace_Projects_Resource extends Resource
{
   ...
   * @return Cloudtrace_Empty
   */
  public function patchTraces($projectId, Cloudtrace_Traces $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patchTraces', array($params), "Cloudtrace_Empty");
  }
}
 ...
 *  </code>
 */
class Cloudtrace_ProjectsTraces_Resource extends Resource
{
   ...
   * @return Cloudtrace_ListTracesResponse
   */
  public function listProjectsTraces($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Cloudtrace_ListTracesResponse");
  }
}
 ...
 *  </code>
 */
class Cloudtrace_V1_Resource extends Resource
{
...
class Cloudtrace_Empty extends Model
{
}

class Cloudtrace_ListTracesResponse extends Collection
{
  protected $collection_key = 'traces';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $tracesType = 'Cloudtrace_Trace';
...
class Cloudtrace_Trace extends Collection
{
  protected $collection_key = 'spans';
  protected $internal_gapi_mappings = array(
  );
  public $projectId;
  protected $spansType = 'Cloudtrace_TraceSpan';
...
class Cloudtrace_TraceSpan extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTime;
...
class Cloudtrace_TraceSpanLabels extends Model
{
}

class Cloudtrace_Traces extends Collection
{
  protected $collection_key = 'traces';
  protected $internal_gapi_mappings = array(
  );

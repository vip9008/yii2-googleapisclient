 ...
 * @author Google, Inc.
 */
class Computeaccounts extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->globalAccountsOperations = new Computeaccounts_GlobalAccountsOperations_Resource(
        $this,
        $this->serviceName,
    ...
    $this->groups = new Computeaccounts_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
    ...
    $this->linux = new Computeaccounts_Linux_Resource(
        $this,
        $this->serviceName,
        'linux',
        array(
    ...
    $this->users = new Computeaccounts_Users_Resource(
        $this,
        $this->serviceName,
        'users',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $computeaccountsService = new Computeaccounts(...);
 *   $globalAccountsOperations = $computeaccountsService->globalAccountsOperations;
 *  </code>
 */
class Computeaccounts_GlobalAccountsOperations_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Computeaccounts_Operation
   */
  public function get($project, $operation, $optParams = array())
  {
    $params = array('project' => $project, 'operation' => $operation);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Computeaccounts_Operation");
  }
   ...
   * @return Computeaccounts_OperationList
   */
  public function listGlobalAccountsOperations($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Computeaccounts_OperationList");
  }
}
 ...
 *  </code>
 */
class Computeaccounts_Groups_Resource extends Resource
{
   ...
   * @return Computeaccounts_Operation
   */
  public function addMember($project, $groupName, Computeaccounts_GroupsAddMemberRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'groupName' => $groupName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('addMember', array($params), "Computeaccounts_Operation");
  }
  ...
  public function delete($project, $groupName, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Computeaccounts_Operation");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Computeaccounts_Group
   */
  public function get($project, $groupName, $optParams = array())
  {
    $params = array('project' => $project, 'groupName' => $groupName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Computeaccounts_Group");
  }
   ...
   * @return Computeaccounts_Operation
   */
  public function insert($project, Computeaccounts_Group $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Computeaccounts_Operation");
  }
   ...
   * @opt_param string maxResults Optional. Maximum count of results to be
   * returned. Maximum value is 500 and default value is 500.
   * @return Computeaccounts_GroupList
   */
  public function listGroups($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Computeaccounts_GroupList");
  }
   ...
   * @return Computeaccounts_Operation
   */
  public function removeMember($project, $groupName, Computeaccounts_GroupsRemoveMemberRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'groupName' => $groupName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('removeMember', array($params), "Computeaccounts_Operation");
  }
}
 ...
 *  </code>
 */
class Computeaccounts_Linux_Resource extends Resource
{
   ...
   * the view.
   * @param array $optParams Optional parameters.
   * @return Computeaccounts_LinuxGetAuthorizedKeysViewResponse
   */
  public function getAuthorizedKeysView($project, $zone, $user, $instance, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('getAuthorizedKeysView', array($params), "Computeaccounts_LinuxGetAuthorizedKeysViewResponse");
  }
   ...
   * @return Computeaccounts_LinuxGetLinuxAccountViewsResponse
   */
  public function getLinuxAccountViews($project, $zone, $instance, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'instance' => $instance);
    $params = array_merge($params, $optParams);
    return $this->call('getLinuxAccountViews', array($params), "Computeaccounts_LinuxGetLinuxAccountViewsResponse");
  }
}
 ...
 *  </code>
 */
class Computeaccounts_Users_Resource extends Resource
{
   ...
   * @return Computeaccounts_Operation
   */
  public function addPublicKey($project, $user, Computeaccounts_PublicKey $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'user' => $user, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('addPublicKey', array($params), "Computeaccounts_Operation");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Computeaccounts_User
   */
  public function get($project, $user, $optParams = array())
  {
    $params = array('project' => $project, 'user' => $user);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Computeaccounts_User");
  }
   ...
   * @return Computeaccounts_Operation
   */
  public function insert($project, Computeaccounts_User $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Computeaccounts_Operation");
   ...
   * @opt_param string maxResults Optional. Maximum count of results to be
   * returned. Maximum value is 500 and default value is 500.
   * @return Computeaccounts_UserList
   */
  public function listUsers($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Computeaccounts_UserList");
  }
  ...
  public function removePublicKey($project, $user, $fingerprint, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('removePublicKey', array($params), "Computeaccounts_Operation");
  }
}
...
class Computeaccounts_AuthorizedKeysView extends Collection
{
...
class Computeaccounts_Group extends Collection
{
...
class Computeaccounts_GroupList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $itemsType = 'Computeaccounts_Group';
...
class Computeaccounts_GroupsAddMemberRequest extends Collection
{
...
class Computeaccounts_GroupsRemoveMemberRequest extends Collection
{
  protected $collection_key = 'users';
  protected $internal_gapi_mappings = array(
  );
...
class Computeaccounts_LinuxAccountViews extends Collection
{
  protected $collection_key = 'userViews';
  protected $internal_gapi_mappings = array(
  );
  protected $groupViewsType = 'Computeaccounts_LinuxGroupView';
  protected $groupViewsDataType = 'array';
  public $kind;
  protected $userViewsType = 'Computeaccounts_LinuxUserView';
...
class Computeaccounts_LinuxGetAuthorizedKeysViewResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $resourceType = 'Computeaccounts_AuthorizedKeysView';
  protected $resourceDataType = '';


  public function setResource(Computeaccounts_AuthorizedKeysView $resource)
  {
...
class Computeaccounts_LinuxGetLinuxAccountViewsResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $resourceType = 'Computeaccounts_LinuxAccountViews';
  protected $resourceDataType = '';


  public function setResource(Computeaccounts_LinuxAccountViews $resource)
  {
    $this->resource = $resource;
  }
  public function getResource()
...
class Computeaccounts_LinuxGroupView extends Collection
{
  protected $collection_key = 'members';
  protected $internal_gapi_mappings = array(
  );
...
class Computeaccounts_LinuxUserView extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $gecos;
...
class Computeaccounts_Operation extends Collection
{
  ...
  public $creationTimestamp;
  public $endTime;
  protected $errorType = 'Computeaccounts_OperationError';
  ...
  public $targetLink;
  public $user;
  protected $warningsType = 'Computeaccounts_OperationWarnings';
  ...
  public function setError(Computeaccounts_OperationError $error)
  {
    $this->error = $error;
  }
...
class Computeaccounts_OperationError extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'Computeaccounts_OperationErrorErrors';
...
class Computeaccounts_OperationErrorErrors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class Computeaccounts_OperationList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $itemsType = 'Computeaccounts_Operation';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $selfLink;
...
class Computeaccounts_OperationWarnings extends Collection
{
  protected $collection_key = 'data';
  protected $internal_gapi_mappings = array(
  );
  public $code;
  protected $dataType = 'Computeaccounts_OperationWarningsData';
...
class Computeaccounts_OperationWarningsData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class Computeaccounts_PublicKey extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $creationTimestamp;
...
class Computeaccounts_User extends Collection
{
  ...
  public $name;
  public $owner;
  protected $publicKeysType = 'Computeaccounts_PublicKey';
...
class Computeaccounts_UserList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $itemsType = 'Computeaccounts_User';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $selfLink;

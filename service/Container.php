...
class Container extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->projects_zones = new Container_ProjectsZones_Resource(
        $this,
        $this->serviceName,
        'zones',
        array(
    ...
    $this->projects_zones_clusters = new Container_ProjectsZonesClusters_Resource(
        $this,
        $this->serviceName,
        'clusters',
        array(
    ...
    $this->projects_zones_operations = new Container_ProjectsZonesOperations_Resource(
        $this,
        $this->serviceName,
        'operations',
        array(
 ...
 *  </code>
 */
class Container_Projects_Resource extends Resource
{
}
 ...
 *  </code>
 */
class Container_ProjectsZones_Resource extends Resource
{
 ...
 *  </code>
 */
class Container_ProjectsZonesClusters_Resource extends Resource
{
   ...
   */
  public function create($projectId, $zone, Container_CreateClusterRequest $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zone' => $zone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Container_Operation");
  }
  ...
  public function delete($projectId, $zone, $clusterId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Container_Operation");
  }
  ...
  public function get($projectId, $zone, $clusterId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zone' => $zone, 'clusterId' => $clusterId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Container_Cluster");
  }
   ...
   * for all zones.
   * @param array $optParams Optional parameters.
   * @return Container_ListClustersResponse
   */
  public function listProjectsZonesClusters($projectId, $zone, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Container_ListClustersResponse");
  }
   ...
   * @return Container_Operation
   */
  public function update($projectId, $zone, $clusterId, Container_UpdateClusterRequest $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zone' => $zone, 'clusterId' => $clusterId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Container_Operation");
  }
}
/**
 ...
 *  </code>
 */
class Container_ProjectsZonesOperations_Resource extends Resource
{
  ...
  public function get($projectId, $zone, $operationId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Container_Operation");
  }
   ...
   * all zones.
   * @param array $optParams Optional parameters.
   * @return Container_ListOperationsResponse
   */
  public function listProjectsZonesOperations($projectId, $zone, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Container_ListOperationsResponse");
  }
}
...
class Container_Cluster extends Collection
{
  ...
  protected $masterAuthType = 'Container_MasterAuth';
  protected $masterAuthDataType = '';
  public $monitoringService;
  public $name;
  public $network;
  protected $nodeConfigType = 'Container_NodeConfig';
  ...
  public function setMasterAuth(Container_MasterAuth $masterAuth)
  {
  ...
  public function setNodeConfig(Container_NodeConfig $nodeConfig)
  {
...
class Container_ClusterUpdate extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Container_CreateClusterRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $clusterType = 'Container_Cluster';
  protected $clusterDataType = '';


  public function setCluster(Container_Cluster $cluster)
  {
...
class Container_ListClustersResponse extends Collection
{
  protected $collection_key = 'clusters';
  protected $internal_gapi_mappings = array(
  );
  protected $clustersType = 'Container_Cluster';
...
class Container_ListOperationsResponse extends Collection
{
  protected $collection_key = 'operations';
  protected $internal_gapi_mappings = array(
  );
  protected $operationsType = 'Container_Operation';
...
class Container_MasterAuth extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Container_NodeConfig extends Collection
{
...
class Container_Operation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class Container_ServerConfig extends Collection
{
...
class Container_UpdateClusterRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $updateType = 'Container_ClusterUpdate';
  protected $updateDataType = '';


  public function setUpdate(Container_ClusterUpdate $update)
  {
    $this->update = $update;
  }

 ...
 * @author Google, Inc.
 */
class Coordinate extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->customFieldDef = new Coordinate_CustomFieldDef_Resource(
        $this,
        $this->serviceName,
        'customFieldDef',
        array(
    ...
    $this->jobs = new Coordinate_Jobs_Resource(
        $this,
        $this->serviceName,
        'jobs',
        array(
    ...
    $this->location = new Coordinate_Location_Resource(
        $this,
        $this->serviceName,
        'location',
        array(
    ...
    $this->schedule = new Coordinate_Schedule_Resource(
        $this,
        $this->serviceName,
        'schedule',
        array(
    ...
    $this->team = new Coordinate_Team_Resource(
        $this,
        $this->serviceName,
        'team',
        array(
    ...
    $this->worker = new Coordinate_Worker_Resource(
        $this,
        $this->serviceName,
        'worker',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $coordinateService = new Coordinate(...);
 *   $customFieldDef = $coordinateService->customFieldDef;
 *  </code>
 */
class Coordinate_CustomFieldDef_Resource extends Resource
{
   ...
   * @return Coordinate_CustomFieldDefListResponse
   */
  public function listCustomFieldDef($teamId, $optParams = array())
  {
    $params = array('teamId' => $teamId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Coordinate_CustomFieldDefListResponse");
  }
}
 ...
 *  </code>
 */
class Coordinate_Jobs_Resource extends Resource
{
   ...
   * @return Coordinate_Job
   */
  public function insert($teamId, $address, $lat, $lng, $title, Coordinate_Job $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'address' => $address, 'lat' => $lat, 'lng' => $lng, 'title' => $title, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Coordinate_Job");
  }
   ...
   * information.
   * @return Coordinate_JobListResponse
   */
  public function listJobs($teamId, $optParams = array())
  {
    $params = array('teamId' => $teamId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Coordinate_JobListResponse");
  }
   ...
   * @return Coordinate_Job
   */
  public function patch($teamId, $jobId, Coordinate_Job $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Coordinate_Job");
  }
   ...
   * @return Coordinate_Job
   */
  public function update($teamId, $jobId, Coordinate_Job $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Coordinate_Job");
  }
}
 ...
 *  </code>
 */
class Coordinate_Location_Resource extends Resource
{
   ...
   * @opt_param string pageToken Continuation token
   * @opt_param string maxResults Maximum number of results to return in one page.
   * @return Coordinate_LocationListResponse
   */
  public function listLocation($teamId, $workerEmail, $startTimestampMs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Coordinate_LocationListResponse");
  }
}
 ...
 *  </code>
 */
class Coordinate_Schedule_Resource extends Resource
{
  ...
  public function get($teamId, $jobId, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Coordinate_Schedule");
  }
   ...
   * @return Coordinate_Schedule
   */
  public function patch($teamId, $jobId, Coordinate_Schedule $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Coordinate_Schedule");
  }
   ...
   * @return Coordinate_Schedule
   */
  public function update($teamId, $jobId, Coordinate_Schedule $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Coordinate_Schedule");
  }
}
 ...
 *  </code>
 */
class Coordinate_Team_Resource extends Resource
{
   ...
   * the Dispatcher role.
   * @return Coordinate_TeamListResponse
   */
  public function listTeam($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Coordinate_TeamListResponse");
  }
}
 ...
 *  </code>
 */
class Coordinate_Worker_Resource extends Resource
{
   ...
   * @param string $teamId Team ID
   * @param array $optParams Optional parameters.
   * @return Coordinate_WorkerListResponse
   */
  public function listWorker($teamId, $optParams = array())
  {
    $params = array('teamId' => $teamId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Coordinate_WorkerListResponse");
  }
}
...
class Coordinate_CustomField extends Model
{
...
class Coordinate_CustomFieldDef extends Collection
{
  protected $collection_key = 'enumitems';
  protected $internal_gapi_mappings = array(
  );
  public $enabled;
  protected $enumitemsType = 'Coordinate_EnumItemDef';
...
class Coordinate_CustomFieldDefListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Coordinate_CustomFieldDef';
...
class Coordinate_CustomFields extends Collection
{
  protected $collection_key = 'customField';
  protected $internal_gapi_mappings = array(
  );
  protected $customFieldType = 'Coordinate_CustomField';
...
class Coordinate_EnumItemDef extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $active;
...
class Coordinate_Job extends Collection
{
  protected $collection_key = 'jobChange';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $jobChangeType = 'Coordinate_JobChange';
  protected $jobChangeDataType = 'array';
  public $kind;
  protected $stateType = 'Coordinate_JobState';
  ...
  public function setState(Coordinate_JobState $state)
  {
    $this->state = $state;
  }
...
class Coordinate_JobChange extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Coordinate_JobListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Coordinate_Job';
  protected $itemsDataType = 'array';
  public $kind;
...
class Coordinate_JobState extends Collection
{
  protected $collection_key = 'note';
  protected $internal_gapi_mappings = array(
  );
  public $assignee;
  protected $customFieldsType = 'Coordinate_CustomFields';
  protected $customFieldsDataType = '';
  public $customerName;
  public $customerPhoneNumber;
  public $kind;
  protected $locationType = 'Coordinate_Location';
  ...
  public function setCustomFields(Coordinate_CustomFields $customFields)
  {
  ...
  public function setLocation(Coordinate_Location $location)
  {
...
class Coordinate_Location extends Collection
{
...
class Coordinate_LocationListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Coordinate_LocationRecord';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  protected $tokenPaginationType = 'Coordinate_TokenPagination';
  ...
  public function setTokenPagination(Coordinate_TokenPagination $tokenPagination)
  {
...
class Coordinate_LocationRecord extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Coordinate_Schedule extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $allDay;
...
class Coordinate_Team extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Coordinate_TeamListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Coordinate_Team';
  protected $itemsDataType = 'array';
  public $kind;
...
class Coordinate_TokenPagination extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Coordinate_Worker extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Coordinate_WorkerListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Coordinate_Worker';
  protected $itemsDataType = 'array';
  public $kind;

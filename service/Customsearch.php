 ...
 * @author Google, Inc.
 */
class Customsearch extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->cse = new Customsearch_Cse_Resource(
        $this,
        $this->serviceName,
        'cse',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $customsearchService = new Customsearch(...);
 *   $cse = $customsearchService->cse;
 *  </code>
 */
class Customsearch_Cse_Resource extends Resource
{
   ...
   * @return Customsearch_Search
   */
  public function listCse($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Customsearch_Search");
  }
}
...
class Customsearch_Context extends Collection
{
  protected $collection_key = 'facets';
  protected $internal_gapi_mappings = array(
  );
  protected $facetsType = 'Customsearch_ContextFacets';
...
class Customsearch_ContextFacets extends Model
{
  protected $internal_gapi_mappings = array(
...
class Customsearch_Promotion extends Collection
{
  protected $collection_key = 'bodyLines';
  protected $internal_gapi_mappings = array(
  );
  protected $bodyLinesType = 'Customsearch_PromotionBodyLines';
  protected $bodyLinesDataType = 'array';
  public $displayLink;
  public $htmlTitle;
  protected $imageType = 'Customsearch_PromotionImage';
  ...
  public function setImage(Customsearch_PromotionImage $image)
  {
    $this->image = $image;
  }
...
class Customsearch_PromotionBodyLines extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $htmlTitle;
...
class Customsearch_PromotionImage extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $height;
...
class Customsearch_Query extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Customsearch_Result extends Collection
{
  ...
  public $htmlSnippet;
  public $htmlTitle;
  protected $imageType = 'Customsearch_ResultImage';
  protected $imageDataType = '';
  public $kind;
  protected $labelsType = 'Customsearch_ResultLabels';
  ...
  public function setImage(Customsearch_ResultImage $image)
  {
    $this->image = $image;
  }
  public function getImage()
...
class Customsearch_ResultImage extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $byteSize;
...
class Customsearch_ResultLabels extends Model
{
  protected $internal_gapi_mappings = array(
        "labelWithOp" => "label_with_op",
  );
...
class Customsearch_ResultPagemap extends Model
{
}

class Customsearch_ResultPagemapItemElement extends Model
{
}

class Customsearch_Search extends Collection
{
  protected $collection_key = 'promotions';
  protected $internal_gapi_mappings = array(
  );
  protected $contextType = 'Customsearch_Context';
  protected $contextDataType = '';
  protected $itemsType = 'Customsearch_Result';
  protected $itemsDataType = 'array';
  public $kind;
  protected $promotionsType = 'Customsearch_Promotion';
  protected $promotionsDataType = 'array';
  protected $queriesType = 'Customsearch_Query';
  protected $queriesDataType = 'map';
  protected $searchInformationType = 'Customsearch_SearchSearchInformation';
  protected $searchInformationDataType = '';
  protected $spellingType = 'Customsearch_SearchSpelling';
  protected $spellingDataType = '';
  protected $urlType = 'Customsearch_SearchUrl';
  protected $urlDataType = '';


  public function setContext(Customsearch_Context $context)
  {
  ...
  public function setSearchInformation(Customsearch_SearchSearchInformation $searchInformation)
  {
  ...
  public function setSpelling(Customsearch_SearchSpelling $spelling)
  {
  ...
  public function setUrl(Customsearch_SearchUrl $url)
  {
    $this->url = $url;
  }
  public function getUrl()
...
class Customsearch_SearchQueries extends Model
{
}

class Customsearch_SearchSearchInformation extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Customsearch_SearchSpelling extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Customsearch_SearchUrl extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $template;

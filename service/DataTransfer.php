 ...
 * @author Google, Inc.
 */
class DataTransfer extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->applications = new DataTransfer_Applications_Resource(
        $this,
        $this->serviceName,
        'applications',
        array(
    ...
    $this->transfers = new DataTransfer_Transfers_Resource(
        $this,
        $this->serviceName,
        'transfers',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new DataTransfer(...);
 *   $applications = $adminService->applications;
 *  </code>
 */
class DataTransfer_Applications_Resource extends Resource
{
   ...
   * @return DataTransfer_Application
   */
  public function get($applicationId, $optParams = array())
  {
    $params = array('applicationId' => $applicationId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "DataTransfer_Application");
  }
   ...
   * 100.
   * @return DataTransfer_ApplicationsListResponse
   */
  public function listApplications($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "DataTransfer_ApplicationsListResponse");
  }
}
 ...
 *  </code>
 */
class DataTransfer_Transfers_Resource extends Resource
{
   ...
   * @return DataTransfer_DataTransfer
   */
  public function insert(DataTransfer_DataTransfer $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "DataTransfer_DataTransfer");
  }
   ...
   * @opt_param string customerId Immutable ID of the Google Apps account.
   * @return DataTransfer_DataTransfersListResponse
   */
  public function listTransfers($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "DataTransfer_DataTransfersListResponse");
  }
}
...
class DataTransfer_Application extends Collection
{
  ...
  public $kind;
  public $name;
  protected $transferParamsType = 'DataTransfer_ApplicationTransferParam';
...
class DataTransfer_ApplicationDataTransfer extends Collection
{
  protected $collection_key = 'applicationTransferParams';
  protected $internal_gapi_mappings = array(
  );
  public $applicationId;
  protected $applicationTransferParamsType = 'DataTransfer_ApplicationTransferParam';
...
class DataTransfer_ApplicationTransferParam extends Collection
{
...
class DataTransfer_ApplicationsListResponse extends Collection
{
  protected $collection_key = 'applications';
  protected $internal_gapi_mappings = array(
  );
  protected $applicationsType = 'DataTransfer_Application';
...
class DataTransfer_DataTransfer extends Collection
{
  protected $collection_key = 'applicationDataTransfers';
  protected $internal_gapi_mappings = array(
  );
  protected $applicationDataTransfersType = 'DataTransfer_ApplicationDataTransfer';
...
class DataTransfer_DataTransfersListResponse extends Collection
{
  protected $collection_key = 'dataTransfers';
  protected $internal_gapi_mappings = array(
  );
  protected $dataTransfersType = 'DataTransfer_DataTransfer';

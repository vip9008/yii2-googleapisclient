 ...
 * @author Google, Inc.
 */
class Directory extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->asps = new Directory_Asps_Resource(
        $this,
        $this->serviceName,
        'asps',
        array(
    ...
    $this->channels = new Directory_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->chromeosdevices = new Directory_Chromeosdevices_Resource(
        $this,
        $this->serviceName,
        'chromeosdevices',
        array(
    ...
    $this->customers = new Directory_Customers_Resource(
        $this,
        $this->serviceName,
        'customers',
        array(
    ...
    $this->domainAliases = new Directory_DomainAliases_Resource(
        $this,
        $this->serviceName,
        'domainAliases',
        array(
    ...
    $this->domains = new Directory_Domains_Resource(
        $this,
        $this->serviceName,
        'domains',
        array(
    ...
    $this->groups = new Directory_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
    ...
    $this->groups_aliases = new Directory_GroupsAliases_Resource(
        $this,
        $this->serviceName,
        'aliases',
        array(
    ...
    $this->members = new Directory_Members_Resource(
        $this,
        $this->serviceName,
        'members',
        array(
    ...
    $this->mobiledevices = new Directory_Mobiledevices_Resource(
        $this,
        $this->serviceName,
        'mobiledevices',
        array(
    ...
    $this->notifications = new Directory_Notifications_Resource(
        $this,
        $this->serviceName,
        'notifications',
        array(
    ...
    $this->orgunits = new Directory_Orgunits_Resource(
        $this,
        $this->serviceName,
        'orgunits',
        array(
    ...
    $this->privileges = new Directory_Privileges_Resource(
        $this,
        $this->serviceName,
        'privileges',
        array(
    ...
    $this->roleAssignments = new Directory_RoleAssignments_Resource(
        $this,
        $this->serviceName,
        'roleAssignments',
        array(
    ...
    $this->roles = new Directory_Roles_Resource(
        $this,
        $this->serviceName,
        'roles',
        array(
    ...
    $this->schemas = new Directory_Schemas_Resource(
        $this,
        $this->serviceName,
        'schemas',
        array(
    ...
    $this->tokens = new Directory_Tokens_Resource(
        $this,
        $this->serviceName,
        'tokens',
        array(
    ...
    $this->users = new Directory_Users_Resource(
        $this,
        $this->serviceName,
        'users',
        array(
    ...
    $this->users_aliases = new Directory_UsersAliases_Resource(
        $this,
        $this->serviceName,
        'aliases',
        array(
    ...
    $this->users_photos = new Directory_UsersPhotos_Resource(
        $this,
        $this->serviceName,
        'photos',
        array(
    ...
    $this->verificationCodes = new Directory_VerificationCodes_Resource(
        $this,
        $this->serviceName,
        'verificationCodes',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new Directory(...);
 *   $asps = $adminService->asps;
 *  </code>
 */
class Directory_Asps_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Directory_Asp
   */
  public function get($userKey, $codeId, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'codeId' => $codeId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Asp");
  }
   ...
   * be the user's primary email address, alias email address, or unique user ID.
   * @param array $optParams Optional parameters.
   * @return Directory_Asps
   */
  public function listAsps($userKey, $optParams = array())
  {
    $params = array('userKey' => $userKey);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Asps");
  }
}
 ...
 *  </code>
 */
class Directory_Channels_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(Directory_Channel $postBody, $optParams = array())
  {
 ...
 *  </code>
 */
class Directory_Chromeosdevices_Resource extends Resource
{
   ...
   * @return Directory_ChromeOsDevices
   */
  public function listChromeosdevices($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_ChromeOsDevices");
  }
   ...
   * @return Directory_ChromeOsDevice
   */
  public function patch($customerId, $deviceId, Directory_ChromeOsDevice $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'deviceId' => $deviceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_ChromeOsDevice");
  }
   ...
   * @return Directory_ChromeOsDevice
   */
  public function update($customerId, $deviceId, Directory_ChromeOsDevice $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'deviceId' => $deviceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_ChromeOsDevice");
  }
}
 ...
 *  </code>
 */
class Directory_Customers_Resource extends Resource
{
  ...
  public function get($customerKey, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Customer");
  }
   ...
   * @return Directory_Customer
   */
  public function patch($customerKey, Directory_Customer $postBody, $optParams = array())
  {
    $params = array('customerKey' => $customerKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_Customer");
  }
   ...
   * @return Directory_Customer
   */
  public function update($customerKey, Directory_Customer $postBody, $optParams = array())
  {
    $params = array('customerKey' => $customerKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_Customer");
  }
}
 ...
 *  </code>
 */
class Directory_DomainAliases_Resource extends Resource
{
   ...
   * @param string $domainAliasName Name of domain alias to be retrieved.
   * @param array $optParams Optional parameters.
   * @return Directory_DomainAlias
   */
  public function get($customer, $domainAliasName, $optParams = array())
  {
    $params = array('customer' => $customer, 'domainAliasName' => $domainAliasName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_DomainAlias");
  }
   ...
   * @return Directory_DomainAlias
   */
  public function insert($customer, Directory_DomainAlias $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_DomainAlias");
  }
   ...
   * @return Directory_DomainAliases
   */
  public function listDomainAliases($customer, $optParams = array())
  {
    $params = array('customer' => $customer);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_DomainAliases");
  }
}
 ...
 *  </code>
 */
class Directory_Domains_Resource extends Resource
{
  ...
  public function get($customer, $domainName, $optParams = array())
  {
    $params = array('customer' => $customer, 'domainName' => $domainName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Domains");
  }
   ...
   * @return Directory_Domains
   */
  public function insert($customer, Directory_Domains $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_Domains");
  }
   ...
   * @param string $customer Immutable id of the Google Apps account.
   * @param array $optParams Optional parameters.
   * @return Directory_Domains2
   */
  public function listDomains($customer, $optParams = array())
  {
    $params = array('customer' => $customer);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Domains2");
  }
}
 ...
 *  </code>
 */
class Directory_Groups_Resource extends Resource
{
  ...
  public function get($groupKey, $optParams = array())
  {
    $params = array('groupKey' => $groupKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Group");
  }
   ...
   * @return Directory_Group
   */
  public function insert(Directory_Group $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_Group");
  }
  ...
  public function listGroups($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Groups");
  }
   ...
   * @return Directory_Group
   */
  public function patch($groupKey, Directory_Group $postBody, $optParams = array())
  {
    $params = array('groupKey' => $groupKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_Group");
  }
   ...
   * @return Directory_Group
   */
  public function update($groupKey, Directory_Group $postBody, $optParams = array())
  {
    $params = array('groupKey' => $groupKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_Group");
  }
}
 ...
 *  </code>
 */
class Directory_GroupsAliases_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Directory_Alias
   */
  public function insert($groupKey, Directory_Alias $postBody, $optParams = array())
  {
    $params = array('groupKey' => $groupKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_Alias");
  }
   ...
   * @param string $groupKey Email or immutable Id of the group
   * @param array $optParams Optional parameters.
   * @return Directory_Aliases
   */
  public function listGroupsAliases($groupKey, $optParams = array())
  {
    $params = array('groupKey' => $groupKey);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Aliases");
  }
}
 ...
 *  </code>
 */
class Directory_Members_Resource extends Resource
{
   ...
   * @param string $memberKey Email or immutable Id of the member
   * @param array $optParams Optional parameters.
   * @return Directory_Member
   */
  public function get($groupKey, $memberKey, $optParams = array())
  {
    $params = array('groupKey' => $groupKey, 'memberKey' => $memberKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Member");
  }
   ...
   * @return Directory_Member
   */
  public function insert($groupKey, Directory_Member $postBody, $optParams = array())
  {
    $params = array('groupKey' => $groupKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_Member");
  }
  ...
  public function listMembers($groupKey, $optParams = array())
  {
    $params = array('groupKey' => $groupKey);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Members");
  }
   ...
   * @return Directory_Member
   */
  public function patch($groupKey, $memberKey, Directory_Member $postBody, $optParams = array())
  {
    $params = array('groupKey' => $groupKey, 'memberKey' => $memberKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_Member");
  }
   ...
   * @return Directory_Member
   */
  public function update($groupKey, $memberKey, Directory_Member $postBody, $optParams = array())
  {
    $params = array('groupKey' => $groupKey, 'memberKey' => $memberKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_Member");
  }
}
 ...
 *  </code>
 */
class Directory_Mobiledevices_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function action($customerId, $resourceId, Directory_MobileDeviceAction $postBody, $optParams = array())
  {
   ...
   * @opt_param string projection Restrict information returned to a set of
   * selected fields.
   * @return Directory_MobileDevice
   */
  public function get($customerId, $resourceId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'resourceId' => $resourceId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_MobileDevice");
  }
   ...
   * @return Directory_MobileDevices
   */
  public function listMobiledevices($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_MobileDevices");
  }
}
 ...
 *  </code>
 */
class Directory_Notifications_Resource extends Resource
{
   ...
   * @param string $notificationId The unique ID of the notification.
   * @param array $optParams Optional parameters.
   * @return Directory_Notification
   */
  public function get($customer, $notificationId, $optParams = array())
  {
    $params = array('customer' => $customer, 'notificationId' => $notificationId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Notification");
  }
  ...
  public function listNotifications($customer, $optParams = array())
  {
    $params = array('customer' => $customer);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Notifications");
  }
   ...
   * @return Directory_Notification
   */
  public function patch($customer, $notificationId, Directory_Notification $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'notificationId' => $notificationId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_Notification");
  }
   ...
   * @return Directory_Notification
   */
  public function update($customer, $notificationId, Directory_Notification $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'notificationId' => $notificationId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_Notification");
  }
}
 ...
 *  </code>
 */
class Directory_Orgunits_Resource extends Resource
{
   ...
   * @param string $orgUnitPath Full path of the organization unit or its Id
   * @param array $optParams Optional parameters.
   * @return Directory_OrgUnit
   */
  public function get($customerId, $orgUnitPath, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'orgUnitPath' => $orgUnitPath);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_OrgUnit");
  }
   ...
   * @return Directory_OrgUnit
   */
  public function insert($customerId, Directory_OrgUnit $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_OrgUnit");
  }
   ...
   * Id
   * @return Directory_OrgUnits
   */
  public function listOrgunits($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_OrgUnits");
  }
   ...
   * @return Directory_OrgUnit
   */
  public function patch($customerId, $orgUnitPath, Directory_OrgUnit $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'orgUnitPath' => $orgUnitPath, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_OrgUnit");
  }
   ...
   * @return Directory_OrgUnit
   */
  public function update($customerId, $orgUnitPath, Directory_OrgUnit $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'orgUnitPath' => $orgUnitPath, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_OrgUnit");
  }
}
 ...
 *  </code>
 */
class Directory_Privileges_Resource extends Resource
{
  ...
  public function listPrivileges($customer, $optParams = array())
  {
    $params = array('customer' => $customer);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Privileges");
  }
}
 ...
 *  </code>
 */
class Directory_RoleAssignments_Resource extends Resource
{
   ...
   * @param string $roleAssignmentId Immutable ID of the role assignment.
   * @param array $optParams Optional parameters.
   * @return Directory_RoleAssignment
   */
  public function get($customer, $roleAssignmentId, $optParams = array())
  {
    $params = array('customer' => $customer, 'roleAssignmentId' => $roleAssignmentId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_RoleAssignment");
  }
   ...
   * @return Directory_RoleAssignment
   */
  public function insert($customer, Directory_RoleAssignment $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_RoleAssignment");
  }
   ...
   * @return Directory_RoleAssignments
   */
  public function listRoleAssignments($customer, $optParams = array())
  {
    $params = array('customer' => $customer);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_RoleAssignments");
  }
}
 ...
 *  </code>
 */
class Directory_Roles_Resource extends Resource
{
  ...
  public function get($customer, $roleId, $optParams = array())
  {
    $params = array('customer' => $customer, 'roleId' => $roleId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Role");
  }
   ...
   * @return Directory_Role
   */
  public function insert($customer, Directory_Role $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_Role");
  }
  ...
  public function listRoles($customer, $optParams = array())
  {
    $params = array('customer' => $customer);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Roles");
  }
   ...
   * @return Directory_Role
   */
  public function patch($customer, $roleId, Directory_Role $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'roleId' => $roleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_Role");
  }
   ...
   * @return Directory_Role
   */
  public function update($customer, $roleId, Directory_Role $postBody, $optParams = array())
  {
    $params = array('customer' => $customer, 'roleId' => $roleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_Role");
  }
}
 ...
 *  </code>
 */
class Directory_Schemas_Resource extends Resource
{
  ...
  public function get($customerId, $schemaKey, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'schemaKey' => $schemaKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Schema");
  }
   ...
   * @return Directory_Schema
   */
  public function insert($customerId, Directory_Schema $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_Schema");
  }
  ...
  public function listSchemas($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Schemas");
  }
   ...
   * @return Directory_Schema
   */
  public function patch($customerId, $schemaKey, Directory_Schema $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'schemaKey' => $schemaKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_Schema");
  }
   ...
   * @return Directory_Schema
   */
  public function update($customerId, $schemaKey, Directory_Schema $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'schemaKey' => $schemaKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_Schema");
  }
}
 ...
 *  </code>
 */
class Directory_Tokens_Resource extends Resource
{
  ...
  public function get($userKey, $clientId, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'clientId' => $clientId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_Token");
  }
   ...
   * be the user's primary email address, alias email address, or unique user ID.
   * @param array $optParams Optional parameters.
   * @return Directory_Tokens
   */
  public function listTokens($userKey, $optParams = array())
  {
    $params = array('userKey' => $userKey);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Tokens");
  }
}
 ...
 *  </code>
 */
class Directory_Users_Resource extends Resource
{
  ...
  public function get($userKey, $optParams = array())
  {
    $params = array('userKey' => $userKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_User");
  }
   ...
   * @return Directory_User
   */
  public function insert(Directory_User $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_User");
  }
  ...
  public function listUsers($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_Users");
  }
   ...
   * @param array $optParams Optional parameters.
   */
  public function makeAdmin($userKey, Directory_UserMakeAdmin $postBody, $optParams = array())
  {
   ...
   * @return Directory_User
   */
  public function patch($userKey, Directory_User $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_User");
  }
   ...
   * @param array $optParams Optional parameters.
   */
  public function undelete($userKey, Directory_UserUndelete $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @return Directory_User
   */
  public function update($userKey, Directory_User $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_User");
  }
   ...
   */
  public function watch(Directory_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Directory_Channel");
  }
}
 ...
 *  </code>
 */
class Directory_UsersAliases_Resource extends Resource
{
   ...
   * @return Directory_Alias
   */
  public function insert($userKey, Directory_Alias $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Directory_Alias");
   ...
   * @return Directory_Channel
   */
  public function watch($userKey, Directory_Channel $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Directory_Channel");
 ...
 *  </code>
 */
class Directory_UsersPhotos_Resource extends Resource
{
   ...
   * @param string $userKey Email or immutable Id of the user
   * @param array $optParams Optional parameters.
   * @return Directory_UserPhoto
   */
  public function get($userKey, $optParams = array())
  {
    $params = array('userKey' => $userKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Directory_UserPhoto");
  }
   ...
   * @return Directory_UserPhoto
   */
  public function patch($userKey, Directory_UserPhoto $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Directory_UserPhoto");
  }
   ...
   * @return Directory_UserPhoto
   */
  public function update($userKey, Directory_UserPhoto $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Directory_UserPhoto");
  }
}
 ...
 *  </code>
 */
class Directory_VerificationCodes_Resource extends Resource
{
   ...
   * be the user's primary email address, alias email address, or unique user ID.
   * @param array $optParams Optional parameters.
   * @return Directory_VerificationCodes
   */
  public function listVerificationCodes($userKey, $optParams = array())
  {
    $params = array('userKey' => $userKey);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Directory_VerificationCodes");
  }
}
...
class Directory_Alias extends Model
{
...
class Directory_Aliases extends Collection
{
  protected $collection_key = 'aliases';
  protected $internal_gapi_mappings = array(
  );
  protected $aliasesType = 'Directory_Alias';
...
class Directory_Asp extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $codeId;
...
class Directory_Asps extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Directory_Asp';
...
class Directory_Channel extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class Directory_ChannelParams extends Model
{
}

class Directory_ChromeOsDevice extends Collection
{
  protected $collection_key = 'recentUsers';
  protected $internal_gapi_mappings = array(
  );
  protected $activeTimeRangesType = 'Directory_ChromeOsDeviceActiveTimeRanges';
  ...
  protected $recentUsersType = 'Directory_ChromeOsDeviceRecentUsers';
...
class Directory_ChromeOsDeviceActiveTimeRanges extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $activeTime;
...
class Directory_ChromeOsDeviceRecentUsers extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $email;
...
class Directory_ChromeOsDevices extends Collection
{
  protected $collection_key = 'chromeosdevices';
  protected $internal_gapi_mappings = array(
  );
  protected $chromeosdevicesType = 'Directory_ChromeOsDevice';
...
class Directory_Customer extends Model
{
  protected $internal_gapi_mappings = array(
  );
  ...
  public $language;
  public $phoneNumber;
  protected $postalAddressType = 'Directory_CustomerPostalAddress';
  ...
  public function setPostalAddress(Directory_CustomerPostalAddress $postalAddress)
  {
...
class Directory_CustomerPostalAddress extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $addressLine1;
...
class Directory_DomainAlias extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $creationTime;
...
class Directory_DomainAliases extends Collection
{
  protected $collection_key = 'domainAliases';
  protected $internal_gapi_mappings = array(
  );
  protected $domainAliasesType = 'Directory_DomainAlias';
...
class Directory_Domains extends Collection
{
  protected $collection_key = 'domainAliases';
  protected $internal_gapi_mappings = array(
  );
...
class Directory_Domains2 extends Collection
{
  protected $collection_key = 'domains';
  protected $internal_gapi_mappings = array(
  );
  protected $domainsType = 'Directory_Domains';
...
class Directory_Group extends Collection
{
...
class Directory_Groups extends Collection
{
  protected $collection_key = 'groups';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $groupsType = 'Directory_Group';
...
class Directory_Member extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $email;
...
class Directory_Members extends Collection
{
  ...
  public $etag;
  public $kind;
  protected $membersType = 'Directory_Member';
...
class Directory_MobileDevice extends Collection
{
  protected $collection_key = 'otherAccountsInfo';
  protected $internal_gapi_mappings = array(
  );
  public $adbStatus;
  protected $applicationsType = 'Directory_MobileDeviceApplications';
...
class Directory_MobileDeviceAction extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $action;
...
class Directory_MobileDeviceApplications extends Collection
{
...
class Directory_MobileDevices extends Collection
{
  ...
  public $etag;
  public $kind;
  protected $mobiledevicesType = 'Directory_MobileDevice';
...
class Directory_Notification extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $body;
...
class Directory_Notifications extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Directory_Notification';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class Directory_OrgUnit extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Directory_OrgUnits extends Collection
{
  ...
  public $etag;
  public $kind;
  protected $organizationUnitsType = 'Directory_OrgUnit';
...
class Directory_Privilege extends Collection
{
  protected $collection_key = 'childPrivileges';
  protected $internal_gapi_mappings = array(
  );
  protected $childPrivilegesType = 'Directory_Privilege';
...
class Directory_Privileges extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Directory_Privilege';
  protected $itemsDataType = 'array';
  public $kind;
...
class Directory_Role extends Collection
{
  ...
  public $roleId;
  public $roleName;
  protected $rolePrivilegesType = 'Directory_RoleRolePrivileges';
...
class Directory_RoleAssignment extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $assignedTo;
...
class Directory_RoleAssignments extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Directory_RoleAssignment';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class Directory_RoleRolePrivileges extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $privilegeName;
...
class Directory_Roles extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Directory_Role';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class Directory_Schema extends Collection
{
  protected $collection_key = 'fields';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $fieldsType = 'Directory_SchemaFieldSpec';
...
class Directory_SchemaFieldSpec extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  ...
  public $kind;
  public $multiValued;
  protected $numericIndexingSpecType = 'Directory_SchemaFieldSpecNumericIndexingSpec';
  ...
  public function setNumericIndexingSpec(Directory_SchemaFieldSpecNumericIndexingSpec $numericIndexingSpec)
  {
...
class Directory_SchemaFieldSpecNumericIndexingSpec extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $maxValue;
...
class Directory_Schemas extends Collection
{
  ...
  public $etag;
  public $kind;
  protected $schemasType = 'Directory_Schema';
...
class Directory_Token extends Collection
{
...
class Directory_Tokens extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Directory_Token';
  protected $itemsDataType = 'array';
  public $kind;
...
class Directory_User extends Collection
{
  protected $collection_key = 'nonEditableAliases';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $nameType = 'Directory_UserName';
  ...
  public function setName(Directory_UserName $name)
  {
    $this->name = $name;
  }
  public function getName()
...
class Directory_UserAbout extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $contentType;
...
class Directory_UserAddress extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $country;
...
class Directory_UserCustomProperties extends Model
{
}

class Directory_UserCustomSchemas extends Model
{
}

class Directory_UserEmail extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class Directory_UserExternalId extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $customType;
...
class Directory_UserIm extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Directory_UserMakeAdmin extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $status;
...
class Directory_UserName extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $familyName;
...
class Directory_UserOrganization extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $costCenter;
...
class Directory_UserPhone extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $customType;
...
class Directory_UserPhoto extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class Directory_UserRelation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $customType;
...
class Directory_UserUndelete extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $orgUnitPath;
...
class Directory_UserWebsite extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $customType;
...
class Directory_Users extends Collection
{
  ...
  public $nextPageToken;
  public $triggerEvent;
  protected $usersType = 'Directory_User';
...
class Directory_VerificationCode extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class Directory_VerificationCodes extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Directory_VerificationCode';
  protected $itemsDataType = 'array';
  public $kind;

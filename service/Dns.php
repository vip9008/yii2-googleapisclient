...
class Dns extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->changes = new Dns_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->managedZones = new Dns_ManagedZones_Resource(
        $this,
        $this->serviceName,
        'managedZones',
        array(
    ...
    $this->projects = new Dns_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->resourceRecordSets = new Dns_ResourceRecordSets_Resource(
        $this,
        $this->serviceName,
        'resourceRecordSets',
        array(
 ...
 *  </code>
 */
class Dns_Changes_Resource extends Resource
{
   ...
   * @return Dns_Change
   */
  public function create($project, $managedZone, Dns_Change $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Dns_Change");
  }
  ...
  public function get($project, $managedZone, $changeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dns_Change");
  }
 ...
 *  </code>
 */
class Dns_ManagedZones_Resource extends Resource
{
   ...
   */
  public function create($project, Dns_ManagedZone $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Dns_ManagedZone");
  }
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dns_ManagedZone");
  }
   ...
   * @opt_param int maxResults Optional. Maximum number of results to be returned.
   * If unspecified, the server will decide how many results to return.
   * @return Dns_ManagedZonesListResponse
   */
  public function listManagedZones($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dns_ManagedZonesListResponse");
  }
}
 ...
 *  </code>
 */
class Dns_Projects_Resource extends Resource
{
  ...
  public function get($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dns_Project");
  }
}
 ...
 *  </code>
 */
class Dns_ResourceRecordSets_Resource extends Resource
{
   ...
   * @return Dns_ResourceRecordSetsListResponse
   */
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dns_ResourceRecordSetsListResponse");
  }
}
...
class Dns_Change extends Collection
{
  protected $collection_key = 'deletions';
  protected $internal_gapi_mappings = array(
  );
  protected $additionsType = 'Dns_ResourceRecordSet';
  protected $additionsDataType = 'array';
  protected $deletionsType = 'Dns_ResourceRecordSet';
...
class Dns_ChangesListResponse extends Collection
{
  protected $collection_key = 'changes';
  protected $internal_gapi_mappings = array(
  );
  protected $changesType = 'Dns_Change';
...
class Dns_ManagedZone extends Collection
{
...
class Dns_ManagedZonesListResponse extends Collection
{
  protected $collection_key = 'managedZones';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $managedZonesType = 'Dns_ManagedZone';
...
class Dns_Project extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
  ...
  public function setQuota(Dns_Quota $quota)
  {
    $this->quota = $quota;
  }
...
class Dns_ResourceRecordSet extends Collection
{
...
class Dns_ResourceRecordSetsListResponse extends Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $rrsetsType = 'Dns_ResourceRecordSet';

 ...
 * @author Google, Inc.
 */
class DoubleClickBidManager extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->lineitems = new DoubleClickBidManager_Lineitems_Resource(
        $this,
        $this->serviceName,
        'lineitems',
        array(
    ...
    $this->queries = new DoubleClickBidManager_Queries_Resource(
        $this,
        $this->serviceName,
        'queries',
        array(
    ...
    $this->reports = new DoubleClickBidManager_Reports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $doubleclickbidmanagerService = new DoubleClickBidManager(...);
 *   $lineitems = $doubleclickbidmanagerService->lineitems;
 *  </code>
 */
class DoubleClickBidManager_Lineitems_Resource extends Resource
{
   ...
   * @return DoubleClickBidManager_DownloadLineItemsResponse
   */
  public function downloadlineitems(DoubleClickBidManager_DownloadLineItemsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('downloadlineitems', array($params), "DoubleClickBidManager_DownloadLineItemsResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return DoubleClickBidManager_UploadLineItemsResponse
   */
  public function uploadlineitems(DoubleClickBidManager_UploadLineItemsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('uploadlineitems', array($params), "DoubleClickBidManager_UploadLineItemsResponse");
  }
}
 ...
 *  </code>
 */
class DoubleClickBidManager_Queries_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return DoubleClickBidManager_Query
   */
  public function createquery(DoubleClickBidManager_Query $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('createquery', array($params), "DoubleClickBidManager_Query");
  }
  ...
  public function getquery($queryId, $optParams = array())
  {
    $params = array('queryId' => $queryId);
    $params = array_merge($params, $optParams);
    return $this->call('getquery', array($params), "DoubleClickBidManager_Query");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return DoubleClickBidManager_ListQueriesResponse
   */
  public function listqueries($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('listqueries', array($params), "DoubleClickBidManager_ListQueriesResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   */
  public function runquery($queryId, DoubleClickBidManager_RunQueryRequest $postBody, $optParams = array())
  {
 ...
 *  </code>
 */
class DoubleClickBidManager_Reports_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return DoubleClickBidManager_ListReportsResponse
   */
  public function listreports($queryId, $optParams = array())
  {
    $params = array('queryId' => $queryId);
    $params = array_merge($params, $optParams);
    return $this->call('listreports', array($params), "DoubleClickBidManager_ListReportsResponse");
  }
}
...
class DoubleClickBidManager_DownloadLineItemsRequest extends Collection
{
...
class DoubleClickBidManager_DownloadLineItemsResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $lineItems;
...
class DoubleClickBidManager_FilterPair extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class DoubleClickBidManager_ListQueriesResponse extends Collection
{
  protected $collection_key = 'queries';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $queriesType = 'DoubleClickBidManager_Query';
...
class DoubleClickBidManager_ListReportsResponse extends Collection
{
  protected $collection_key = 'reports';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $reportsType = 'DoubleClickBidManager_Report';
...
class DoubleClickBidManager_Parameters extends Collection
{
  protected $collection_key = 'metrics';
  protected $internal_gapi_mappings = array(
  );
  protected $filtersType = 'DoubleClickBidManager_FilterPair';
...
class DoubleClickBidManager_Query extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $metadataType = 'DoubleClickBidManager_QueryMetadata';
  protected $metadataDataType = '';
  protected $paramsType = 'DoubleClickBidManager_Parameters';
  protected $paramsDataType = '';
  public $queryId;
  public $reportDataEndTimeMs;
  public $reportDataStartTimeMs;
  protected $scheduleType = 'DoubleClickBidManager_QuerySchedule';
  ...
  public function setMetadata(DoubleClickBidManager_QueryMetadata $metadata)
  {
  ...
  public function setParams(DoubleClickBidManager_Parameters $params)
  {
    $this->params = $params;
  }
  ...
  public function setSchedule(DoubleClickBidManager_QuerySchedule $schedule)
  {
...
class DoubleClickBidManager_QueryMetadata extends Collection
{
...
class DoubleClickBidManager_QuerySchedule extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTimeMs;
...
class DoubleClickBidManager_Report extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $keyType = 'DoubleClickBidManager_ReportKey';
  protected $keyDataType = '';
  protected $metadataType = 'DoubleClickBidManager_ReportMetadata';
  protected $metadataDataType = '';
  protected $paramsType = 'DoubleClickBidManager_Parameters';
  protected $paramsDataType = '';


  public function setKey(DoubleClickBidManager_ReportKey $key)
  {
    $this->key = $key;
  }
  ...
  public function setMetadata(DoubleClickBidManager_ReportMetadata $metadata)
  {
    $this->metadata = $metadata;
  }
  public function getMetadata()
...
class DoubleClickBidManager_ReportFailure extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $errorCode;
...
class DoubleClickBidManager_ReportKey extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $queryId;
...
class DoubleClickBidManager_ReportMetadata extends Model
{
  protected $internal_gapi_mappings = array(
  );
  ...
  public $reportDataEndTimeMs;
  public $reportDataStartTimeMs;
  protected $statusType = 'DoubleClickBidManager_ReportStatus';
  ...
  public function setStatus(DoubleClickBidManager_ReportStatus $status)
  {
    $this->status = $status;
  }
...
class DoubleClickBidManager_ReportStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $failureType = 'DoubleClickBidManager_ReportFailure';
  ...
  public function setFailure(DoubleClickBidManager_ReportFailure $failure)
  {
...
class DoubleClickBidManager_RowStatus extends Collection
{
...
class DoubleClickBidManager_RunQueryRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dataRange;
...
class DoubleClickBidManager_UploadLineItemsRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dryRun;
...
class DoubleClickBidManager_UploadLineItemsResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $uploadStatusType = 'DoubleClickBidManager_UploadStatus';
  protected $uploadStatusDataType = '';


  public function setUploadStatus(DoubleClickBidManager_UploadStatus $uploadStatus)
  {
...
class DoubleClickBidManager_UploadStatus extends Collection
{
  protected $collection_key = 'rowStatus';
  protected $internal_gapi_mappings = array(
  );
  public $errors;
  protected $rowStatusType = 'DoubleClickBidManager_RowStatus';

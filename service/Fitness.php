...
class Fitness extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->users_dataSources = new Fitness_UsersDataSources_Resource(
        $this,
        $this->serviceName,
        'dataSources',
        array(
    ...
    $this->users_dataSources_datasets = new Fitness_UsersDataSourcesDatasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
    ...
    $this->users_dataset = new Fitness_UsersDataset_Resource(
        $this,
        $this->serviceName,
        'dataset',
        array(
    ...
    $this->users_sessions = new Fitness_UsersSessions_Resource(
        $this,
        $this->serviceName,
        'sessions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $fitnessService = new Fitness(...);
 *   $users = $fitnessService->users;
 *  </code>
 */
class Fitness_Users_Resource extends Resource
{
}
 ...
 *  </code>
 */
class Fitness_UsersDataSources_Resource extends Resource
{
   ...
   * @return Fitness_DataSource
   */
  public function create($userId, Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Fitness_DataSource");
  }
  ...
  public function delete($userId, $dataSourceId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Fitness_DataSource");
  }
  ...
  public function get($userId, $dataSourceId, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Fitness_DataSource");
  }
   ...
   * @return Fitness_ListDataSourcesResponse
   */
  public function listUsersDataSources($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Fitness_ListDataSourcesResponse");
  }
   ...
   * @return Fitness_DataSource
   */
  public function patch($userId, $dataSourceId, Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Fitness_DataSource");
  }
   ...
   * @return Fitness_DataSource
   */
  public function update($userId, $dataSourceId, Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Fitness_DataSource");
  }
}
 ...
 *  </code>
 */
class Fitness_UsersDataSourcesDatasets_Resource extends Resource
{
   ...
   * @return Fitness_Dataset
   */
  public function get($userId, $dataSourceId, $datasetId, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Fitness_Dataset");
  }
   ...
   * @return Fitness_Dataset
   */
  public function patch($userId, $dataSourceId, $datasetId, Fitness_Dataset $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Fitness_Dataset");
  }
}
/**
 ...
 *  </code>
 */
class Fitness_UsersDataset_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Fitness_AggregateResponse
   */
  public function aggregate($userId, Fitness_AggregateRequest $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('aggregate', array($params), "Fitness_AggregateResponse");
  }
}
/**
 ...
 *  </code>
 */
class Fitness_UsersSessions_Resource extends Resource
{
   ...
   * @return Fitness_ListSessionsResponse
   */
  public function listUsersSessions($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Fitness_ListSessionsResponse");
  }
   ...
   */
  public function update($userId, $sessionId, Fitness_Session $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'sessionId' => $sessionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Fitness_Session");
  }
}
...
class Fitness_AggregateBucket extends Collection
{
  protected $collection_key = 'dataset';
  protected $internal_gapi_mappings = array(
  );
  public $activity;
  protected $datasetType = 'Fitness_Dataset';
  protected $datasetDataType = 'array';
  public $endTimeMillis;
  protected $sessionType = 'Fitness_Session';
  ...
  public function setSession(Fitness_Session $session)
  {
...
class Fitness_AggregateBy extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dataSourceId;
...
class Fitness_AggregateRequest extends Collection
{
  protected $collection_key = 'aggregateBy';
  protected $internal_gapi_mappings = array(
  );
  protected $aggregateByType = 'Fitness_AggregateBy';
  protected $aggregateByDataType = 'array';
  protected $bucketByActivitySegmentType = 'Fitness_BucketByActivity';
  protected $bucketByActivitySegmentDataType = '';
  protected $bucketByActivityTypeType = 'Fitness_BucketByActivity';
  protected $bucketByActivityTypeDataType = '';
  protected $bucketBySessionType = 'Fitness_BucketBySession';
  protected $bucketBySessionDataType = '';
  protected $bucketByTimeType = 'Fitness_BucketByTime';
  ...
  public function setBucketByActivitySegment(Fitness_BucketByActivity $bucketByActivitySegment)
  {
  ...
  public function setBucketByActivityType(Fitness_BucketByActivity $bucketByActivityType)
  {
  ...
  public function setBucketBySession(Fitness_BucketBySession $bucketBySession)
  {
  ...
  public function setBucketByTime(Fitness_BucketByTime $bucketByTime)
  {
...
class Fitness_AggregateResponse extends Collection
{
  protected $collection_key = 'bucket';
  protected $internal_gapi_mappings = array(
  );
  protected $bucketType = 'Fitness_AggregateBucket';
...
class Fitness_Application extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $detailsUrl;
...
class Fitness_BucketByActivity extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Fitness_BucketBySession extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $minDurationMillis;
...
class Fitness_BucketByTime extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Fitness_DataPoint extends Collection
{
  ...
  protected $valueType = 'Fitness_Value';
...
class Fitness_DataSource extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $applicationType = 'Fitness_Application';
  protected $applicationDataType = '';
  public $dataStreamId;
  public $dataStreamName;
  protected $dataTypeType = 'Fitness_DataType';
  protected $dataTypeDataType = '';
  protected $deviceType = 'Fitness_Device';
  protected $deviceDataType = '';
  public $name;
  public $type;


  public function setApplication(Fitness_Application $application)
  {
  ...
  public function setDataType(Fitness_DataType $dataType)
  {
  ...
  public function setDevice(Fitness_Device $device)
  {
    $this->device = $device;
  }
...
class Fitness_DataType extends Collection
{
  protected $collection_key = 'field';
  protected $internal_gapi_mappings = array(
  );
  protected $fieldType = 'Fitness_DataTypeField';
...
class Fitness_DataTypeField extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $format;
...
class Fitness_Dataset extends Collection
{
  ...
  protected $pointType = 'Fitness_DataPoint';
...
class Fitness_Device extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $manufacturer;
...
class Fitness_ListDataSourcesResponse extends Collection
{
  protected $collection_key = 'dataSource';
  protected $internal_gapi_mappings = array(
  );
  protected $dataSourceType = 'Fitness_DataSource';
...
class Fitness_ListSessionsResponse extends Collection
{
  protected $collection_key = 'session';
  protected $internal_gapi_mappings = array(
  );
  protected $deletedSessionType = 'Fitness_Session';
...
class Fitness_MapValue extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fpVal;
...
class Fitness_Session extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Fitness_Value extends Collection
{
  ...
  public $fpVal;
  public $intVal;
  protected $mapValType = 'Fitness_ValueMapValEntry';
...
class Fitness_ValueMapValEntry extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
  protected $valueType = 'Fitness_MapValue';
  ...
  public function setValue(Fitness_MapValue $value)
  {
    $this->value = $value;
  }
  public function getValue()

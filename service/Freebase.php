 ...
 * @author Google, Inc.
 */
class Freebase extends Service
{
   ...
   * @return Freebase_ReconcileGet
   */
  public function reconcile($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('reconcile', array($params), "Freebase_ReconcileGet");
  }
  /**
...
class Freebase_ReconcileCandidate extends Model
{
  ...
  public $mid;
  public $name;
  protected $notableType = 'Freebase_ReconcileCandidateNotable';
  ...
  public function setNotable(Freebase_ReconcileCandidateNotable $notable)
  {
...
class Freebase_ReconcileCandidateNotable extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Freebase_ReconcileGet extends Collection
{
  protected $collection_key = 'warning';
  protected $internal_gapi_mappings = array(
  );
  protected $candidateType = 'Freebase_ReconcileCandidate';
  protected $candidateDataType = 'array';
  protected $costsType = 'Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'Freebase_ReconcileCandidate';
  protected $matchDataType = '';
  protected $warningType = 'Freebase_ReconcileGetWarning';
  ...
  public function setCosts(Freebase_ReconcileGetCosts $costs)
  {
    $this->costs = $costs;
  }
  ...
  public function setMatch(Freebase_ReconcileCandidate $match)
  {
    $this->match = $match;
  }
...
class Freebase_ReconcileGetCosts extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $hits;
...
class Freebase_ReconcileGetWarning extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $location;

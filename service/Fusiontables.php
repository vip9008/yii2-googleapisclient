 ...
 * @author Google, Inc.
 */
class Fusiontables extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->column = new Fusiontables_Column_Resource(
        $this,
        $this->serviceName,
        'column',
        array(
    ...
    $this->query = new Fusiontables_Query_Resource(
        $this,
        $this->serviceName,
        'query',
        array(
    ...
    $this->style = new Fusiontables_Style_Resource(
        $this,
        $this->serviceName,
        'style',
        array(
    ...
    $this->table = new Fusiontables_Table_Resource(
        $this,
        $this->serviceName,
        'table',
        array(
    ...
    $this->task = new Fusiontables_Task_Resource(
        $this,
        $this->serviceName,
        'task',
        array(
    ...
    $this->template = new Fusiontables_Template_Resource(
        $this,
        $this->serviceName,
        'template',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $fusiontablesService = new Fusiontables(...);
 *   $column = $fusiontablesService->column;
 *  </code>
 */
class Fusiontables_Column_Resource extends Resource
{
   ...
   * requested.
   * @param array $optParams Optional parameters.
   * @return Fusiontables_Column
   */
  public function get($tableId, $columnId, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'columnId' => $columnId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Fusiontables_Column");
  }
   ...
   * @return Fusiontables_Column
   */
  public function insert($tableId, Fusiontables_Column $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Fusiontables_Column");
  }
   ...
   * 5.
   * @return Fusiontables_ColumnList
   */
  public function listColumn($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Fusiontables_ColumnList");
  }
   ...
   * @return Fusiontables_Column
   */
  public function patch($tableId, $columnId, Fusiontables_Column $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'columnId' => $columnId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Fusiontables_Column");
  }
   ...
   * @return Fusiontables_Column
   */
  public function update($tableId, $columnId, Fusiontables_Column $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'columnId' => $columnId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Fusiontables_Column");
  }
}
 ...
 *  </code>
 */
class Fusiontables_Query_Resource extends Resource
{
   ...
   * Default is true.
   * @return Fusiontables_Sqlresponse
   */
  public function sql($sql, $optParams = array())
  {
    $params = array('sql' => $sql);
    $params = array_merge($params, $optParams);
    return $this->call('sql', array($params), "Fusiontables_Sqlresponse");
  }
  ...
  public function sqlGet($sql, $optParams = array())
  {
    $params = array('sql' => $sql);
    $params = array_merge($params, $optParams);
    return $this->call('sqlGet', array($params), "Fusiontables_Sqlresponse");
  }
}
 ...
 *  </code>
 */
class Fusiontables_Style_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Fusiontables_StyleSetting
   */
  public function get($tableId, $styleId, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'styleId' => $styleId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Fusiontables_StyleSetting");
  }
   ...
   * @return Fusiontables_StyleSetting
   */
  public function insert($tableId, Fusiontables_StyleSetting $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Fusiontables_StyleSetting");
  }
   ...
   * Default is 5.
   * @return Fusiontables_StyleSettingList
   */
  public function listStyle($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Fusiontables_StyleSettingList");
  }
   ...
   * @return Fusiontables_StyleSetting
   */
  public function patch($tableId, $styleId, Fusiontables_StyleSetting $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'styleId' => $styleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Fusiontables_StyleSetting");
  }
   ...
   * @return Fusiontables_StyleSetting
   */
  public function update($tableId, $styleId, Fusiontables_StyleSetting $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'styleId' => $styleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Fusiontables_StyleSetting");
  }
}
 ...
 *  </code>
 */
class Fusiontables_Table_Resource extends Resource
{
   ...
   * @return Fusiontables_Table
   */
  public function copy($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('copy', array($params), "Fusiontables_Table");
  }
  ...
  public function get($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Fusiontables_Table");
  }
   ...
   * last endLine lines.
   * @return Fusiontables_Import
   */
  public function importRows($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('importRows', array($params), "Fusiontables_Import");
  }
  ...
  public function importTable($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('importTable', array($params), "Fusiontables_Table");
  }
   ...
   * @return Fusiontables_Table
   */
  public function insert(Fusiontables_Table $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Fusiontables_Table");
  }
   ...
   * 5.
   * @return Fusiontables_TableList
   */
  public function listTable($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Fusiontables_TableList");
  }
   ...
   * @return Fusiontables_Table
   */
  public function patch($tableId, Fusiontables_Table $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Fusiontables_Table");
  }
   ...
   * an offset from the end of the file; the imported content will exclude the
   * last endLine lines.
   * @return Fusiontables_Task
   */
  public function replaceRows($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('replaceRows', array($params), "Fusiontables_Task");
  }
   ...
   * @return Fusiontables_Table
   */
  public function update($tableId, Fusiontables_Table $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Fusiontables_Table");
  }
}
 ...
 *  </code>
 */
class Fusiontables_Task_Resource extends Resource
{
  ...
  public function get($tableId, $taskId, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'taskId' => $taskId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Fusiontables_Task");
  }
   ...
   * @return Fusiontables_TaskList
   */
  public function listTask($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Fusiontables_TaskList");
  }
}
 ...
 *  </code>
 */
class Fusiontables_Template_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Fusiontables_Template
   */
  public function get($tableId, $templateId, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'templateId' => $templateId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Fusiontables_Template");
  }
   ...
   * @return Fusiontables_Template
   */
  public function insert($tableId, Fusiontables_Template $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Fusiontables_Template");
  }
   ...
   * Default is 5.
   * @return Fusiontables_TemplateList
   */
  public function listTemplate($tableId, $optParams = array())
  {
    $params = array('tableId' => $tableId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Fusiontables_TemplateList");
  }
   ...
   * @return Fusiontables_Template
   */
  public function patch($tableId, $templateId, Fusiontables_Template $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'templateId' => $templateId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Fusiontables_Template");
  }
   ...
   * @return Fusiontables_Template
   */
  public function update($tableId, $templateId, Fusiontables_Template $postBody, $optParams = array())
  {
    $params = array('tableId' => $tableId, 'templateId' => $templateId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Fusiontables_Template");
  }
}
...
class Fusiontables_Bucket extends Model
{
...
class Fusiontables_Column extends Collection
{
  protected $collection_key = 'validValues';
  protected $internal_gapi_mappings = array(
  );
  protected $baseColumnType = 'Fusiontables_ColumnBaseColumn';
  ...
  public function setBaseColumn(Fusiontables_ColumnBaseColumn $baseColumn)
  {
...
class Fusiontables_ColumnBaseColumn extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $columnId;
...
class Fusiontables_ColumnList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Fusiontables_Column';
...
class Fusiontables_Geometry extends Collection
{
...
class Fusiontables_Import extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Fusiontables_Line extends Collection
{
...
class Fusiontables_LineStyle extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $strokeColor;
  protected $strokeColorStylerType = 'Fusiontables_StyleFunction';
  protected $strokeColorStylerDataType = '';
  public $strokeOpacity;
  public $strokeWeight;
  protected $strokeWeightStylerType = 'Fusiontables_StyleFunction';
  ...
  public function setStrokeColorStyler(Fusiontables_StyleFunction $strokeColorStyler)
  {
  ...
  public function setStrokeWeightStyler(Fusiontables_StyleFunction $strokeWeightStyler)
  {
...
class Fusiontables_Point extends Collection
{
  protected $collection_key = 'coordinates';
  protected $internal_gapi_mappings = array(
  );
...
class Fusiontables_PointStyle extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $iconName;
  protected $iconStylerType = 'Fusiontables_StyleFunction';
  ...
  public function setIconStyler(Fusiontables_StyleFunction $iconStyler)
  {
...
class Fusiontables_Polygon extends Collection
{
  protected $collection_key = 'coordinates';
  protected $internal_gapi_mappings = array(
  );
...
class Fusiontables_PolygonStyle extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fillColor;
  protected $fillColorStylerType = 'Fusiontables_StyleFunction';
  ...
  public function setFillColorStyler(Fusiontables_StyleFunction $fillColorStyler)
  {
...
class Fusiontables_Sqlresponse extends Collection
{
...
class Fusiontables_StyleFunction extends Collection
{
  protected $collection_key = 'buckets';
  protected $internal_gapi_mappings = array(
  );
  protected $bucketsType = 'Fusiontables_Bucket';
  protected $bucketsDataType = 'array';
  public $columnName;
  protected $gradientType = 'Fusiontables_StyleFunctionGradient';
  ...
  public function setGradient(Fusiontables_StyleFunctionGradient $gradient)
  {
...
class Fusiontables_StyleFunctionGradient extends Collection
{
  protected $collection_key = 'colors';
  protected $internal_gapi_mappings = array(
  );
  protected $colorsType = 'Fusiontables_StyleFunctionGradientColors';
...
class Fusiontables_StyleFunctionGradientColors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $color;
...
class Fusiontables_StyleSetting extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $markerOptionsType = 'Fusiontables_PointStyle';
  protected $markerOptionsDataType = '';
  public $name;
  protected $polygonOptionsType = 'Fusiontables_PolygonStyle';
  protected $polygonOptionsDataType = '';
  protected $polylineOptionsType = 'Fusiontables_LineStyle';
  ...
  public function setMarkerOptions(Fusiontables_PointStyle $markerOptions)
  {
  ...
  public function setPolygonOptions(Fusiontables_PolygonStyle $polygonOptions)
  {
  ...
  public function setPolylineOptions(Fusiontables_LineStyle $polylineOptions)
  {
...
class Fusiontables_StyleSettingList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Fusiontables_StyleSetting';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $totalItems;
...
class Fusiontables_Table extends Collection
{
  ...
  protected $columnsType = 'Fusiontables_Column';
...
class Fusiontables_TableList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Fusiontables_Table';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
...
class Fusiontables_Task extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Fusiontables_TaskList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Fusiontables_Task';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $totalItems;
...
class Fusiontables_Template extends Collection
{
...
class Fusiontables_TemplateList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Fusiontables_Template';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $totalItems;

 ...
 * @author Google, Inc.
 */
class Genomics extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->callsets = new Genomics_Callsets_Resource(
        $this,
        $this->serviceName,
        'callsets',
        array(
    ...
    $this->datasets = new Genomics_Datasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
    ...
    $this->operations = new Genomics_Operations_Resource(
        $this,
        $this->serviceName,
        'operations',
        array(
    ...
    $this->readgroupsets = new Genomics_Readgroupsets_Resource(
        $this,
        $this->serviceName,
        'readgroupsets',
        array(
    ...
    $this->readgroupsets_coveragebuckets = new Genomics_ReadgroupsetsCoveragebuckets_Resource(
        $this,
        $this->serviceName,
        'coveragebuckets',
        array(
    ...
    $this->reads = new Genomics_Reads_Resource(
        $this,
        $this->serviceName,
        'reads',
        array(
    ...
    $this->references = new Genomics_References_Resource(
        $this,
        $this->serviceName,
        'references',
        array(
    ...
    $this->references_bases = new Genomics_ReferencesBases_Resource(
        $this,
        $this->serviceName,
        'bases',
        array(
    ...
    $this->referencesets = new Genomics_Referencesets_Resource(
        $this,
        $this->serviceName,
        'referencesets',
        array(
    ...
    $this->variants = new Genomics_Variants_Resource(
        $this,
        $this->serviceName,
        'variants',
        array(
    ...
    $this->variantsets = new Genomics_Variantsets_Resource(
        $this,
        $this->serviceName,
        'variantsets',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $genomicsService = new Genomics(...);
 *   $callsets = $genomicsService->callsets;
 *  </code>
 */
class Genomics_Callsets_Resource extends Resource
{
   ...
   * @return Genomics_CallSet
   */
  public function create(Genomics_CallSet $postBody, $optParams = array())
  {
  ...
  public function get($callSetId, $optParams = array())
  {
    $params = array('callSetId' => $callSetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Genomics_CallSet");
  }
   ...
   * @return Genomics_CallSet
   */
  public function patch($callSetId, Genomics_CallSet $postBody, $optParams = array())
  {
    $params = array('callSetId' => $callSetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Genomics_CallSet");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_SearchCallSetsResponse
   */
  public function search(Genomics_SearchCallSetsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Genomics_SearchCallSetsResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_Datasets_Resource extends Resource
{
   ...
   */
  public function create(Genomics_Dataset $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Genomics_Dataset");
  }
  ...
  public function get($datasetId, $optParams = array())
  {
    $params = array('datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Genomics_Dataset");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_Policy
   */
  public function getIamPolicy($resource, Genomics_GetIamPolicyRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('getIamPolicy', array($params), "Genomics_Policy");
  }
   ...
   * @return Genomics_ListDatasetsResponse
   */
  public function listDatasets($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Genomics_ListDatasetsResponse");
  }
   ...
   * @return Genomics_Dataset
   */
  public function patch($datasetId, Genomics_Dataset $postBody, $optParams = array())
  {
    $params = array('datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Genomics_Dataset");
  }
   ...
   * @return Genomics_Policy
   */
  public function setIamPolicy($resource, Genomics_SetIamPolicyRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setIamPolicy', array($params), "Genomics_Policy");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_TestIamPermissionsResponse
   */
  public function testIamPermissions($resource, Genomics_TestIamPermissionsRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('testIamPermissions', array($params), "Genomics_TestIamPermissionsResponse");
  }
   ...
   * @return Genomics_Dataset
   */
  public function undelete($datasetId, Genomics_UndeleteDatasetRequest $postBody, $optParams = array())
  {
    $params = array('datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('undelete', array($params), "Genomics_Dataset");
  }
}
 ...
 *  </code>
 */
class Genomics_Operations_Resource extends Resource
{
   ...
   * @return Genomics_Empty
   */
  public function cancel($name, Genomics_CancelOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Genomics_Empty");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_Operation
   */
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Genomics_Operation");
  }
   ...
   * @return Genomics_ListOperationsResponse
   */
  public function listOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Genomics_ListOperationsResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_Readgroupsets_Resource extends Resource
{
   ...
   * @return Genomics_Operation
   */
  public function export($readGroupSetId, Genomics_ExportReadGroupSetRequest $postBody, $optParams = array())
  {
    $params = array('readGroupSetId' => $readGroupSetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('export', array($params), "Genomics_Operation");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_ReadGroupSet
   */
  public function get($readGroupSetId, $optParams = array())
  {
    $params = array('readGroupSetId' => $readGroupSetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Genomics_ReadGroupSet");
  }
   ...
   * @return Genomics_Operation
   */
  public function import(Genomics_ImportReadGroupSetsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('import', array($params), "Genomics_Operation");
  }
   ...
   * @return Genomics_ReadGroupSet
   */
  public function patch($readGroupSetId, Genomics_ReadGroupSet $postBody, $optParams = array())
  {
    $params = array('readGroupSetId' => $readGroupSetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Genomics_ReadGroupSet");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_SearchReadGroupSetsResponse
   */
  public function search(Genomics_SearchReadGroupSetsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Genomics_SearchReadGroupSetsResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_ReadgroupsetsCoveragebuckets_Resource extends Resource
{
   ...
   * @return Genomics_ListCoverageBucketsResponse
   */
  public function listReadgroupsetsCoveragebuckets($readGroupSetId, $optParams = array())
  {
    $params = array('readGroupSetId' => $readGroupSetId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Genomics_ListCoverageBucketsResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_Reads_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_SearchReadsResponse
   */
  public function search(Genomics_SearchReadsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Genomics_SearchReadsResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_References_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_SearchReferencesResponse
   */
  public function search(Genomics_SearchReferencesRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Genomics_SearchReferencesResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_ReferencesBases_Resource extends Resource
{
   ...
   * through large result sets. To get the next page of results, set this
   * parameter to the value of `nextPageToken` from the previous response.
   * @return Genomics_ListBasesResponse
   */
  public function listReferencesBases($referenceId, $optParams = array())
  {
    $params = array('referenceId' => $referenceId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Genomics_ListBasesResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_Referencesets_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_SearchReferenceSetsResponse
   */
  public function search(Genomics_SearchReferenceSetsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Genomics_SearchReferenceSetsResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_Variants_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_Variant
   */
  public function create(Genomics_Variant $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Genomics_Variant");
  }
  ...
  public function get($variantId, $optParams = array())
  {
    $params = array('variantId' => $variantId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Genomics_Variant");
  }
   ...
   * @return Genomics_Operation
   */
  public function import(Genomics_ImportVariantsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('import', array($params), "Genomics_Operation");
   ...
   * @return Genomics_Variant
   */
  public function patch($variantId, Genomics_Variant $postBody, $optParams = array())
  {
    $params = array('variantId' => $variantId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Genomics_Variant");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_SearchVariantsResponse
   */
  public function search(Genomics_SearchVariantsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Genomics_SearchVariantsResponse");
  }
}
 ...
 *  </code>
 */
class Genomics_Variantsets_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_VariantSet
   */
  public function create(Genomics_VariantSet $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Genomics_VariantSet");
  }
   ...
   * @return Genomics_Operation
   */
  public function export($variantSetId, Genomics_ExportVariantSetRequest $postBody, $optParams = array())
  {
  ...
  public function get($variantSetId, $optParams = array())
  {
    $params = array('variantSetId' => $variantSetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Genomics_VariantSet");
  }
   ...
   * @return Genomics_VariantSet
   */
  public function patch($variantSetId, Genomics_VariantSet $postBody, $optParams = array())
  {
    $params = array('variantSetId' => $variantSetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Genomics_VariantSet");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Genomics_SearchVariantSetsResponse
   */
  public function search(Genomics_SearchVariantSetsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Genomics_SearchVariantSetsResponse");
  }
}
...
class Genomics_Binding extends Collection
{
...
class Genomics_CallSet extends Collection
{
...
class Genomics_CallSetInfo extends Model
{
}

class Genomics_CancelOperationRequest extends Model
{
}

class Genomics_CigarUnit extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $operation;
...
class Genomics_CoverageBucket extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $meanCoverage;
  protected $rangeType = 'Genomics_Range';
  ...
  public function setRange(Genomics_Range $range)
  {
    $this->range = $range;
  }
...
class Genomics_Dataset extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $createTime;
...
class Genomics_Empty extends Model
{
}

class Genomics_Experiment extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_ExportReadGroupSetRequest extends Collection
{
...
class Genomics_ExportVariantSetRequest extends Collection
{
...
class Genomics_GetIamPolicyRequest extends Model
{
}

class Genomics_ImportReadGroupSetsRequest extends Collection
{
...
class Genomics_ImportReadGroupSetsResponse extends Collection
{
...
class Genomics_ImportVariantsRequest extends Collection
{
  protected $collection_key = 'sourceUris';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_ImportVariantsResponse extends Collection
{
  protected $collection_key = 'callSetIds';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_LinearAlignment extends Collection
{
  protected $collection_key = 'cigar';
  protected $internal_gapi_mappings = array(
  );
  protected $cigarType = 'Genomics_CigarUnit';
  protected $cigarDataType = 'array';
  public $mappingQuality;
  protected $positionType = 'Genomics_Position';
  ...
  public function setPosition(Genomics_Position $position)
  {
...
class Genomics_ListBasesResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_ListCoverageBucketsResponse extends Collection
{
  protected $collection_key = 'coverageBuckets';
  protected $internal_gapi_mappings = array(
  );
  public $bucketWidth;
  protected $coverageBucketsType = 'Genomics_CoverageBucket';
...
class Genomics_ListDatasetsResponse extends Collection
{
  protected $collection_key = 'datasets';
  protected $internal_gapi_mappings = array(
  );
  protected $datasetsType = 'Genomics_Dataset';
...
class Genomics_ListOperationsResponse extends Collection
{
  protected $collection_key = 'operations';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $operationsType = 'Genomics_Operation';
...
class Genomics_Operation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $done;
  protected $errorType = 'Genomics_Status';
  ...
  public function setError(Genomics_Status $error)
  {
    $this->error = $error;
  }
...
class Genomics_OperationEvent extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Genomics_OperationMetadata extends Collection
{
  protected $collection_key = 'events';
  protected $internal_gapi_mappings = array(
  );
  public $createTime;
  protected $eventsType = 'Genomics_OperationEvent';
...
class Genomics_OperationMetadataRequest extends Model
{
}

class Genomics_OperationResponse extends Model
{
}

class Genomics_Policy extends Collection
{
  protected $collection_key = 'bindings';
  protected $internal_gapi_mappings = array(
  );
  protected $bindingsType = 'Genomics_Binding';
...
class Genomics_Position extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $position;
...
class Genomics_Program extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $commandLine;
...
class Genomics_Range extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $end;
...
class Genomics_Read extends Collection
{
  ...
  protected $alignmentType = 'Genomics_LinearAlignment';
  ...
  public $id;
  public $info;
  protected $nextMatePositionType = 'Genomics_Position';
  ...
  public function setAlignment(Genomics_LinearAlignment $alignment)
  {
  ...
  public function setNextMatePosition(Genomics_Position $nextMatePosition)
  {
...
class Genomics_ReadGroup extends Collection
{
  ...
  public $datasetId;
  public $description;
  protected $experimentType = 'Genomics_Experiment';
  protected $experimentDataType = '';
  public $id;
  public $info;
  public $name;
  public $predictedInsertSize;
  protected $programsType = 'Genomics_Program';
  ...
  public function setExperiment(Genomics_Experiment $experiment)
  {
...
class Genomics_ReadGroupInfo extends Model
{
}

class Genomics_ReadGroupSet extends Collection
{
  ...
  public $info;
  public $name;
  protected $readGroupsType = 'Genomics_ReadGroup';
...
class Genomics_ReadGroupSetInfo extends Model
{
}

class Genomics_ReadInfo extends Model
{
}

class Genomics_Reference extends Collection
{
...
class Genomics_ReferenceBound extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $referenceName;
...
class Genomics_ReferenceSet extends Collection
{
  protected $collection_key = 'sourceAccessions';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_SearchCallSetsRequest extends Collection
{
  protected $collection_key = 'variantSetIds';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_SearchCallSetsResponse extends Collection
{
  protected $collection_key = 'callSets';
  protected $internal_gapi_mappings = array(
  );
  protected $callSetsType = 'Genomics_CallSet';
...
class Genomics_SearchReadGroupSetsRequest extends Collection
{
...
class Genomics_SearchReadGroupSetsResponse extends Collection
{
  protected $collection_key = 'readGroupSets';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $readGroupSetsType = 'Genomics_ReadGroupSet';
...
class Genomics_SearchReadsRequest extends Collection
{
  protected $collection_key = 'readGroupSetIds';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_SearchReadsResponse extends Collection
{
  protected $collection_key = 'alignments';
  protected $internal_gapi_mappings = array(
  );
  protected $alignmentsType = 'Genomics_Read';
...
class Genomics_SearchReferenceSetsRequest extends Collection
{
...
class Genomics_SearchReferenceSetsResponse extends Collection
{
  protected $collection_key = 'referenceSets';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $referenceSetsType = 'Genomics_ReferenceSet';
...
class Genomics_SearchReferencesRequest extends Collection
{
  protected $collection_key = 'md5checksums';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_SearchReferencesResponse extends Collection
{
  protected $collection_key = 'references';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $referencesType = 'Genomics_Reference';
...
class Genomics_SearchVariantSetsRequest extends Collection
{
  protected $collection_key = 'datasetIds';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_SearchVariantSetsResponse extends Collection
{
  protected $collection_key = 'variantSets';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $variantSetsType = 'Genomics_VariantSet';
...
class Genomics_SearchVariantsRequest extends Collection
{
  protected $collection_key = 'variantSetIds';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_SearchVariantsResponse extends Collection
{
  protected $collection_key = 'variants';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $variantsType = 'Genomics_Variant';
...
class Genomics_SetIamPolicyRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $policyType = 'Genomics_Policy';
  protected $policyDataType = '';


  public function setPolicy(Genomics_Policy $policy)
  {
    $this->policy = $policy;
  }
...
class Genomics_Status extends Collection
{
...
class Genomics_StatusDetails extends Model
{
}

class Genomics_TestIamPermissionsRequest extends Collection
{
...
class Genomics_TestIamPermissionsResponse extends Collection
{
  protected $collection_key = 'permissions';
  protected $internal_gapi_mappings = array(
  );
...
class Genomics_UndeleteDatasetRequest extends Model
{
}

class Genomics_Variant extends Collection
{
  protected $collection_key = 'names';
  protected $internal_gapi_mappings = array(
  );
  public $alternateBases;
  protected $callsType = 'Genomics_VariantCall';
...
class Genomics_VariantCall extends Collection
{
...
class Genomics_VariantCallInfo extends Model
{
}

class Genomics_VariantInfo extends Model
{
}

class Genomics_VariantSet extends Collection
{
  ...
  public $datasetId;
  public $id;
  protected $metadataType = 'Genomics_VariantSetMetadata';
  protected $metadataDataType = 'array';
  protected $referenceBoundsType = 'Genomics_ReferenceBound';
...
class Genomics_VariantSetMetadata extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Genomics_VariantSetMetadataInfo extends Model
{
}

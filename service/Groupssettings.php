 ...
 * @author Google, Inc.
 */
class Groupssettings extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->groups = new Groupssettings_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupssettingsService = new Groupssettings(...);
 *   $groups = $groupssettingsService->groups;
 *  </code>
 */
class Groupssettings_Groups_Resource extends Resource
{
   ...
   * @return Groupssettings_Groups
   */
  public function patch($groupUniqueId, Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Groupssettings_Groups");
  }
   ...
   * @return Groupssettings_Groups
   */
  public function update($groupUniqueId, Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Groupssettings_Groups");
  }
}
...
class Groupssettings_Groups extends Model
{

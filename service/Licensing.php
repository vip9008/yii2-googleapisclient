 ...
 * @author Google, Inc.
 */
class Licensing extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->licenseAssignments = new Licensing_LicenseAssignments_Resource(
        $this,
        $this->serviceName,
        'licenseAssignments',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $licensingService = new Licensing(...);
 *   $licenseAssignments = $licensingService->licenseAssignments;
 *  </code>
 */
class Licensing_LicenseAssignments_Resource extends Resource
{
   ...
   * @param string $userId email id or unique Id of the user
   * @param array $optParams Optional parameters.
   * @return Licensing_LicenseAssignment
   */
  public function get($productId, $skuId, $userId, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Licensing_LicenseAssignment");
  }
   ...
   * @return Licensing_LicenseAssignment
   */
  public function insert($productId, $skuId, Licensing_LicenseAssignmentInsert $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Licensing_LicenseAssignment");
  }
   ...
   * @return Licensing_LicenseAssignmentList
   */
  public function listForProduct($productId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProduct', array($params), "Licensing_LicenseAssignmentList");
  }
  ...
  public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProductAndSku', array($params), "Licensing_LicenseAssignmentList");
  }
   ...
   * @return Licensing_LicenseAssignment
   */
  public function patch($productId, $skuId, $userId, Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Licensing_LicenseAssignment");
  }
   ...
   * @return Licensing_LicenseAssignment
   */
  public function update($productId, $skuId, $userId, Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Licensing_LicenseAssignment");
  }
}
...
class Licensing_LicenseAssignment extends Model
{
...
class Licensing_LicenseAssignmentInsert extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $userId;
...
class Licensing_LicenseAssignmentList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Licensing_LicenseAssignment';

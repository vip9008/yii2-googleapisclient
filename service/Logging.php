...
class Logging_LogLine extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $logMessage;
  public $severity;
  protected $sourceLocationType = 'Logging_SourceLocation';
  ...
  public function setSourceLocation(Logging_SourceLocation $sourceLocation)
  {
...
class Logging_RequestLog extends Collection
{
  ...
  public $ip;
  public $latency;
  protected $lineType = 'Logging_LogLine';
  ...
  public $resource;
  public $responseSize;
  protected $sourceReferenceType = 'Logging_SourceReference';
...
class Logging_SourceLocation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $file;
...
class Logging_SourceReference extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $repository;

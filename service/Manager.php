...
class Manager extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->deployments = new Manager_Deployments_Resource(
        $this,
        $this->serviceName,
        'deployments',
        array(
    ...
    $this->templates = new Manager_Templates_Resource(
        $this,
        $this->serviceName,
        'templates',
        array(
 ...
 *  </code>
 */
class Manager_Deployments_Resource extends Resource
{
  ...
  public function get($projectId, $region, $deploymentName, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'region' => $region, 'deploymentName' => $deploymentName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Manager_Deployment");
  }
   ...
   * @return Manager_Deployment
   */
  public function insert($projectId, $region, Manager_Deployment $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'region' => $region, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Manager_Deployment");
  }
 ...
 *  </code>
 */
class Manager_Templates_Resource extends Resource
{
  ...
  public function get($projectId, $templateName, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'templateName' => $templateName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Manager_Template");
  }
   ...
   * @return Manager_Template
   */
  public function insert($projectId, Manager_Template $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Manager_Template");
  }
   ...
   * @opt_param int maxResults Maximum count of results to be returned. Acceptable
   * values are 0 to 100, inclusive. (Default: 50)
   * @return Manager_TemplatesListResponse
   */
  public function listTemplates($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Manager_TemplatesListResponse");
  }
}
...
class Manager_AccessConfig extends Model
{
...
class Manager_Action extends Collection
{
...
class Manager_AllowedRule extends Collection
{
...
class Manager_AutoscalingModule extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Manager_AutoscalingModuleStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Manager_DeployState extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $details;
...
class Manager_Deployment extends Collection
{
  ...
  public $creationDate;
  public $description;
  protected $modulesType = 'Manager_ModuleStatus';
  protected $modulesDataType = 'map';
  public $name;
  protected $overridesType = 'Manager_ParamOverride';
  protected $overridesDataType = 'array';
  protected $stateType = 'Manager_DeployState';
  ...
  public function setState(Manager_DeployState $state)
  {
    $this->state = $state;
  }
...
class Manager_DeploymentModules extends Model
{
}

class Manager_DeploymentsListResponse extends Collection
{
  protected $collection_key = 'resources';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $resourcesType = 'Manager_Deployment';
...
class Manager_DiskAttachment extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $deviceName;
...
class Manager_EnvVariable extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $hidden;
...
class Manager_ExistingDisk extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $attachmentType = 'Manager_DiskAttachment';
  protected $attachmentDataType = '';
  public $source;


  public function setAttachment(Manager_DiskAttachment $attachment)
  {
...
class Manager_FirewallModule extends Collection
{
  protected $collection_key = 'targetTags';
  protected $internal_gapi_mappings = array(
  );
  protected $allowedType = 'Manager_AllowedRule';
...
class Manager_FirewallModuleStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $firewallUrl;
...
class Manager_HealthCheckModule extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Manager_HealthCheckModuleStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Manager_LbModule extends Collection
{
...
class Manager_LbModuleStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Manager_Metadata extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $fingerPrint;
  protected $itemsType = 'Manager_MetadataItem';
...
class Manager_MetadataItem extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class Manager_Module extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $autoscalingModuleType = 'Manager_AutoscalingModule';
  protected $autoscalingModuleDataType = '';
  protected $firewallModuleType = 'Manager_FirewallModule';
  protected $firewallModuleDataType = '';
  protected $healthCheckModuleType = 'Manager_HealthCheckModule';
  protected $healthCheckModuleDataType = '';
  protected $lbModuleType = 'Manager_LbModule';
  protected $lbModuleDataType = '';
  protected $networkModuleType = 'Manager_NetworkModule';
  protected $networkModuleDataType = '';
  protected $replicaPoolModuleType = 'Manager_ReplicaPoolModule';
  protected $replicaPoolModuleDataType = '';
  public $type;


  public function setAutoscalingModule(Manager_AutoscalingModule $autoscalingModule)
  {
  ...
  public function setFirewallModule(Manager_FirewallModule $firewallModule)
  {
  ...
  public function setHealthCheckModule(Manager_HealthCheckModule $healthCheckModule)
  {
  ...
  public function setLbModule(Manager_LbModule $lbModule)
  {
  ...
  public function setNetworkModule(Manager_NetworkModule $networkModule)
  {
  ...
  public function setReplicaPoolModule(Manager_ReplicaPoolModule $replicaPoolModule)
  {
...
class Manager_ModuleStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $autoscalingModuleStatusType = 'Manager_AutoscalingModuleStatus';
  protected $autoscalingModuleStatusDataType = '';
  protected $firewallModuleStatusType = 'Manager_FirewallModuleStatus';
  protected $firewallModuleStatusDataType = '';
  protected $healthCheckModuleStatusType = 'Manager_HealthCheckModuleStatus';
  protected $healthCheckModuleStatusDataType = '';
  protected $lbModuleStatusType = 'Manager_LbModuleStatus';
  protected $lbModuleStatusDataType = '';
  protected $networkModuleStatusType = 'Manager_NetworkModuleStatus';
  protected $networkModuleStatusDataType = '';
  protected $replicaPoolModuleStatusType = 'Manager_ReplicaPoolModuleStatus';
  ...
  public function setAutoscalingModuleStatus(Manager_AutoscalingModuleStatus $autoscalingModuleStatus)
  {
  ...
  public function setFirewallModuleStatus(Manager_FirewallModuleStatus $firewallModuleStatus)
  {
  ...
  public function setHealthCheckModuleStatus(Manager_HealthCheckModuleStatus $healthCheckModuleStatus)
  {
  ...
  public function setLbModuleStatus(Manager_LbModuleStatus $lbModuleStatus)
  {
  ...
  public function setNetworkModuleStatus(Manager_NetworkModuleStatus $networkModuleStatus)
  {
  ...
  public function setReplicaPoolModuleStatus(Manager_ReplicaPoolModuleStatus $replicaPoolModuleStatus)
  {
...
class Manager_NetworkInterface extends Collection
{
  protected $collection_key = 'accessConfigs';
  protected $internal_gapi_mappings = array(
  );
  protected $accessConfigsType = 'Manager_AccessConfig';
...
class Manager_NetworkModule extends Model
{
  protected $internal_gapi_mappings = array(
        "iPv4Range" => "IPv4Range",
  );
...
class Manager_NetworkModuleStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $networkUrl;
...
class Manager_NewDisk extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $attachmentType = 'Manager_DiskAttachment';
  ...
  public $autoDelete;
  public $boot;
  protected $initializeParamsType = 'Manager_NewDiskInitializeParams';
  ...
  public function setInitializeParams(Manager_NewDiskInitializeParams $initializeParams)
  {
...
class Manager_NewDiskInitializeParams extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $diskSizeGb;
...
class Manager_ParamOverride extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $path;
...
class Manager_ReplicaPoolModule extends Collection
{
  protected $collection_key = 'healthChecks';
  protected $internal_gapi_mappings = array(
  );
  protected $envVariablesType = 'Manager_EnvVariable';
  protected $envVariablesDataType = 'map';
  public $healthChecks;
  public $numReplicas;
  protected $replicaPoolParamsType = 'Manager_ReplicaPoolParams';
  ...
  public function setReplicaPoolParams(Manager_ReplicaPoolParams $replicaPoolParams)
  {
...
class Manager_ReplicaPoolModuleEnvVariables extends Model
{
}

class Manager_ReplicaPoolModuleStatus extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Manager_ReplicaPoolParams extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $v1beta1Type = 'Manager_ReplicaPoolParamsV1Beta1';
  protected $v1beta1DataType = '';


  public function setV1beta1(Manager_ReplicaPoolParamsV1Beta1 $v1beta1)
  {
...
class Manager_ReplicaPoolParamsV1Beta1 extends Collection
{
  ...
  public $canIpForward;
  public $description;
  protected $disksToAttachType = 'Manager_ExistingDisk';
  protected $disksToAttachDataType = 'array';
  protected $disksToCreateType = 'Manager_NewDisk';
  protected $disksToCreateDataType = 'array';
  public $initAction;
  public $machineType;
  protected $metadataType = 'Manager_Metadata';
  protected $metadataDataType = '';
  protected $networkInterfacesType = 'Manager_NetworkInterface';
  protected $networkInterfacesDataType = 'array';
  public $onHostMaintenance;
  protected $serviceAccountsType = 'Manager_ServiceAccount';
  protected $serviceAccountsDataType = 'array';
  protected $tagsType = 'Manager_Tag';
  ...
  public function setMetadata(Manager_Metadata $metadata)
  {
  ...
  public function setTags(Manager_Tag $tags)
  {
    $this->tags = $tags;
  }
...
class Manager_ServiceAccount extends Collection
{
...
class Manager_Tag extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Manager_Template extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $actionsType = 'Manager_Action';
  protected $actionsDataType = 'map';
  public $description;
  protected $modulesType = 'Manager_Module';
  protected $modulesDataType = 'map';
  public $name;
...
class Manager_TemplateActions extends Model
{
}

class Manager_TemplateModules extends Model
{
}

class Manager_TemplatesListResponse extends Collection
{
  protected $collection_key = 'resources';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $resourcesType = 'Manager_Template';
  protected $resourcesDataType = 'array';

...
class Mirror extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->accounts = new Mirror_Accounts_Resource(
        $this,
        $this->serviceName,
        'accounts',
        array(
    ...
    $this->contacts = new Mirror_Contacts_Resource(
        $this,
        $this->serviceName,
        'contacts',
        array(
    ...
    $this->locations = new Mirror_Locations_Resource(
        $this,
        $this->serviceName,
        'locations',
        array(
    ...
    $this->settings = new Mirror_Settings_Resource(
        $this,
        $this->serviceName,
        'settings',
        array(
    ...
    $this->subscriptions = new Mirror_Subscriptions_Resource(
        $this,
        $this->serviceName,
        'subscriptions',
        array(
    ...
    $this->timeline = new Mirror_Timeline_Resource(
        $this,
        $this->serviceName,
        'timeline',
        array(
    ...
    $this->timeline_attachments = new Mirror_TimelineAttachments_Resource(
        $this,
        $this->serviceName,
        'attachments',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $mirrorService = new Mirror(...);
 *   $accounts = $mirrorService->accounts;
 *  </code>
 */
class Mirror_Accounts_Resource extends Resource
{
   ...
   */
  public function insert($userToken, $accountType, $accountName, Mirror_Account $postBody, $optParams = array())
  {
    $params = array('userToken' => $userToken, 'accountType' => $accountType, 'accountName' => $accountName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Mirror_Account");
  }
}
 ...
 *  </code>
 */
class Mirror_Contacts_Resource extends Resource
{
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Mirror_Contact");
  }
   ...
   * @return Mirror_Contact
   */
  public function insert(Mirror_Contact $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Mirror_Contact");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Mirror_ContactsListResponse
   */
  public function listContacts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Mirror_ContactsListResponse");
  }
   ...
   * @return Mirror_Contact
   */
  public function patch($id, Mirror_Contact $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Mirror_Contact");
  }
   ...
   * @return Mirror_Contact
   */
  public function update($id, Mirror_Contact $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Mirror_Contact");
  }
}
 ...
 *  </code>
 */
class Mirror_Locations_Resource extends Resource
{
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Mirror_Location");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Mirror_LocationsListResponse
   */
  public function listLocations($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Mirror_LocationsListResponse");
  }
}
 ...
 *  </code>
 */
class Mirror_Settings_Resource extends Resource
{
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Mirror_Setting");
  }
}
 ...
 *  </code>
 */
class Mirror_Subscriptions_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Mirror_Subscription
   */
  public function insert(Mirror_Subscription $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Mirror_Subscription");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Mirror_SubscriptionsListResponse
   */
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Mirror_SubscriptionsListResponse");
  }
   ...
   * @return Mirror_Subscription
   */
  public function update($id, Mirror_Subscription $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Mirror_Subscription");
  }
}
 ...
 *  </code>
 */
class Mirror_Timeline_Resource extends Resource
{
   ...
   * @param string $id The ID of the timeline item.
   * @param array $optParams Optional parameters.
   * @return Mirror_TimelineItem
   */
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Mirror_TimelineItem");
  }
   ...
   * @return Mirror_TimelineItem
   */
  public function insert(Mirror_TimelineItem $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Mirror_TimelineItem");
  }
   ...
   * will be returned.
   * @return Mirror_TimelineListResponse
   */
  public function listTimeline($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Mirror_TimelineListResponse");
  }
   ...
   * @return Mirror_TimelineItem
   */
  public function patch($id, Mirror_TimelineItem $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Mirror_TimelineItem");
  }
   ...
   * @return Mirror_TimelineItem
   */
  public function update($id, Mirror_TimelineItem $postBody, $optParams = array())
  {
    $params = array('id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Mirror_TimelineItem");
  }
}
 ...
 *  </code>
 */
class Mirror_TimelineAttachments_Resource extends Resource
{
   ...
   * @param string $attachmentId The ID of the attachment.
   * @param array $optParams Optional parameters.
   * @return Mirror_Attachment
   */
  public function get($itemId, $attachmentId, $optParams = array())
  {
    $params = array('itemId' => $itemId, 'attachmentId' => $attachmentId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Mirror_Attachment");
  }
  ...
  public function insert($itemId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Mirror_Attachment");
  }
   ...
   * listed.
   * @param array $optParams Optional parameters.
   * @return Mirror_AttachmentsListResponse
   */
  public function listTimelineAttachments($itemId, $optParams = array())
  {
    $params = array('itemId' => $itemId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Mirror_AttachmentsListResponse");
  }
}
...
class Mirror_Account extends Collection
{
  protected $collection_key = 'userData';
  protected $internal_gapi_mappings = array(
  );
  protected $authTokensType = 'Mirror_AuthToken';
  protected $authTokensDataType = 'array';
  public $features;
  public $password;
  protected $userDataType = 'Mirror_UserData';
...
class Mirror_Attachment extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $contentType;
...
class Mirror_AttachmentsListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Mirror_Attachment';
...
class Mirror_AuthToken extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $authToken;
...
class Mirror_Command extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class Mirror_Contact extends Collection
{
  protected $collection_key = 'sharingFeatures';
  protected $internal_gapi_mappings = array(
  );
  protected $acceptCommandsType = 'Mirror_Command';
...
class Mirror_ContactsListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Mirror_Contact';
  protected $itemsDataType = 'array';
  public $kind;
...
class Mirror_Location extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accuracy;
...
class Mirror_LocationsListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Mirror_Location';
  protected $itemsDataType = 'array';
  public $kind;
...
class Mirror_MenuItem extends Collection
{
  ...
  protected $valuesType = 'Mirror_MenuValue';
...
class Mirror_MenuValue extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class Mirror_Notification extends Collection
{
  ...
  public $itemId;
  public $operation;
  protected $userActionsType = 'Mirror_UserAction';
...
class Mirror_NotificationConfig extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $deliveryTime;
...
class Mirror_Setting extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Mirror_Subscription extends Collection
{
  ...
  public $id;
  public $kind;
  protected $notificationType = 'Mirror_Notification';
  ...
  public function setNotification(Mirror_Notification $notification)
  {
...
class Mirror_SubscriptionsListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Mirror_Subscription';
  protected $itemsDataType = 'array';
  public $kind;
...
class Mirror_TimelineItem extends Collection
{
  protected $collection_key = 'recipients';
  protected $internal_gapi_mappings = array(
  );
  protected $attachmentsType = 'Mirror_Attachment';
  protected $attachmentsDataType = 'array';
  public $bundleId;
  public $canonicalUrl;
  public $created;
  protected $creatorType = 'Mirror_Contact';
  ...
  public $isPinned;
  public $kind;
  protected $locationType = 'Mirror_Location';
  protected $locationDataType = '';
  protected $menuItemsType = 'Mirror_MenuItem';
  protected $menuItemsDataType = 'array';
  protected $notificationType = 'Mirror_NotificationConfig';
  protected $notificationDataType = '';
  public $pinScore;
  protected $recipientsType = 'Mirror_Contact';
  ...
  public function setCreator(Mirror_Contact $creator)
  {
  ...
  public function setLocation(Mirror_Location $location)
  {
  ...
  public function setNotification(Mirror_NotificationConfig $notification)
  {
    $this->notification = $notification;
  }
  public function getNotification()
...
class Mirror_TimelineListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Mirror_TimelineItem';
  protected $itemsDataType = 'array';
  public $kind;
...
class Mirror_UserAction extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $payload;
...
class Mirror_UserData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;

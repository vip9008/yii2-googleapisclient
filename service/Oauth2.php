...
class Oauth2 extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->userinfo = new Oauth2_Userinfo_Resource(
        $this,
        $this->serviceName,
        'userinfo',
        array(
    ...
    $this->userinfo_v2_me = new Oauth2_UserinfoV2Me_Resource(
        $this,
        $this->serviceName,
        'me',
        array(
  ...
  public function getCertForOpenIdConnect($optParams = array())
  {
    ...
    return $this->base_methods->call('getCertForOpenIdConnect', array($params), "Oauth2_Jwk");
  }
  /**
   * (tokeninfo)
   *
  ...
  public function tokeninfo($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('tokeninfo', array($params), "Oauth2_Tokeninfo");
  }
}

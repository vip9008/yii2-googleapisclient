 ...
 * @author Google, Inc.
 */
class Pagespeedonline extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->pagespeedapi = new Pagespeedonline_Pagespeedapi_Resource(
        $this,
        $this->serviceName,
        'pagespeedapi',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $pagespeedonlineService = new Pagespeedonline(...);
 *   $pagespeedapi = $pagespeedonlineService->pagespeedapi;
 *  </code>
 */
class Pagespeedonline_Pagespeedapi_Resource extends Resource
{
   ...
   * @return Pagespeedonline_Result
   */
  public function runpagespeed($url, $optParams = array())
  {
    $params = array('url' => $url);
    $params = array_merge($params, $optParams);
    return $this->call('runpagespeed', array($params), "Pagespeedonline_Result");
  }
}
...
class Pagespeedonline_PagespeedApiFormatStringV2 extends Collection
{
  protected $collection_key = 'args';
  protected $internal_gapi_mappings = array(
  );
  protected $argsType = 'Pagespeedonline_PagespeedApiFormatStringV2Args';
...
class Pagespeedonline_PagespeedApiFormatStringV2Args extends Collection
{
  ...
  public $key;
  protected $rectsType = 'Pagespeedonline_PagespeedApiFormatStringV2ArgsRects';
  protected $rectsDataType = 'array';
  protected $secondaryRectsType = 'Pagespeedonline_PagespeedApiFormatStringV2ArgsSecondaryRects';
...
class Pagespeedonline_PagespeedApiFormatStringV2ArgsRects extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $height;
...
class Pagespeedonline_PagespeedApiFormatStringV2ArgsSecondaryRects extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $height;
...
class Pagespeedonline_PagespeedApiImageV2 extends Model
{
  protected $internal_gapi_mappings = array(
        "mimeType" => "mime_type",
        "pageRect" => "page_rect",
  ...
  public $key;
  public $mimeType;
  protected $pageRectType = 'Pagespeedonline_PagespeedApiImageV2PageRect';
  ...
  public function setPageRect(Pagespeedonline_PagespeedApiImageV2PageRect $pageRect)
  {
...
class Pagespeedonline_PagespeedApiImageV2PageRect extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $height;
...
class Pagespeedonline_Result extends Collection
{
  protected $collection_key = 'invalidRules';
  protected $internal_gapi_mappings = array(
  );
  protected $formattedResultsType = 'Pagespeedonline_ResultFormattedResults';
  protected $formattedResultsDataType = '';
  public $id;
  public $invalidRules;
  public $kind;
  protected $pageStatsType = 'Pagespeedonline_ResultPageStats';
  protected $pageStatsDataType = '';
  public $responseCode;
  protected $ruleGroupsType = 'Pagespeedonline_ResultRuleGroupsElement';
  protected $ruleGroupsDataType = 'map';
  protected $screenshotType = 'Pagespeedonline_PagespeedApiImageV2';
  protected $screenshotDataType = '';
  public $title;
  protected $versionType = 'Pagespeedonline_ResultVersion';
  protected $versionDataType = '';


  public function setFormattedResults(Pagespeedonline_ResultFormattedResults $formattedResults)
  {
  ...
  public function setPageStats(Pagespeedonline_ResultPageStats $pageStats)
  {
  ...
  public function setScreenshot(Pagespeedonline_PagespeedApiImageV2 $screenshot)
  {
  ...
  public function setVersion(Pagespeedonline_ResultVersion $version)
  {
...
class Pagespeedonline_ResultFormattedResults extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $locale;
  protected $ruleResultsType = 'Pagespeedonline_ResultFormattedResultsRuleResultsElement';
...
class Pagespeedonline_ResultFormattedResultsRuleResults extends Model
{
}

class Pagespeedonline_ResultFormattedResultsRuleResultsElement extends Collection
{
  ...
  public $ruleImpact;
  protected $summaryType = 'Pagespeedonline_PagespeedApiFormatStringV2';
  protected $summaryDataType = '';
  protected $urlBlocksType = 'Pagespeedonline_ResultFormattedResultsRuleResultsElementUrlBlocks';
  ...
  public function setSummary(Pagespeedonline_PagespeedApiFormatStringV2 $summary)
  {
...
class Pagespeedonline_ResultFormattedResultsRuleResultsElementUrlBlocks extends Collection
{
  protected $collection_key = 'urls';
  protected $internal_gapi_mappings = array(
  );
  protected $headerType = 'Pagespeedonline_PagespeedApiFormatStringV2';
  protected $headerDataType = '';
  protected $urlsType = 'Pagespeedonline_ResultFormattedResultsRuleResultsElementUrlBlocksUrls';
  protected $urlsDataType = 'array';


  public function setHeader(Pagespeedonline_PagespeedApiFormatStringV2 $header)
  {
    $this->header = $header;
  }
...
class Pagespeedonline_ResultFormattedResultsRuleResultsElementUrlBlocksUrls extends Collection
{
  protected $collection_key = 'details';
  protected $internal_gapi_mappings = array(
  );
  protected $detailsType = 'Pagespeedonline_PagespeedApiFormatStringV2';
  protected $detailsDataType = 'array';
  protected $resultType = 'Pagespeedonline_PagespeedApiFormatStringV2';
  ...
  public function setResult(Pagespeedonline_PagespeedApiFormatStringV2 $result)
  {
    $this->result = $result;
  }
...
class Pagespeedonline_ResultPageStats extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Pagespeedonline_ResultRuleGroups extends Model
{
}

class Pagespeedonline_ResultRuleGroupsElement extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $score;
...
class Pagespeedonline_ResultVersion extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $major;

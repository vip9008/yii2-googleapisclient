...
class Partners extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->clientMessages = new Partners_ClientMessages_Resource(
        $this,
        $this->serviceName,
        'clientMessages',
        array(
    ...
    $this->companies = new Partners_Companies_Resource(
        $this,
        $this->serviceName,
        'companies',
        array(
    ...
    $this->companies_leads = new Partners_CompaniesLeads_Resource(
        $this,
        $this->serviceName,
        'leads',
        array(
    ...
    $this->userEvents = new Partners_UserEvents_Resource(
        $this,
        $this->serviceName,
        'userEvents',
        array(
    ...
    $this->userStates = new Partners_UserStates_Resource(
        $this,
        $this->serviceName,
        'userStates',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $partnersService = new Partners(...);
 *   $clientMessages = $partnersService->clientMessages;
 *  </code>
 */
class Partners_ClientMessages_Resource extends Resource
{
   ...
   * @return Partners_LogMessageResponse
   */
  public function log(Partners_LogMessageRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('log', array($params), "Partners_LogMessageResponse");
  }
}
 ...
 *  </code>
 */
class Partners_Companies_Resource extends Resource
{
   ...
   * @return Partners_GetCompanyResponse
   */
  public function get($companyId, $optParams = array())
  {
    $params = array('companyId' => $companyId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Partners_GetCompanyResponse");
  }
   ...
   * example if `currencyCode` is `"USD"`, then 1 unit is one US dollar.
   * @return Partners_ListCompaniesResponse
   */
  public function listCompanies($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Partners_ListCompaniesResponse");
  }
}
 ...
 *  </code>
 */
class Partners_CompaniesLeads_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Partners_CreateLeadResponse
   */
  public function create($companyId, Partners_CreateLeadRequest $postBody, $optParams = array())
  {
    $params = array('companyId' => $companyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Partners_CreateLeadResponse");
  }
}
 ...
 *  </code>
 */
class Partners_UserEvents_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Partners_LogUserEventResponse
   */
  public function log(Partners_LogUserEventRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('log', array($params), "Partners_LogUserEventResponse");
  }
}
 ...
 *  </code>
 */
class Partners_UserStates_Resource extends Resource
{
   ...
   * indicate where the traffic comes from. An identifier has multiple letters
   * created by a team which redirected the traffic to us.
   * @return Partners_ListUserStatesResponse
   */
  public function listUserStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Partners_ListUserStatesResponse");
  }
}
...
class Partners_CertificationExamStatus extends Model
{
...
class Partners_CertificationStatus extends Collection
{
  protected $collection_key = 'examStatuses';
  protected $internal_gapi_mappings = array(
  );
  protected $examStatusesType = 'Partners_CertificationExamStatus';
...
class Partners_Company extends Collection
{
  protected $collection_key = 'services';
  protected $internal_gapi_mappings = array(
  );
  protected $certificationStatusesType = 'Partners_CertificationStatus';
  protected $certificationStatusesDataType = 'array';
  protected $convertedMinMonthlyBudgetType = 'Partners_Money';
  protected $convertedMinMonthlyBudgetDataType = '';
  public $id;
  public $industries;
  protected $localizedInfosType = 'Partners_LocalizedCompanyInfo';
  protected $localizedInfosDataType = 'array';
  protected $locationsType = 'Partners_Location';
  protected $locationsDataType = 'array';
  public $name;
  protected $originalMinMonthlyBudgetType = 'Partners_Money';
  protected $originalMinMonthlyBudgetDataType = '';
  protected $publicProfileType = 'Partners_PublicProfile';
  protected $publicProfileDataType = '';
  protected $ranksType = 'Partners_Rank';
  ...
  public function setConvertedMinMonthlyBudget(Partners_Money $convertedMinMonthlyBudget)
  {
  ...
  public function setOriginalMinMonthlyBudget(Partners_Money $originalMinMonthlyBudget)
  {
  ...
  public function setPublicProfile(Partners_PublicProfile $publicProfile)
  {
...
class Partners_CreateLeadRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $leadType = 'Partners_Lead';
  protected $leadDataType = '';
  protected $recaptchaChallengeType = 'Partners_RecaptchaChallenge';
  protected $recaptchaChallengeDataType = '';
  protected $requestMetadataType = 'Partners_RequestMetadata';
  protected $requestMetadataDataType = '';


  public function setLead(Partners_Lead $lead)
  {
    $this->lead = $lead;
  }
  ...
  public function setRecaptchaChallenge(Partners_RecaptchaChallenge $recaptchaChallenge)
  {
  ...
  public function setRequestMetadata(Partners_RequestMetadata $requestMetadata)
  {
...
class Partners_CreateLeadResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $leadType = 'Partners_Lead';
  ...
  protected $responseMetadataType = 'Partners_ResponseMetadata';
  ...
  public function setResponseMetadata(Partners_ResponseMetadata $responseMetadata)
  {
...
class Partners_DebugInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $serverInfo;
...
class Partners_EventData extends Collection
{
...
class Partners_GetCompanyResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $companyType = 'Partners_Company';
  protected $companyDataType = '';
  protected $responseMetadataType = 'Partners_ResponseMetadata';
  protected $responseMetadataDataType = '';


  public function setCompany(Partners_Company $company)
  {
...
class Partners_LatLng extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $latitude;
...
class Partners_Lead extends Collection
{
  ...
  public $id;
  protected $minMonthlyBudgetType = 'Partners_Money';
  ...
  public function setMinMonthlyBudget(Partners_Money $minMonthlyBudget)
  {
...
class Partners_ListCompaniesResponse extends Collection
{
  protected $collection_key = 'companies';
  protected $internal_gapi_mappings = array(
  );
  protected $companiesType = 'Partners_Company';
...
class Partners_ListUserStatesResponse extends Collection
{
...
class Partners_LocalizedCompanyInfo extends Collection
{
...
class Partners_Location extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
  protected $latLngType = 'Partners_LatLng';
  ...
  public function setLatLng(Partners_LatLng $latLng)
  {
    $this->latLng = $latLng;
  }
...
class Partners_LogMessageRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $clientInfo;
...
class Partners_LogMessageRequestClientInfo extends Model
{
}

class Partners_LogMessageResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $responseMetadataType = 'Partners_ResponseMetadata';
...
class Partners_LogUserEventRequest extends Collection
{
  ...
  protected $eventDatasType = 'Partners_EventData';
...
class Partners_LogUserEventResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $responseMetadataType = 'Partners_ResponseMetadata';
...
class Partners_Money extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $currencyCode;
...
class Partners_PublicProfile extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Partners_Rank extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class Partners_RecaptchaChallenge extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Partners_RequestMetadata extends Collection
{
  ...
  protected $trafficSourceType = 'Partners_TrafficSource';
  protected $trafficSourceDataType = '';
  protected $userOverridesType = 'Partners_UserOverrides';
  ...
  public function setTrafficSource(Partners_TrafficSource $trafficSource)
  {
  ...
  public function setUserOverrides(Partners_UserOverrides $userOverrides)
  {
...
class Partners_ResponseMetadata extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $debugInfoType = 'Partners_DebugInfo';
  protected $debugInfoDataType = '';


  public function setDebugInfo(Partners_DebugInfo $debugInfo)
  {
...
class Partners_TrafficSource extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Partners_UserOverrides extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $ipAddress;

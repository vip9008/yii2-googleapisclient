 ...
 * @author Google, Inc.
 */
class Playmoviespartner extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->accounts_avails = new Playmoviespartner_AccountsAvails_Resource(
        $this,
        $this->serviceName,
        'avails',
        array(
    ...
    $this->accounts_experienceLocales = new Playmoviespartner_AccountsExperienceLocales_Resource(
        $this,
        $this->serviceName,
        'experienceLocales',
        array(
    ...
    $this->accounts_orders = new Playmoviespartner_AccountsOrders_Resource(
        $this,
        $this->serviceName,
        'orders',
        array(
    ...
    $this->accounts_storeInfos = new Playmoviespartner_AccountsStoreInfos_Resource(
        $this,
        $this->serviceName,
        'storeInfos',
        array(
    ...
    $this->accounts_storeInfos_country = new Playmoviespartner_AccountsStoreInfosCountry_Resource(
        $this,
        $this->serviceName,
        'country',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $playmoviespartnerService = new Playmoviespartner(...);
 *   $accounts = $playmoviespartnerService->accounts;
 *  </code>
 */
class Playmoviespartner_Accounts_Resource extends Resource
{
}
 ...
 *  </code>
 */
class Playmoviespartner_AccountsAvails_Resource extends Resource
{
   ...
   * field.
   * @return Playmoviespartner_ListAvailsResponse
   */
  public function listAccountsAvails($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Playmoviespartner_ListAvailsResponse");
  }
}
/**
 ...
 *  </code>
 */
class Playmoviespartner_AccountsExperienceLocales_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Playmoviespartner_ExperienceLocale
   */
  public function get($accountId, $elId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'elId' => $elId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Playmoviespartner_ExperienceLocale");
  }
   ...
   * @return Playmoviespartner_ListExperienceLocalesResponse
   */
  public function listAccountsExperienceLocales($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Playmoviespartner_ListExperienceLocalesResponse");
  }
}
/**
 ...
 *  </code>
 */
class Playmoviespartner_AccountsOrders_Resource extends Resource
{
   ...
   * @return Playmoviespartner_ListOrdersResponse
   */
  public function listAccountsOrders($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Playmoviespartner_ListOrdersResponse");
  }
}
/**
 ...
 *  </code>
 */
class Playmoviespartner_AccountsStoreInfos_Resource extends Resource
{
   ...
   * `video_id`s.
   * @return Playmoviespartner_ListStoreInfosResponse
   */
  public function listAccountsStoreInfos($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Playmoviespartner_ListStoreInfosResponse");
  }
}
 ...
 *  </code>
 */
class Playmoviespartner_AccountsStoreInfosCountry_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Playmoviespartner_StoreInfo
   */
  public function get($accountId, $videoId, $country, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Playmoviespartner_StoreInfo");
  }
}
...
class Playmoviespartner_Avail extends Collection
{
...
class Playmoviespartner_ExperienceLocale extends Collection
{
  protected $collection_key = 'pphNames';
  protected $internal_gapi_mappings = array(
  );
...
class Playmoviespartner_ListAvailsResponse extends Collection
{
  protected $collection_key = 'avails';
  protected $internal_gapi_mappings = array(
  );
  protected $availsType = 'Playmoviespartner_Avail';
...
class Playmoviespartner_ListExperienceLocalesResponse extends Collection
{
  protected $collection_key = 'experienceLocales';
  protected $internal_gapi_mappings = array(
  );
  protected $experienceLocalesType = 'Playmoviespartner_ExperienceLocale';
...
class Playmoviespartner_ListOrdersResponse extends Collection
{
  protected $collection_key = 'orders';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $ordersType = 'Playmoviespartner_Order';
...
class Playmoviespartner_ListStoreInfosResponse extends Collection
{
  protected $collection_key = 'storeInfos';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $storeInfosType = 'Playmoviespartner_StoreInfo';
...
class Playmoviespartner_Order extends Collection
{
...
class Playmoviespartner_StoreInfo extends Collection
{

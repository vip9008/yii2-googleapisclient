...
class Prediction extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->hostedmodels = new Prediction_Hostedmodels_Resource(
        $this,
        $this->serviceName,
        'hostedmodels',
        array(
    ...
    $this->trainedmodels = new Prediction_Trainedmodels_Resource(
        $this,
        $this->serviceName,
        'trainedmodels',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $predictionService = new Prediction(...);
 *   $hostedmodels = $predictionService->hostedmodels;
 *  </code>
 */
class Prediction_Hostedmodels_Resource extends Resource
{
   ...
   */
  public function predict($project, $hostedModelName, Prediction_Input $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'hostedModelName' => $hostedModelName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('predict', array($params), "Prediction_Output");
  }
}
 ...
 *  </code>
 */
class Prediction_Trainedmodels_Resource extends Resource
{
   ...
   * @param string $id The unique name for the predictive model.
   * @param array $optParams Optional parameters.
   * @return Prediction_Insert2
   */
  public function get($project, $id, $optParams = array())
  {
    $params = array('project' => $project, 'id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Prediction_Insert2");
  }
   ...
   * @return Prediction_Insert2
   */
  public function insert($project, Prediction_Insert $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Prediction_Insert2");
  }
   ...
   * @return Prediction_PredictionList
   */
  public function listTrainedmodels($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Prediction_PredictionList");
  }
   ...
   * @return Prediction_Output
   */
  public function predict($project, $id, Prediction_Input $postBody, $optParams = array())
  {
   ...
   * @return Prediction_Insert2
   */
  public function update($project, $id, Prediction_Update $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Prediction_Insert2");
  }
}
...
class Prediction_Analyze extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $dataDescriptionType = 'Prediction_AnalyzeDataDescription';
  protected $dataDescriptionDataType = '';
  public $errors;
  public $id;
  public $kind;
  protected $modelDescriptionType = 'Prediction_AnalyzeModelDescription';
  protected $modelDescriptionDataType = '';
  public $selfLink;


  public function setDataDescription(Prediction_AnalyzeDataDescription $dataDescription)
  {
  ...
  public function setModelDescription(Prediction_AnalyzeModelDescription $modelDescription)
  {
...
class Prediction_AnalyzeDataDescription extends Collection
{
  protected $collection_key = 'features';
  protected $internal_gapi_mappings = array(
  );
  protected $featuresType = 'Prediction_AnalyzeDataDescriptionFeatures';
  protected $featuresDataType = 'array';
  protected $outputFeatureType = 'Prediction_AnalyzeDataDescriptionOutputFeature';
  ...
  public function setOutputFeature(Prediction_AnalyzeDataDescriptionOutputFeature $outputFeature)
  {
...
class Prediction_AnalyzeDataDescriptionFeatures extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $categoricalType = 'Prediction_AnalyzeDataDescriptionFeaturesCategorical';
  protected $categoricalDataType = '';
  public $index;
  protected $numericType = 'Prediction_AnalyzeDataDescriptionFeaturesNumeric';
  protected $numericDataType = '';
  protected $textType = 'Prediction_AnalyzeDataDescriptionFeaturesText';
  protected $textDataType = '';


  public function setCategorical(Prediction_AnalyzeDataDescriptionFeaturesCategorical $categorical)
  {
  ...
  public function setNumeric(Prediction_AnalyzeDataDescriptionFeaturesNumeric $numeric)
  {
  ...
  public function setText(Prediction_AnalyzeDataDescriptionFeaturesText $text)
  {
    $this->text = $text;
  }
...
class Prediction_AnalyzeDataDescriptionFeaturesCategorical extends Collection
{
  protected $collection_key = 'values';
  protected $internal_gapi_mappings = array(
  );
  public $count;
  protected $valuesType = 'Prediction_AnalyzeDataDescriptionFeaturesCategoricalValues';
...
class Prediction_AnalyzeDataDescriptionFeaturesCategoricalValues extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Prediction_AnalyzeDataDescriptionFeaturesNumeric extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Prediction_AnalyzeDataDescriptionFeaturesText extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Prediction_AnalyzeDataDescriptionOutputFeature extends Collection
{
  protected $collection_key = 'text';
  protected $internal_gapi_mappings = array(
  );
  protected $numericType = 'Prediction_AnalyzeDataDescriptionOutputFeatureNumeric';
  protected $numericDataType = '';
  protected $textType = 'Prediction_AnalyzeDataDescriptionOutputFeatureText';
  protected $textDataType = 'array';


  public function setNumeric(Prediction_AnalyzeDataDescriptionOutputFeatureNumeric $numeric)
  {
    $this->numeric = $numeric;
  }
  public function getNumeric()
...
class Prediction_AnalyzeDataDescriptionOutputFeatureNumeric extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Prediction_AnalyzeDataDescriptionOutputFeatureText extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Prediction_AnalyzeErrors extends Model
{
}

class Prediction_AnalyzeModelDescription extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $confusionMatrix;
  public $confusionMatrixRowTotals;
  protected $modelinfoType = 'Prediction_Insert2';
  ...
  public function setModelinfo(Prediction_Insert2 $modelinfo)
  {
...
class Prediction_AnalyzeModelDescriptionConfusionMatrix extends Model
{
}

class Prediction_AnalyzeModelDescriptionConfusionMatrixElement extends Model
{
}

class Prediction_AnalyzeModelDescriptionConfusionMatrixRowTotals extends Model
{
}

class Prediction_Input extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $inputType = 'Prediction_InputInput';
  protected $inputDataType = '';


  public function setInput(Prediction_InputInput $input)
  {
    $this->input = $input;
  }
...
class Prediction_InputInput extends Collection
{
...
class Prediction_Insert extends Collection
{
  ...
  protected $trainingInstancesType = 'Prediction_InsertTrainingInstances';
...
class Prediction_Insert2 extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $created;
  public $id;
  public $kind;
  protected $modelInfoType = 'Prediction_Insert2ModelInfo';
  protected $modelInfoDataType = '';
  public $modelType;
  public $selfLink;
  public $storageDataLocation;
  ...
  public function setModelInfo(Prediction_Insert2ModelInfo $modelInfo)
  {
    $this->modelInfo = $modelInfo;
  }
  public function getModelInfo()
...
class Prediction_Insert2ModelInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Prediction_InsertTrainingInstances extends Collection
{
  protected $collection_key = 'csvInstance';
  protected $internal_gapi_mappings = array(
  );
...
class Prediction_InsertUtility extends Model
{
}

class Prediction_Output extends Collection
{
  ...
  public $kind;
  public $outputLabel;
  protected $outputMultiType = 'Prediction_OutputOutputMulti';
...
class Prediction_OutputOutputMulti extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $label;
...
class Prediction_PredictionList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Prediction_Insert2';
...
class Prediction_Update extends Collection
{
  protected $collection_key = 'csvInstance';
  protected $internal_gapi_mappings = array(
  );

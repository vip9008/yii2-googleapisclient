 ...
 * @author Google, Inc.
 */
class Proximitybeacon extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->beaconinfo = new Proximitybeacon_Beaconinfo_Resource(
        $this,
        $this->serviceName,
        'beaconinfo',
        array(
    ...
    $this->beacons = new Proximitybeacon_Beacons_Resource(
        $this,
        $this->serviceName,
        'beacons',
        array(
    ...
    $this->beacons_attachments = new Proximitybeacon_BeaconsAttachments_Resource(
        $this,
        $this->serviceName,
        'attachments',
        array(
    ...
    $this->beacons_diagnostics = new Proximitybeacon_BeaconsDiagnostics_Resource(
        $this,
        $this->serviceName,
        'diagnostics',
        array(
    ...
    $this->namespaces = new Proximitybeacon_Namespaces_Resource(
        $this,
        $this->serviceName,
        'namespaces',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $proximitybeaconService = new Proximitybeacon(...);
 *   $beaconinfo = $proximitybeaconService->beaconinfo;
 *  </code>
 */
class Proximitybeacon_Beaconinfo_Resource extends Resource
{
   ...
   * @return Proximitybeacon_GetInfoForObservedBeaconsResponse
   */
  public function getforobserved(Proximitybeacon_GetInfoForObservedBeaconsRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('getforobserved', array($params), "Proximitybeacon_GetInfoForObservedBeaconsResponse");
  }
}
 ...
 *  </code>
 */
class Proximitybeacon_Beacons_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Proximitybeacon_Empty
   */
  public function activate($beaconName, $optParams = array())
  {
    $params = array('beaconName' => $beaconName);
    $params = array_merge($params, $optParams);
    return $this->call('activate', array($params), "Proximitybeacon_Empty");
  }
  ...
  public function deactivate($beaconName, $optParams = array())
  {
    $params = array('beaconName' => $beaconName);
    $params = array_merge($params, $optParams);
    return $this->call('deactivate', array($params), "Proximitybeacon_Empty");
  }
  ...
  public function decommission($beaconName, $optParams = array())
  {
    $params = array('beaconName' => $beaconName);
    $params = array_merge($params, $optParams);
    return $this->call('decommission', array($params), "Proximitybeacon_Empty");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Proximitybeacon_Beacon
   */
  public function get($beaconName, $optParams = array())
  {
    $params = array('beaconName' => $beaconName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Proximitybeacon_Beacon");
  }
   ...
   * @return Proximitybeacon_ListBeaconsResponse
   */
  public function listBeacons($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Proximitybeacon_ListBeaconsResponse");
  }
   ...
   * @return Proximitybeacon_Beacon
   */
  public function register(Proximitybeacon_Beacon $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('register', array($params), "Proximitybeacon_Beacon");
  }
   ...
   * @return Proximitybeacon_Beacon
   */
  public function update($beaconName, Proximitybeacon_Beacon $postBody, $optParams = array())
  {
    $params = array('beaconName' => $beaconName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Proximitybeacon_Beacon");
  }
}
 ...
 *  </code>
 */
class Proximitybeacon_BeaconsAttachments_Resource extends Resource
{
   ...
   * @return Proximitybeacon_DeleteAttachmentsResponse
   */
  public function batchDelete($beaconName, $optParams = array())
  {
    $params = array('beaconName' => $beaconName);
    $params = array_merge($params, $optParams);
    return $this->call('batchDelete', array($params), "Proximitybeacon_DeleteAttachmentsResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Proximitybeacon_BeaconAttachment
   */
  public function create($beaconName, Proximitybeacon_BeaconAttachment $postBody, $optParams = array())
  {
    $params = array('beaconName' => $beaconName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Proximitybeacon_BeaconAttachment");
  }
  ...
  public function delete($attachmentName, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Proximitybeacon_Empty");
  }
   ...
   * @return Proximitybeacon_ListBeaconAttachmentsResponse
   */
  public function listBeaconsAttachments($beaconName, $optParams = array())
  {
    $params = array('beaconName' => $beaconName);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Proximitybeacon_ListBeaconAttachmentsResponse");
  }
}
/**
 ...
 *  </code>
 */
class Proximitybeacon_BeaconsDiagnostics_Resource extends Resource
{
   ...
   * @return Proximitybeacon_ListDiagnosticsResponse
   */
  public function listBeaconsDiagnostics($beaconName, $optParams = array())
  {
    $params = array('beaconName' => $beaconName);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Proximitybeacon_ListDiagnosticsResponse");
  }
}
 ...
 *  </code>
 */
class Proximitybeacon_Namespaces_Resource extends Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Proximitybeacon_ListNamespacesResponse
   */
  public function listNamespaces($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Proximitybeacon_ListNamespacesResponse");
  }
}
...
class Proximitybeacon_AdvertisedId extends Model
{
...
class Proximitybeacon_AttachmentInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $data;
...
class Proximitybeacon_Beacon extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $advertisedIdType = 'Proximitybeacon_AdvertisedId';
  protected $advertisedIdDataType = '';
  public $beaconName;
  public $description;
  public $expectedStability;
  protected $indoorLevelType = 'Proximitybeacon_IndoorLevel';
  protected $indoorLevelDataType = '';
  protected $latLngType = 'Proximitybeacon_LatLng';
  ...
  public function setAdvertisedId(Proximitybeacon_AdvertisedId $advertisedId)
  {
  ...
  public function setIndoorLevel(Proximitybeacon_IndoorLevel $indoorLevel)
  {
  ...
  public function setLatLng(Proximitybeacon_LatLng $latLng)
  {
    $this->latLng = $latLng;
  }
...
class Proximitybeacon_BeaconAttachment extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Proximitybeacon_BeaconInfo extends Collection
{
  ...
  protected $advertisedIdType = 'Proximitybeacon_AdvertisedId';
  protected $advertisedIdDataType = '';
  protected $attachmentsType = 'Proximitybeacon_AttachmentInfo';
...
class Proximitybeacon_BeaconProperties extends Model
{
}

class Proximitybeacon_Date extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $day;
...
class Proximitybeacon_DeleteAttachmentsResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $numDeleted;
...
class Proximitybeacon_Diagnostics extends Collection
{
  ...
  public $alerts;
  public $beaconName;
  protected $estimatedLowBatteryDateType = 'Proximitybeacon_Date';
  ...
  public function setEstimatedLowBatteryDate(Proximitybeacon_Date $estimatedLowBatteryDate)
  {
...
class Proximitybeacon_Empty extends Model
{
}

class Proximitybeacon_GetInfoForObservedBeaconsRequest extends Collection
{
  protected $collection_key = 'observations';
  protected $internal_gapi_mappings = array(
  );
  public $namespacedTypes;
  protected $observationsType = 'Proximitybeacon_Observation';
...
class Proximitybeacon_GetInfoForObservedBeaconsResponse extends Collection
{
  protected $collection_key = 'beacons';
  protected $internal_gapi_mappings = array(
  );
  protected $beaconsType = 'Proximitybeacon_BeaconInfo';
...
class Proximitybeacon_IndoorLevel extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class Proximitybeacon_LatLng extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $latitude;
...
class Proximitybeacon_ListBeaconAttachmentsResponse extends Collection
{
  protected $collection_key = 'attachments';
  protected $internal_gapi_mappings = array(
  );
  protected $attachmentsType = 'Proximitybeacon_BeaconAttachment';
  protected $attachmentsDataType = 'array';
...
class Proximitybeacon_ListBeaconsResponse extends Collection
{
  protected $collection_key = 'beacons';
  protected $internal_gapi_mappings = array(
  );
  protected $beaconsType = 'Proximitybeacon_Beacon';
  protected $beaconsDataType = 'array';
...
class Proximitybeacon_ListDiagnosticsResponse extends Collection
{
  protected $collection_key = 'diagnostics';
  protected $internal_gapi_mappings = array(
  );
  protected $diagnosticsType = 'Proximitybeacon_Diagnostics';
...
class Proximitybeacon_ListNamespacesResponse extends Collection
{
  protected $collection_key = 'namespaces';
  protected $internal_gapi_mappings = array(
  );
  protected $namespacesType = 'Proximitybeacon_ProximitybeaconNamespace';
...
class Proximitybeacon_Observation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $advertisedIdType = 'Proximitybeacon_AdvertisedId';
...
class Proximitybeacon_ProximitybeaconNamespace extends Model
{
  protected $internal_gapi_mappings = array(
  );

...
class Pubsub extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->subscriptions = new Pubsub_Subscriptions_Resource(
        $this,
        $this->serviceName,
        'subscriptions',
        array(
    ...
    $this->topics = new Pubsub_Topics_Resource(
        $this,
        $this->serviceName,
        'topics',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $pubsubService = new Pubsub(...);
 *   $subscriptions = $pubsubService->subscriptions;
 *  </code>
 */
class Pubsub_Subscriptions_Resource extends Resource
{
   ...
   */
  public function acknowledge(Pubsub_AcknowledgeRequest $postBody, $optParams = array())
  {
   ...
   */
  public function create(Pubsub_Subscription $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Pubsub_Subscription");
  }
  ...
  public function get($subscription, $optParams = array())
  {
    $params = array('subscription' => $subscription);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Pubsub_Subscription");
  }
   ...
   * @return Pubsub_ListSubscriptionsResponse
   */
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Pubsub_ListSubscriptionsResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   */
  public function modifyAckDeadline(Pubsub_ModifyAckDeadlineRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @param array $optParams Optional parameters.
   */
  public function modifyPushConfig(Pubsub_ModifyPushConfigRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @param array $optParams Optional parameters.
   * @return Pubsub_PullResponse
   */
  public function pull(Pubsub_PullRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('pull', array($params), "Pubsub_PullResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Pubsub_PullBatchResponse
   */
  public function pullBatch(Pubsub_PullBatchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('pullBatch', array($params), "Pubsub_PullBatchResponse");
  }
}
 ...
 *  </code>
 */
class Pubsub_Topics_Resource extends Resource
{
   ...
   * @return Pubsub_Topic
   */
  public function create(Pubsub_Topic $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Pubsub_Topic");
  }
  ...
  public function get($topic, $optParams = array())
  {
    $params = array('topic' => $topic);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Pubsub_Topic");
  }
   ...
   * @opt_param string query A valid label query expression.
   * @return Pubsub_ListTopicsResponse
   */
  public function listTopics($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Pubsub_ListTopicsResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   */
  public function publish(Pubsub_PublishRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @param array $optParams Optional parameters.
   * @return Pubsub_PublishBatchResponse
   */
  public function publishBatch(Pubsub_PublishBatchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('publishBatch', array($params), "Pubsub_PublishBatchResponse");
  }
}
...
class Pubsub_AcknowledgeRequest extends Collection
{
...
class Pubsub_Label extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class Pubsub_ListSubscriptionsResponse extends Collection
{
  protected $collection_key = 'subscription';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $subscriptionType = 'Pubsub_Subscription';
...
class Pubsub_ListTopicsResponse extends Collection
{
  protected $collection_key = 'topic';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $topicType = 'Pubsub_Topic';
...
class Pubsub_ModifyAckDeadlineRequest extends Collection
{
...
class Pubsub_ModifyPushConfigRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $pushConfigType = 'Pubsub_PushConfig';
  protected $pushConfigDataType = '';
  public $subscription;


  public function setPushConfig(Pubsub_PushConfig $pushConfig)
  {
...
class Pubsub_PublishBatchRequest extends Collection
{
  protected $collection_key = 'messages';
  protected $internal_gapi_mappings = array(
  );
  protected $messagesType = 'Pubsub_PubsubMessage';
...
class Pubsub_PublishBatchResponse extends Collection
{
...
class Pubsub_PublishRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $messageType = 'Pubsub_PubsubMessage';
  protected $messageDataType = '';
  public $topic;


  public function setMessage(Pubsub_PubsubMessage $message)
  {
...
class Pubsub_PubsubEvent extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $deleted;
...
class Pubsub_PubsubMessage extends Collection
{
  protected $collection_key = 'label';
  protected $internal_gapi_mappings = array(
  );
  public $data;
  protected $labelType = 'Pubsub_Label';
...
class Pubsub_PullBatchRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $maxEvents;
...
class Pubsub_PullBatchResponse extends Collection
{
  protected $collection_key = 'pullResponses';
  protected $internal_gapi_mappings = array(
  );
  protected $pullResponsesType = 'Pubsub_PullResponse';
...
class Pubsub_PullRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $returnImmediately;
...
class Pubsub_PullResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $ackId;
  protected $pubsubEventType = 'Pubsub_PubsubEvent';
  ...
  public function setPubsubEvent(Pubsub_PubsubEvent $pubsubEvent)
  {
...
class Pubsub_PushConfig extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $pushEndpoint;
...
class Pubsub_Subscription extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $ackDeadlineSeconds;
...
class Pubsub_Topic extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;

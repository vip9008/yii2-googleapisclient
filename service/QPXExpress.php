 ...
 * @author Google, Inc.
 */
class QPXExpress extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->trips = new QPXExpress_Trips_Resource(
        $this,
        $this->serviceName,
        'trips',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $qpxExpressService = new QPXExpress(...);
 *   $trips = $qpxExpressService->trips;
 *  </code>
 */
class QPXExpress_Trips_Resource extends Resource
{
   ...
   * @return QPXExpress_TripsSearchResponse
   */
  public function search(QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "QPXExpress_TripsSearchResponse");
  }
}
...
class QPXExpress_AircraftData extends Model
{
...
class QPXExpress_AirportData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $city;
...
class QPXExpress_BagDescriptor extends Collection
{
...
class QPXExpress_CarrierData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class QPXExpress_CityData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class QPXExpress_Data extends Collection
{
  protected $collection_key = 'tax';
  protected $internal_gapi_mappings = array(
  );
  protected $aircraftType = 'QPXExpress_AircraftData';
  protected $aircraftDataType = 'array';
  protected $airportType = 'QPXExpress_AirportData';
  protected $airportDataType = 'array';
  protected $carrierType = 'QPXExpress_CarrierData';
  protected $carrierDataType = 'array';
  protected $cityType = 'QPXExpress_CityData';
  protected $cityDataType = 'array';
  public $kind;
  protected $taxType = 'QPXExpress_TaxData';
...
class QPXExpress_FareInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $basisCode;
...
class QPXExpress_FlightInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $carrier;
...
class QPXExpress_FreeBaggageAllowance extends Collection
{
  protected $collection_key = 'bagDescriptor';
  protected $internal_gapi_mappings = array(
  );
  protected $bagDescriptorType = 'QPXExpress_BagDescriptor';
...
class QPXExpress_LegInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $aircraft;
...
class QPXExpress_PassengerCounts extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $adultCount;
...
class QPXExpress_PricingInfo extends Collection
{
  protected $collection_key = 'tax';
  protected $internal_gapi_mappings = array(
  );
  public $baseFareTotal;
  protected $fareType = 'QPXExpress_FareInfo';
  protected $fareDataType = 'array';
  public $fareCalculation;
  public $kind;
  public $latestTicketingTime;
  protected $passengersType = 'QPXExpress_PassengerCounts';
  ...
  public $saleTaxTotal;
  public $saleTotal;
  protected $segmentPricingType = 'QPXExpress_SegmentPricing';
  protected $segmentPricingDataType = 'array';
  protected $taxType = 'QPXExpress_TaxInfo';
  protected $taxDataType = 'array';
  ...
  public function setPassengers(QPXExpress_PassengerCounts $passengers)
  {
...
class QPXExpress_SegmentInfo extends Collection
{
  ...
  public $connectionDuration;
  public $duration;
  protected $flightType = 'QPXExpress_FlightInfo';
  protected $flightDataType = '';
  public $id;
  public $kind;
  protected $legType = 'QPXExpress_LegInfo';
  ...
  public function setFlight(QPXExpress_FlightInfo $flight)
  {
    $this->flight = $flight;
  }
...
class QPXExpress_SegmentPricing extends Collection
{
  protected $collection_key = 'freeBaggageOption';
  protected $internal_gapi_mappings = array(
  );
  public $fareId;
  protected $freeBaggageOptionType = 'QPXExpress_FreeBaggageAllowance';
...
class QPXExpress_SliceInfo extends Collection
{
  ...
  public $duration;
  public $kind;
  protected $segmentType = 'QPXExpress_SegmentInfo';
...
class QPXExpress_SliceInput extends Collection
{
  ...
  protected $permittedDepartureTimeType = 'QPXExpress_TimeOfDayRange';
  ...
  public function setPermittedDepartureTime(QPXExpress_TimeOfDayRange $permittedDepartureTime)
  {
...
class QPXExpress_TaxData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class QPXExpress_TaxInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $chargeType;
...
class QPXExpress_TimeOfDayRange extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $earliestTime;
...
class QPXExpress_TripOption extends Collection
{
  ...
  public $id;
  public $kind;
  protected $pricingType = 'QPXExpress_PricingInfo';
  protected $pricingDataType = 'array';
  public $saleTotal;
  protected $sliceType = 'QPXExpress_SliceInfo';
...
class QPXExpress_TripOptionsRequest extends Collection
{
  protected $collection_key = 'slice';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $refundable;
  public $saleCountry;
  protected $sliceType = 'QPXExpress_SliceInput';
  protected $sliceDataType = 'array';
  public $solutions;
...
class QPXExpress_TripOptionsResponse extends Collection
{
  protected $collection_key = 'tripOption';
  protected $internal_gapi_mappings = array(
  );
  protected $dataType = 'QPXExpress_Data';
  protected $dataDataType = '';
  public $kind;
  public $requestId;
  protected $tripOptionType = 'QPXExpress_TripOption';
  protected $tripOptionDataType = 'array';


  public function setData(QPXExpress_Data $data)
  {
    $this->data = $data;
  }
...
class QPXExpress_TripsSearchRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $requestType = 'QPXExpress_TripOptionsRequest';
  protected $requestDataType = '';


  public function setRequest(QPXExpress_TripOptionsRequest $request)
  {
...
class QPXExpress_TripsSearchResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $tripsType = 'QPXExpress_TripOptionsResponse';
  ...
  public function setTrips(QPXExpress_TripOptionsResponse $trips)
  {
    $this->trips = $trips;
  }

 ...
 * @author Google, Inc.
 */
class Replicapool extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->instanceGroupManagers = new Replicapool_InstanceGroupManagers_Resource(
        $this,
        $this->serviceName,
    ...
    $this->zoneOperations = new Replicapool_ZoneOperations_Resource(
        $this,
        $this->serviceName,
        'zoneOperations',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $replicapoolService = new Replicapool(...);
 *   $instanceGroupManagers = $replicapoolService->instanceGroupManagers;
 *  </code>
 */
class Replicapool_InstanceGroupManagers_Resource extends Resource
{
   ...
   * @return Replicapool_Operation
   */
  public function abandonInstances($project, $zone, $instanceGroupManager, Replicapool_InstanceGroupManagersAbandonInstancesRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'instanceGroupManager' => $instanceGroupManager, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('abandonInstances', array($params), "Replicapool_Operation");
  }
  ...
  public function delete($project, $zone, $instanceGroupManager, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Replicapool_Operation");
  }
   ...
   * @return Replicapool_Operation
   */
  public function deleteInstances($project, $zone, $instanceGroupManager, Replicapool_InstanceGroupManagersDeleteInstancesRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'instanceGroupManager' => $instanceGroupManager, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('deleteInstances', array($params), "Replicapool_Operation");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Replicapool_InstanceGroupManager
   */
  public function get($project, $zone, $instanceGroupManager, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'instanceGroupManager' => $instanceGroupManager);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Replicapool_InstanceGroupManager");
  }
   ...
   * @return Replicapool_Operation
   */
  public function insert($project, $zone, $size, Replicapool_InstanceGroupManager $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'size' => $size, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Replicapool_Operation");
  }
   ...
   * @return Replicapool_InstanceGroupManagerList
   */
  public function listInstanceGroupManagers($project, $zone, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Replicapool_InstanceGroupManagerList");
  }
   ...
   * @return Replicapool_Operation
   */
  public function recreateInstances($project, $zone, $instanceGroupManager, Replicapool_InstanceGroupManagersRecreateInstancesRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'instanceGroupManager' => $instanceGroupManager, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('recreateInstances', array($params), "Replicapool_Operation");
  }
  ...
  public function resize($project, $zone, $instanceGroupManager, $size, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('resize', array($params), "Replicapool_Operation");
  }
   ...
   * @return Replicapool_Operation
   */
  public function setInstanceTemplate($project, $zone, $instanceGroupManager, Replicapool_InstanceGroupManagersSetInstanceTemplateRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'instanceGroupManager' => $instanceGroupManager, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setInstanceTemplate', array($params), "Replicapool_Operation");
  }
   ...
   * @return Replicapool_Operation
   */
  public function setTargetPools($project, $zone, $instanceGroupManager, Replicapool_InstanceGroupManagersSetTargetPoolsRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'instanceGroupManager' => $instanceGroupManager, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setTargetPools', array($params), "Replicapool_Operation");
  }
}
 ...
 *  </code>
 */
class Replicapool_ZoneOperations_Resource extends Resource
{
  ...
  public function get($project, $zone, $operation, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Replicapool_Operation");
  }
   ...
   * @opt_param string maxResults Optional. Maximum count of results to be
   * returned. Maximum value is 500 and default value is 500.
   * @return Replicapool_OperationList
   */
  public function listZoneOperations($project, $zone, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Replicapool_OperationList");
  }
}
...
class Replicapool_InstanceGroupManager extends Collection
{
  protected $collection_key = 'targetPools';
  protected $internal_gapi_mappings = array(
  );
  protected $autoHealingPoliciesType = 'Replicapool_ReplicaPoolAutoHealingPolicy';
...
class Replicapool_InstanceGroupManagerList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $itemsType = 'Replicapool_InstanceGroupManager';
...
class Replicapool_InstanceGroupManagersAbandonInstancesRequest extends Collection
{
...
class Replicapool_InstanceGroupManagersDeleteInstancesRequest extends Collection
{
  protected $collection_key = 'instances';
  protected $internal_gapi_mappings = array(
  );
...
class Replicapool_InstanceGroupManagersRecreateInstancesRequest extends Collection
{
  protected $collection_key = 'instances';
  protected $internal_gapi_mappings = array(
  );
...
class Replicapool_InstanceGroupManagersSetInstanceTemplateRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $instanceTemplate;
...
class Replicapool_InstanceGroupManagersSetTargetPoolsRequest extends Collection
{
  protected $collection_key = 'targetPools';
  protected $internal_gapi_mappings = array(
  );
...
class Replicapool_Operation extends Collection
{
  ...
  public $creationTimestamp;
  public $endTime;
  protected $errorType = 'Replicapool_OperationError';
  ...
  public $targetLink;
  public $user;
  protected $warningsType = 'Replicapool_OperationWarnings';
  ...
  public function setError(Replicapool_OperationError $error)
  {
    $this->error = $error;
  }
...
class Replicapool_OperationError extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'Replicapool_OperationErrorErrors';
...
class Replicapool_OperationErrorErrors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class Replicapool_OperationList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $itemsType = 'Replicapool_Operation';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $selfLink;
...
class Replicapool_OperationWarnings extends Collection
{
  protected $collection_key = 'data';
  protected $internal_gapi_mappings = array(
  );
  public $code;
  protected $dataType = 'Replicapool_OperationWarningsData';
...
class Replicapool_OperationWarningsData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class Replicapool_ReplicaPoolAutoHealingPolicy extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $actionType;

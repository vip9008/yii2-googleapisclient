 ...
 * @author Google, Inc.
 */
class Replicapoolupdater extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->rollingUpdates = new Replicapoolupdater_RollingUpdates_Resource(
        $this,
        $this->serviceName,
        'rollingUpdates',
        array(
    ...
    $this->zoneOperations = new Replicapoolupdater_ZoneOperations_Resource(
        $this,
        $this->serviceName,
        'zoneOperations',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $replicapoolupdaterService = new Replicapoolupdater(...);
 *   $rollingUpdates = $replicapoolupdaterService->rollingUpdates;
 *  </code>
 */
class Replicapoolupdater_RollingUpdates_Resource extends Resource
{
   ...
   * @return Replicapoolupdater_Operation
   */
  public function cancel($project, $zone, $rollingUpdate, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "Replicapoolupdater_Operation");
  }
   ...
   * @param string $rollingUpdate The name of the update.
   * @param array $optParams Optional parameters.
   * @return Replicapoolupdater_RollingUpdate
   */
  public function get($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Replicapoolupdater_RollingUpdate");
  }
   ...
   * @return Replicapoolupdater_Operation
   */
  public function insert($project, $zone, Replicapoolupdater_RollingUpdate $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Replicapoolupdater_Operation");
  }
   ...
   * @return Replicapoolupdater_RollingUpdateList
   */
  public function listRollingUpdates($project, $zone, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Replicapoolupdater_RollingUpdateList");
  }
   ...
   * @opt_param string pageToken Optional. Tag returned by a previous list request
   * truncated by maxResults. Used to continue a previous list request.
   * @return Replicapoolupdater_InstanceUpdateList
   */
  public function listInstanceUpdates($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('listInstanceUpdates', array($params), "Replicapoolupdater_InstanceUpdateList");
  }
  ...
  public function pause($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('pause', array($params), "Replicapoolupdater_Operation");
  }
  ...
  public function resume($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('resume', array($params), "Replicapoolupdater_Operation");
  }
  ...
  public function rollback($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('rollback', array($params), "Replicapoolupdater_Operation");
  }
}
 ...
 *  </code>
 */
class Replicapoolupdater_ZoneOperations_Resource extends Resource
{
  ...
  public function get($project, $zone, $operation, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Replicapoolupdater_Operation");
  }
   ...
   * @opt_param string maxResults Optional. Maximum count of results to be
   * returned. Maximum value is 500 and default value is 500.
   * @return Replicapoolupdater_OperationList
   */
  public function listZoneOperations($project, $zone, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Replicapoolupdater_OperationList");
  }
}
...
class Replicapoolupdater_InstanceUpdate extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $errorType = 'Replicapoolupdater_InstanceUpdateError';
  protected $errorDataType = '';
  public $instance;
  public $status;


  public function setError(Replicapoolupdater_InstanceUpdateError $error)
  {
    $this->error = $error;
  }
...
class Replicapoolupdater_InstanceUpdateError extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'Replicapoolupdater_InstanceUpdateErrorErrors';
...
class Replicapoolupdater_InstanceUpdateErrorErrors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class Replicapoolupdater_InstanceUpdateList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Replicapoolupdater_InstanceUpdate';
...
class Replicapoolupdater_Operation extends Collection
{
  ...
  public $endTime;
  protected $errorType = 'Replicapoolupdater_OperationError';
  protected $errorDataType = '';
  ...
  public $targetLink;
  public $user;
  protected $warningsType = 'Replicapoolupdater_OperationWarnings';
  ...
  public function setError(Replicapoolupdater_OperationError $error)
  {
    $this->error = $error;
  }
  public function getError()
...
class Replicapoolupdater_OperationError extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'Replicapoolupdater_OperationErrorErrors';
  protected $errorsDataType = 'array';
...
class Replicapoolupdater_OperationErrorErrors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class Replicapoolupdater_OperationList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $itemsType = 'Replicapoolupdater_Operation';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $selfLink;
...
class Replicapoolupdater_OperationWarnings extends Collection
{
  protected $collection_key = 'data';
  protected $internal_gapi_mappings = array(
  );
  public $code;
  protected $dataType = 'Replicapoolupdater_OperationWarningsData';
...
class Replicapoolupdater_OperationWarningsData extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class Replicapoolupdater_RollingUpdate extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $actionType;
  public $creationTimestamp;
  public $description;
  protected $errorType = 'Replicapoolupdater_RollingUpdateError';
  protected $errorDataType = '';
  public $id;
  ...
  protected $policyType = 'Replicapoolupdater_RollingUpdatePolicy';
  ...
  public function setError(Replicapoolupdater_RollingUpdateError $error)
  {
    $this->error = $error;
  }
  public function getError()
  ...
  public function setPolicy(Replicapoolupdater_RollingUpdatePolicy $policy)
  {
    $this->policy = $policy;
  }
...
class Replicapoolupdater_RollingUpdateError extends Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'Replicapoolupdater_RollingUpdateErrorErrors';
  protected $errorsDataType = 'array';
...
class Replicapoolupdater_RollingUpdateErrorErrors extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class Replicapoolupdater_RollingUpdateList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Replicapoolupdater_RollingUpdate';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $selfLink;
...
class Replicapoolupdater_RollingUpdatePolicy extends Model
{
  protected $internal_gapi_mappings = array(
  );

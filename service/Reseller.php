 ...
 * @author Google, Inc.
 */
class Reseller extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->customers = new Reseller_Customers_Resource(
        $this,
        $this->serviceName,
        'customers',
        array(
    ...
    $this->subscriptions = new Reseller_Subscriptions_Resource(
        $this,
        $this->serviceName,
        'subscriptions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $resellerService = new Reseller(...);
 *   $customers = $resellerService->customers;
 *  </code>
 */
class Reseller_Customers_Resource extends Resource
{
  ...
  public function get($customerId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Reseller_Customer");
  }
   ...
   * @return Reseller_Customer
   */
  public function insert(Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Reseller_Customer");
  }
   ...
   * @return Reseller_Customer
   */
  public function patch($customerId, Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Reseller_Customer");
  }
   ...
   * @return Reseller_Customer
   */
  public function update($customerId, Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Reseller_Customer");
  }
}
 ...
 *  </code>
 */
class Reseller_Subscriptions_Resource extends Resource
{
  ...
  public function activate($customerId, $subscriptionId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('activate', array($params), "Reseller_Subscription");
  }
   ...
   * @return Reseller_Subscription
   */
  public function changePlan($customerId, $subscriptionId, Reseller_ChangePlanRequest $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changePlan', array($params), "Reseller_Subscription");
  }
   ...
   * @return Reseller_Subscription
   */
  public function changeRenewalSettings($customerId, $subscriptionId, Reseller_RenewalSettings $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeRenewalSettings', array($params), "Reseller_Subscription");
  }
   ...
   * @return Reseller_Subscription
   */
  public function changeSeats($customerId, $subscriptionId, Reseller_Seats $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeSeats', array($params), "Reseller_Subscription");
  }
  ...
  public function get($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Reseller_Subscription");
  }
   ...
   * @return Reseller_Subscription
   */
  public function insert($customerId, Reseller_Subscription $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Reseller_Subscription");
  }
  ...
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Reseller_Subscriptions");
  }
  ...
  public function startPaidService($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('startPaidService', array($params), "Reseller_Subscription");
  }
  ...
  public function suspend($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('suspend', array($params), "Reseller_Subscription");
  }
}
...
class Reseller_Address extends Model
{
...
class Reseller_ChangePlanRequest extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  ...
  protected $seatsType = 'Reseller_Seats';
  ...
  public function setSeats(Reseller_Seats $seats)
  {
    $this->seats = $seats;
  }
...
class Reseller_Customer extends Model
{
  protected $internal_gapi_mappings = array(
  );
  ...
  public $kind;
  public $phoneNumber;
  protected $postalAddressType = 'Reseller_Address';
  ...
  public function setPostalAddress(Reseller_Address $postalAddress)
  {
...
class Reseller_RenewalSettings extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Reseller_Seats extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Reseller_Subscription extends Collection
{
  ...
  public $customerId;
  public $kind;
  protected $planType = 'Reseller_SubscriptionPlan';
  protected $planDataType = '';
  public $purchaseOrderId;
  protected $renewalSettingsType = 'Reseller_RenewalSettings';
  ...
  protected $transferInfoType = 'Reseller_SubscriptionTransferInfo';
  protected $transferInfoDataType = '';
  protected $trialSettingsType = 'Reseller_SubscriptionTrialSettings';
  ...
  public function setPlan(Reseller_SubscriptionPlan $plan)
  {
    $this->plan = $plan;
  }
  ...
  public function setRenewalSettings(Reseller_RenewalSettings $renewalSettings)
  {
  ...
  public function setTransferInfo(Reseller_SubscriptionTransferInfo $transferInfo)
  {
  ...
  public function setTrialSettings(Reseller_SubscriptionTrialSettings $trialSettings)
  {
...
class Reseller_SubscriptionPlan extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $commitmentIntervalType = 'Reseller_SubscriptionPlanCommitmentInterval';
  protected $commitmentIntervalDataType = '';
  public $isCommitmentPlan;
  public $planName;


  public function setCommitmentInterval(Reseller_SubscriptionPlanCommitmentInterval $commitmentInterval)
  {
...
class Reseller_SubscriptionPlanCommitmentInterval extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTime;
...
class Reseller_SubscriptionTransferInfo extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Reseller_SubscriptionTrialSettings extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $isInTrial;
...
class Reseller_Subscriptions extends Collection
{
  ...
  protected $subscriptionsType = 'Reseller_Subscription';

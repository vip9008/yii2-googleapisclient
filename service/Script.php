...
class Script extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->scripts = new Script_Scripts_Resource(
        $this,
        $this->serviceName,
        'scripts',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $scriptService = new Script(...);
 *   $scripts = $scriptService->scripts;
 *  </code>
 */
class Script_Scripts_Resource extends Resource
{
   ...
   */
  public function run($scriptId, Script_ExecutionRequest $postBody, $optParams = array())
  {
    $params = array('scriptId' => $scriptId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('run', array($params), "Script_Operation");
  }
}
...
class Script_ExecutionError extends Collection
{
  ...
  public $errorMessage;
  public $errorType;
  protected $scriptStackTraceElementsType = 'Script_ScriptStackTraceElement';
...
class Script_ExecutionRequest extends Collection
{
...
class Script_ExecutionResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $result;
...
class Script_Operation extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $done;
  protected $errorType = 'Script_Status';
  ...
  public function setError(Script_Status $error)
  {
    $this->error = $error;
  }
...
class Script_OperationMetadata extends Model
{
}

class Script_OperationResponse extends Model
{
}

class Script_ScriptStackTraceElement extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $function;
...
class Script_Status extends Collection
{
...
class Script_StatusDetails extends Model
{
}

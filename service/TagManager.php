...
class TagManager extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->accounts = new TagManager_Accounts_Resource(
        $this,
        $this->serviceName,
        'accounts',
        array(
    ...
    $this->accounts_containers = new TagManager_AccountsContainers_Resource(
        $this,
        $this->serviceName,
        'containers',
        array(
    ...
    $this->accounts_containers_folders = new TagManager_AccountsContainersFolders_Resource(
        $this,
        $this->serviceName,
        'folders',
        array(
    ...
    $this->accounts_containers_folders_entities = new TagManager_AccountsContainersFoldersEntities_Resource(
        $this,
        $this->serviceName,
        'entities',
        array(
    ...
    $this->accounts_containers_move_folders = new TagManager_AccountsContainersMoveFolders_Resource(
        $this,
        $this->serviceName,
        'move_folders',
        array(
    ...
    $this->accounts_containers_tags = new TagManager_AccountsContainersTags_Resource(
        $this,
        $this->serviceName,
        'tags',
        array(
    ...
    $this->accounts_containers_triggers = new TagManager_AccountsContainersTriggers_Resource(
        $this,
        $this->serviceName,
        'triggers',
        array(
    ...
    $this->accounts_containers_variables = new TagManager_AccountsContainersVariables_Resource(
        $this,
        $this->serviceName,
        'variables',
        array(
    ...
    $this->accounts_containers_versions = new TagManager_AccountsContainersVersions_Resource(
        $this,
        $this->serviceName,
        'versions',
        array(
    ...
    $this->accounts_permissions = new TagManager_AccountsPermissions_Resource(
        $this,
        $this->serviceName,
        'permissions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $tagmanagerService = new TagManager(...);
 *   $accounts = $tagmanagerService->accounts;
 *  </code>
 */
class TagManager_Accounts_Resource extends Resource
{
   ...
   * @return TagManager_Account
   */
  public function get($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_Account");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return TagManager_ListAccountsResponse
   */
  public function listAccounts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListAccountsResponse");
  }
   ...
   * @return TagManager_Account
   */
  public function update($accountId, TagManager_Account $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_Account");
  }
}
 ...
 *  </code>
 */
class TagManager_AccountsContainers_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_Container
   */
  public function create($accountId, TagManager_Container $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "TagManager_Container");
  }
  ...
  public function get($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_Container");
  }
   ...
   * @param string $accountId The GTM Account ID.
   * @param array $optParams Optional parameters.
   * @return TagManager_ListContainersResponse
   */
  public function listAccountsContainers($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListContainersResponse");
  }
   ...
   * @return TagManager_Container
   */
  public function update($accountId, $containerId, TagManager_Container $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_Container");
  }
}
 ...
 *  </code>
 */
class TagManager_AccountsContainersFolders_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_Folder
   */
  public function create($accountId, $containerId, TagManager_Folder $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "TagManager_Folder");
  }
  ...
  public function get($accountId, $containerId, $folderId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'folderId' => $folderId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_Folder");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return TagManager_ListFoldersResponse
   */
  public function listAccountsContainersFolders($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListFoldersResponse");
  }
   ...
   * @return TagManager_Folder
   */
  public function update($accountId, $containerId, $folderId, TagManager_Folder $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'folderId' => $folderId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_Folder");
  }
}
 ...
 *  </code>
 */
class TagManager_AccountsContainersFoldersEntities_Resource extends Resource
{
 ...
 *  </code>
 */
class TagManager_AccountsContainersMoveFolders_Resource extends Resource
{
 ...
 *  </code>
 */
class TagManager_AccountsContainersTags_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_Tag
   */
  public function create($accountId, $containerId, TagManager_Tag $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "TagManager_Tag");
  }
  ...
  public function get($accountId, $containerId, $tagId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'tagId' => $tagId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_Tag");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return TagManager_ListTagsResponse
   */
  public function listAccountsContainersTags($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListTagsResponse");
  }
   ...
   * @return TagManager_Tag
   */
  public function update($accountId, $containerId, $tagId, TagManager_Tag $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'tagId' => $tagId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_Tag");
  }
}
/**
 ...
 *  </code>
 */
class TagManager_AccountsContainersTriggers_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_Trigger
   */
  public function create($accountId, $containerId, TagManager_Trigger $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "TagManager_Trigger");
  }
  ...
  public function get($accountId, $containerId, $triggerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'triggerId' => $triggerId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_Trigger");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return TagManager_ListTriggersResponse
   */
  public function listAccountsContainersTriggers($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListTriggersResponse");
  }
   ...
   * @return TagManager_Trigger
   */
  public function update($accountId, $containerId, $triggerId, TagManager_Trigger $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'triggerId' => $triggerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_Trigger");
  }
}
/**
 ...
 *  </code>
 */
class TagManager_AccountsContainersVariables_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_Variable
   */
  public function create($accountId, $containerId, TagManager_Variable $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "TagManager_Variable");
  }
  ...
  public function get($accountId, $containerId, $variableId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'variableId' => $variableId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_Variable");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return TagManager_ListVariablesResponse
   */
  public function listAccountsContainersVariables($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListVariablesResponse");
  }
   ...
   * @return TagManager_Variable
   */
  public function update($accountId, $containerId, $variableId, TagManager_Variable $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'variableId' => $variableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_Variable");
  }
}
/**
 ...
 *  </code>
 */
class TagManager_AccountsContainersVersions_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_CreateContainerVersionResponse
   */
  public function create($accountId, $containerId, TagManager_CreateContainerVersionRequestVersionOptions $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "TagManager_CreateContainerVersionResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_ContainerVersion
   */
  public function get($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_ContainerVersion");
  }
   ...
   * @return TagManager_ListContainerVersionsResponse
   */
  public function listAccountsContainersVersions($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListContainerVersionsResponse");
  }
   ...
   * @return TagManager_PublishContainerVersionResponse
   */
  public function publish($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('publish', array($params), "TagManager_PublishContainerVersionResponse");
  }
  ...
  public function restore($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('restore', array($params), "TagManager_ContainerVersion");
  }
  ...
  public function undelete($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('undelete', array($params), "TagManager_ContainerVersion");
  }
   ...
   * @return TagManager_ContainerVersion
   */
  public function update($accountId, $containerId, $containerVersionId, TagManager_ContainerVersion $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_ContainerVersion");
  }
}
/**
 ...
 *  </code>
 */
class TagManager_AccountsPermissions_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_UserAccess
   */
  public function create($accountId, TagManager_UserAccess $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "TagManager_UserAccess");
  }
  ...
  public function get($accountId, $permissionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'permissionId' => $permissionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "TagManager_UserAccess");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return TagManager_ListAccountUsersResponse
   */
  public function listAccountsPermissions($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "TagManager_ListAccountUsersResponse");
  }
   ...
   * @return TagManager_UserAccess
   */
  public function update($accountId, $permissionId, TagManager_UserAccess $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'permissionId' => $permissionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "TagManager_UserAccess");
  }
}
...
class TagManager_Account extends Model
{
...
class TagManager_AccountAccess extends Collection
{
...
class TagManager_Condition extends Collection
{
  protected $collection_key = 'parameter';
  protected $internal_gapi_mappings = array(
  );
  protected $parameterType = 'TagManager_Parameter';
...
class TagManager_Container extends Collection
{
...
class TagManager_ContainerAccess extends Collection
{
  protected $collection_key = 'permission';
  protected $internal_gapi_mappings = array(
  );
...
class TagManager_ContainerVersion extends Collection
{
  protected $collection_key = 'variable';
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
  protected $containerType = 'TagManager_Container';
  protected $containerDataType = '';
  public $containerId;
  public $containerVersionId;
  public $deleted;
  public $fingerprint;
  protected $folderType = 'TagManager_Folder';
  protected $folderDataType = 'array';
  protected $macroType = 'TagManager_Macro';
  protected $macroDataType = 'array';
  public $name;
  public $notes;
  protected $ruleType = 'TagManager_Rule';
  protected $ruleDataType = 'array';
  protected $tagType = 'TagManager_Tag';
  protected $tagDataType = 'array';
  protected $triggerType = 'TagManager_Trigger';
  protected $triggerDataType = 'array';
  protected $variableType = 'TagManager_Variable';
  ...
  public function setContainer(TagManager_Container $container)
  {
...
class TagManager_ContainerVersionHeader extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
...
class TagManager_CreateContainerVersionRequestVersionOptions extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class TagManager_CreateContainerVersionResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $compilerError;
  protected $containerVersionType = 'TagManager_ContainerVersion';
  ...
  public function setContainerVersion(TagManager_ContainerVersion $containerVersion)
  {
...
class TagManager_Folder extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
...
class TagManager_FolderEntities extends Collection
{
  protected $collection_key = 'variable';
  protected $internal_gapi_mappings = array(
  );
...
class TagManager_ListAccountUsersResponse extends Collection
{
  protected $collection_key = 'userAccess';
  protected $internal_gapi_mappings = array(
  );
  protected $userAccessType = 'TagManager_UserAccess';
...
class TagManager_ListAccountsResponse extends Collection
{
  protected $collection_key = 'accounts';
  protected $internal_gapi_mappings = array(
  );
  protected $accountsType = 'TagManager_Account';
...
class TagManager_ListContainerVersionsResponse extends Collection
{
  ...
  protected $containerVersionHeaderType = 'TagManager_ContainerVersionHeader';
...
class TagManager_ListContainersResponse extends Collection
{
  protected $collection_key = 'containers';
  protected $internal_gapi_mappings = array(
  );
  protected $containersType = 'TagManager_Container';
...
class TagManager_ListFoldersResponse extends Collection
{
  protected $collection_key = 'folders';
  protected $internal_gapi_mappings = array(
  );
  protected $foldersType = 'TagManager_Folder';
...
class TagManager_ListTagsResponse extends Collection
{
  protected $collection_key = 'tags';
  protected $internal_gapi_mappings = array(
  );
  protected $tagsType = 'TagManager_Tag';
...
class TagManager_ListTriggersResponse extends Collection
{
  protected $collection_key = 'triggers';
  protected $internal_gapi_mappings = array(
  );
  protected $triggersType = 'TagManager_Trigger';
...
class TagManager_ListVariablesResponse extends Collection
{
  protected $collection_key = 'variables';
  protected $internal_gapi_mappings = array(
  );
  protected $variablesType = 'TagManager_Variable';
...
class TagManager_Macro extends Collection
{
  protected $collection_key = 'parameter';
  protected $internal_gapi_mappings = array(
  );
...
class TagManager_Parameter extends Collection
{
  protected $collection_key = 'map';
  protected $internal_gapi_mappings = array(
  );
  public $key;
  protected $listType = 'TagManager_Parameter';
  protected $listDataType = 'array';
  protected $mapType = 'TagManager_Parameter';
...
class TagManager_PublishContainerVersionResponse extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $compilerError;
...
class TagManager_Rule extends Collection
{
  protected $collection_key = 'condition';
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
  protected $conditionType = 'TagManager_Condition';
...
class TagManager_SetupTag extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class TagManager_Tag extends Collection
{
  ...
  protected $parameterDataType = 'array';
  public $parentFolderId;
  protected $priorityType = 'TagManager_Parameter';
  protected $priorityDataType = '';
  public $scheduleEndMs;
  public $scheduleStartMs;
  protected $setupTagType = 'TagManager_SetupTag';
  protected $setupTagDataType = 'array';
  public $tagFiringOption;
  public $tagId;
  protected $teardownTagType = 'TagManager_TeardownTag';
  ...
  public function setPriority(TagManager_Parameter $priority)
  {
...
class TagManager_TeardownTag extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class TagManager_Trigger extends Collection
{
  protected $collection_key = 'filter';
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
  protected $autoEventFilterType = 'TagManager_Condition';
  protected $autoEventFilterDataType = 'array';
  protected $checkValidationType = 'TagManager_Parameter';
  protected $checkValidationDataType = '';
  public $containerId;
  protected $customEventFilterType = 'TagManager_Condition';
  protected $customEventFilterDataType = 'array';
  protected $enableAllVideosType = 'TagManager_Parameter';
  protected $enableAllVideosDataType = '';
  protected $eventNameType = 'TagManager_Parameter';
  protected $eventNameDataType = '';
  protected $filterType = 'TagManager_Condition';
  protected $filterDataType = 'array';
  public $fingerprint;
  protected $intervalType = 'TagManager_Parameter';
  protected $intervalDataType = '';
  protected $limitType = 'TagManager_Parameter';
  protected $limitDataType = '';
  public $name;
  public $parentFolderId;
  public $triggerId;
  public $type;
  protected $uniqueTriggerIdType = 'TagManager_Parameter';
  protected $uniqueTriggerIdDataType = '';
  protected $videoPercentageListType = 'TagManager_Parameter';
  protected $videoPercentageListDataType = '';
  protected $waitForTagsType = 'TagManager_Parameter';
  protected $waitForTagsDataType = '';
  protected $waitForTagsTimeoutType = 'TagManager_Parameter';
  ...
  public function setCheckValidation(TagManager_Parameter $checkValidation)
  {
  ...
  public function setEnableAllVideos(TagManager_Parameter $enableAllVideos)
  {
  ...
  public function setEventName(TagManager_Parameter $eventName)
  {
  ...
  public function setInterval(TagManager_Parameter $interval)
  {
  ...
  public function setLimit(TagManager_Parameter $limit)
  {
    $this->limit = $limit;
  }
  ...
  public function setUniqueTriggerId(TagManager_Parameter $uniqueTriggerId)
  {
  ...
  public function setVideoPercentageList(TagManager_Parameter $videoPercentageList)
  {
  ...
  public function setWaitForTags(TagManager_Parameter $waitForTags)
  {
  ...
  public function setWaitForTagsTimeout(TagManager_Parameter $waitForTagsTimeout)
  {
...
class TagManager_UserAccess extends Collection
{
  protected $collection_key = 'containerAccess';
  protected $internal_gapi_mappings = array(
  );
  protected $accountAccessType = 'TagManager_AccountAccess';
  protected $accountAccessDataType = '';
  public $accountId;
  protected $containerAccessType = 'TagManager_ContainerAccess';
  protected $containerAccessDataType = 'array';
  public $emailAddress;
  public $permissionId;


  public function setAccountAccess(TagManager_AccountAccess $accountAccess)
  {
...
class TagManager_Variable extends Collection
{
  protected $collection_key = 'parameter';
  protected $internal_gapi_mappings = array(
  );

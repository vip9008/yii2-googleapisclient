...
class Taskqueue extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->taskqueues = new Taskqueue_Taskqueues_Resource(
        $this,
        $this->serviceName,
        'taskqueues',
        array(
    ...
    $this->tasks = new Taskqueue_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $taskqueueService = new Taskqueue(...);
 *   $taskqueues = $taskqueueService->taskqueues;
 *  </code>
 */
class Taskqueue_Taskqueues_Resource extends Resource
{
  ...
  public function get($project, $taskqueue, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Taskqueue_TaskQueue");
  }
}
 ...
 *  </code>
 */
class Taskqueue_Tasks_Resource extends Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Taskqueue_Task
   */
  public function get($project, $taskqueue, $task, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Taskqueue_Task");
  }
   ...
   * @return Taskqueue_Task
   */
  public function insert($project, $taskqueue, Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Taskqueue_Task");
  }
  ...
  public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lease', array($params), "Taskqueue_Tasks");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Taskqueue_Tasks2
   */
  public function listTasks($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Taskqueue_Tasks2");
  }
   ...
   * @return Taskqueue_Task
   */
  public function patch($project, $taskqueue, $task, $newLeaseSeconds, Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Taskqueue_Task");
  }
   ...
   * @return Taskqueue_Task
   */
  public function update($project, $taskqueue, $task, $newLeaseSeconds, Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Taskqueue_Task");
  }
}
...
class Taskqueue_Task extends Model
{
...
class Taskqueue_TaskQueue extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $aclType = 'Taskqueue_TaskQueueAcl';
  protected $aclDataType = '';
  public $id;
  public $kind;
  public $maxLeases;
  protected $statsType = 'Taskqueue_TaskQueueStats';
  protected $statsDataType = '';


  public function setAcl(Taskqueue_TaskQueueAcl $acl)
  {
    $this->acl = $acl;
  }
  ...
  public function setStats(Taskqueue_TaskQueueStats $stats)
  {
    $this->stats = $stats;
  }
...
class Taskqueue_TaskQueueAcl extends Collection
{
...
class Taskqueue_TaskQueueStats extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Taskqueue_Tasks extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Taskqueue_Task';
...
class Taskqueue_Tasks2 extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );

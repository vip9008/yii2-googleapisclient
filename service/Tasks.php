...
class Tasks extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->tasklists = new Tasks_Tasklists_Resource(
        $this,
        $this->serviceName,
        'tasklists',
        array(
    ...
    $this->tasks = new Tasks_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 *  </code>
 */
class Tasks_Tasklists_Resource extends Resource
{
  ...
  public function get($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Tasks_TaskList");
  }
   ...
   * @return Tasks_TaskList
   */
  public function insert(Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Tasks_TaskList");
  }
   ...
   * @return Tasks_TaskLists
   */
  public function listTasklists($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Tasks_TaskLists");
  }
   ...
   * @return Tasks_TaskList
   */
  public function patch($tasklist, Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Tasks_TaskList");
  }
   ...
   * @return Tasks_TaskList
   */
  public function update($tasklist, Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Tasks_TaskList");
  }
}
 ...
 *  </code>
 */
class Tasks_Tasks_Resource extends Resource
{
  ...
  public function get($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Tasks_Task");
  }
   ...
   * @return Tasks_Task
   */
  public function insert($tasklist, Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Tasks_Task");
  }
  ...
  public function listTasks($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Tasks_Tasks");
  }
  ...
  public function move($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "Tasks_Task");
  }
   ...
   * @return Tasks_Task
   */
  public function patch($tasklist, $task, Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Tasks_Task");
  }
   ...
   * @return Tasks_Task
   */
  public function update($tasklist, $task, Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Tasks_Task");
  }
}
...
class Tasks_Task extends Collection
{
  ...
  public $id;
  public $kind;
  protected $linksType = 'Tasks_TaskLinks';
...
class Tasks_TaskLinks extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Tasks_TaskList extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class Tasks_TaskLists extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Tasks_TaskList';
...
class Tasks_Tasks extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Tasks_Task';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;

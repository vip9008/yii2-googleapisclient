...
class Translate extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->detections = new Translate_Detections_Resource(
        $this,
        $this->serviceName,
        'detections',
        array(
    ...
    $this->languages = new Translate_Languages_Resource(
        $this,
        $this->serviceName,
        'languages',
        array(
    ...
    $this->translations = new Translate_Translations_Resource(
        $this,
        $this->serviceName,
        'translations',
        array(
 ...
 *  </code>
 */
class Translate_Detections_Resource extends Resource
{
   ...
   * @return Translate_DetectionsListResponse
   */
  public function listDetections($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Translate_DetectionsListResponse");
  }
}
 ...
 *  </code>
 */
class Translate_Languages_Resource extends Resource
{
   ...
   * @return Translate_LanguagesListResponse
   */
  public function listLanguages($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Translate_LanguagesListResponse");
  }
}
 ...
 *  </code>
 */
class Translate_Translations_Resource extends Resource
{
   ...
   * @return Translate_TranslationsListResponse
   */
  public function listTranslations($q, $target, $optParams = array())
  {
    $params = array('q' => $q, 'target' => $target);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Translate_TranslationsListResponse");
  }
}
...
class Translate_DetectionsListResponse extends Collection
{
  protected $collection_key = 'detections';
  protected $internal_gapi_mappings = array(
  );
  protected $detectionsType = 'Translate_DetectionsResourceItems';
...
class Translate_DetectionsResourceItems extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $confidence;
...
class Translate_LanguagesListResponse extends Collection
{
  protected $collection_key = 'languages';
  protected $internal_gapi_mappings = array(
  );
  protected $languagesType = 'Translate_LanguagesResource';
...
class Translate_LanguagesResource extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $language;
...
class Translate_TranslationsListResponse extends Collection
{
  protected $collection_key = 'translations';
  protected $internal_gapi_mappings = array(
  );
  protected $translationsType = 'Translate_TranslationsResource';
...
class Translate_TranslationsResource extends Model
{
  protected $internal_gapi_mappings = array(
  );

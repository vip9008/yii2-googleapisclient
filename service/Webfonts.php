 ...
 * @author Google, Inc.
 */
class Webfonts extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->webfonts = new Webfonts_Webfonts_Resource(
        $this,
        $this->serviceName,
        'webfonts',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $webfontsService = new Webfonts(...);
 *   $webfonts = $webfontsService->webfonts;
 *  </code>
 */
class Webfonts_Webfonts_Resource extends Resource
{
   ...
   * @return Webfonts_WebfontList
   */
  public function listWebfonts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Webfonts_WebfontList");
  }
}
...
class Webfonts_Webfont extends Collection
{
...
class Webfonts_WebfontFiles extends Model
{
}

class Webfonts_WebfontList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Webfonts_Webfont';

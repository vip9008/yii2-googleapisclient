 ...
 * @author Google, Inc.
 */
class Webmasters extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->searchanalytics = new Webmasters_Searchanalytics_Resource(
        $this,
        $this->serviceName,
        'searchanalytics',
        array(
    ...
    $this->sitemaps = new Webmasters_Sitemaps_Resource(
        $this,
        $this->serviceName,
        'sitemaps',
        array(
    ...
    $this->sites = new Webmasters_Sites_Resource(
        $this,
        $this->serviceName,
        'sites',
        array(
    ...
    $this->urlcrawlerrorscounts = new Webmasters_Urlcrawlerrorscounts_Resource(
        $this,
        $this->serviceName,
    ...
    $this->urlcrawlerrorssamples = new Webmasters_Urlcrawlerrorssamples_Resource(
        $this,
        $this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $webmastersService = new Webmasters(...);
 *   $searchanalytics = $webmastersService->searchanalytics;
 *  </code>
 */
class Webmasters_Searchanalytics_Resource extends Resource
{
   ...
   * @return Webmasters_SearchAnalyticsQueryResponse
   */
  public function query($siteUrl, Webmasters_SearchAnalyticsQueryRequest $postBody, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Webmasters_SearchAnalyticsQueryResponse");
  }
}
 ...
 *  </code>
 */
class Webmasters_Sitemaps_Resource extends Resource
{
   ...
   * http://www.example.com/sitemap.xml
   * @param array $optParams Optional parameters.
   * @return Webmasters_WmxSitemap
   */
  public function get($siteUrl, $feedpath, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Webmasters_WmxSitemap");
  }
   ...
   * @return Webmasters_SitemapsListResponse
   */
  public function listSitemaps($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Webmasters_SitemapsListResponse");
  }
 ...
 *  </code>
 */
class Webmasters_Sites_Resource extends Resource
{
   ...
   * Examples: http://www.example.com/ or android-app://com.example/
   * @param array $optParams Optional parameters.
   * @return Webmasters_WmxSite
   */
  public function get($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Webmasters_WmxSite");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Webmasters_SitesListResponse
   */
  public function listSites($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Webmasters_SitesListResponse");
  }
}
 ...
 *  </code>
 */
class Webmasters_Urlcrawlerrorscounts_Resource extends Resource
{
   ...
   * counts.
   * @return Webmasters_UrlCrawlErrorsCountsQueryResponse
   */
  public function query($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Webmasters_UrlCrawlErrorsCountsQueryResponse");
  }
}
 ...
 *  </code>
 */
class Webmasters_Urlcrawlerrorssamples_Resource extends Resource
{
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return Webmasters_UrlCrawlErrorsSample
   */
  public function get($siteUrl, $url, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Webmasters_UrlCrawlErrorsSample");
  }
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return Webmasters_UrlCrawlErrorsSamplesListResponse
   */
  public function listUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Webmasters_UrlCrawlErrorsSamplesListResponse");
  }
...
class Webmasters_ApiDataRow extends Collection
{
...
class Webmasters_ApiDimensionFilter extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dimension;
...
class Webmasters_ApiDimensionFilterGroup extends Collection
{
  protected $collection_key = 'filters';
  protected $internal_gapi_mappings = array(
  );
  protected $filtersType = 'Webmasters_ApiDimensionFilter';
...
class Webmasters_SearchAnalyticsQueryRequest extends Collection
{
  protected $collection_key = 'dimensions';
  protected $internal_gapi_mappings = array(
  );
  public $aggregationType;
  protected $dimensionFilterGroupsType = 'Webmasters_ApiDimensionFilterGroup';
...
class Webmasters_SearchAnalyticsQueryResponse extends Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
  public $responseAggregationType;
  protected $rowsType = 'Webmasters_ApiDataRow';
...
class Webmasters_SitemapsListResponse extends Collection
{
  protected $collection_key = 'sitemap';
  protected $internal_gapi_mappings = array(
  );
  protected $sitemapType = 'Webmasters_WmxSitemap';
...
class Webmasters_SitesListResponse extends Collection
{
  protected $collection_key = 'siteEntry';
  protected $internal_gapi_mappings = array(
  );
  protected $siteEntryType = 'Webmasters_WmxSite';
...
class Webmasters_UrlCrawlErrorCount extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Webmasters_UrlCrawlErrorCountsPerType extends Collection
{
  protected $collection_key = 'entries';
  protected $internal_gapi_mappings = array(
  );
  public $category;
  protected $entriesType = 'Webmasters_UrlCrawlErrorCount';
...
class Webmasters_UrlCrawlErrorsCountsQueryResponse extends Collection
{
  protected $collection_key = 'countPerTypes';
  protected $internal_gapi_mappings = array(
  );
  protected $countPerTypesType = 'Webmasters_UrlCrawlErrorCountsPerType';
...
class Webmasters_UrlCrawlErrorsSample extends Model
{
  protected $internal_gapi_mappings = array(
  ...
  public $pageUrl;
  public $responseCode;
  protected $urlDetailsType = 'Webmasters_UrlSampleDetails';
  ...
  public function setUrlDetails(Webmasters_UrlSampleDetails $urlDetails)
  {
...
class Webmasters_UrlCrawlErrorsSamplesListResponse extends Collection
{
  protected $collection_key = 'urlCrawlErrorSample';
  protected $internal_gapi_mappings = array(
  );
  protected $urlCrawlErrorSampleType = 'Webmasters_UrlCrawlErrorsSample';
...
class Webmasters_UrlSampleDetails extends Collection
{
...
class Webmasters_WmxSite extends Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Webmasters_WmxSitemap extends Collection
{
  protected $collection_key = 'contents';
  protected $internal_gapi_mappings = array(
  );
  protected $contentsType = 'Webmasters_WmxSitemapContent';
...
class Webmasters_WmxSitemapContent extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $indexed;

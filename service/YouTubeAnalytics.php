 ...
 * @author Google, Inc.
 */
class YouTubeAnalytics extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->batchReportDefinitions = new YouTubeAnalytics_BatchReportDefinitions_Resource(
        $this,
        $this->serviceName,
    ...
    $this->batchReports = new YouTubeAnalytics_BatchReports_Resource(
        $this,
        $this->serviceName,
        'batchReports',
        array(
    ...
    $this->groupItems = new YouTubeAnalytics_GroupItems_Resource(
        $this,
        $this->serviceName,
        'groupItems',
        array(
    ...
    $this->groups = new YouTubeAnalytics_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
    ...
    $this->reports = new YouTubeAnalytics_Reports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $youtubeAnalyticsService = new YouTubeAnalytics(...);
 *   $batchReportDefinitions = $youtubeAnalyticsService->batchReportDefinitions;
 *  </code>
 */
class YouTubeAnalytics_BatchReportDefinitions_Resource extends Resource
{
   ...
   * @return YouTubeAnalytics_BatchReportDefinitionList
   */
  public function listBatchReportDefinitions($onBehalfOfContentOwner, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "YouTubeAnalytics_BatchReportDefinitionList");
  }
}
 ...
 *  </code>
 */
class YouTubeAnalytics_BatchReports_Resource extends Resource
{
   ...
   * identifies the content owner that the user is acting on behalf of.
   * @param array $optParams Optional parameters.
   * @return YouTubeAnalytics_BatchReportList
   */
  public function listBatchReports($batchReportDefinitionId, $onBehalfOfContentOwner, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "YouTubeAnalytics_BatchReportList");
  }
}
 ...
 *  </code>
 */
class YouTubeAnalytics_GroupItems_Resource extends Resource
{
   ...
   * the user authenticates with must be linked to the specified YouTube content
   * owner.
   * @return YouTubeAnalytics_GroupItem
   */
  public function insert(YouTubeAnalytics_GroupItem $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "YouTubeAnalytics_GroupItem");
  }
   ...
   * the user authenticates with must be linked to the specified YouTube content
   * owner.
   * @return YouTubeAnalytics_GroupItemListResponse
   */
  public function listGroupItems($groupId, $optParams = array())
  {
    $params = array('groupId' => $groupId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "YouTubeAnalytics_GroupItemListResponse");
  }
}
 ...
 *  </code>
 */
class YouTubeAnalytics_Groups_Resource extends Resource
{
   ...
   * the user authenticates with must be linked to the specified YouTube content
   * owner.
   * @return YouTubeAnalytics_Group
   */
  public function insert(YouTubeAnalytics_Group $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "YouTubeAnalytics_Group");
  }
   ...
   * @return YouTubeAnalytics_GroupListResponse
   */
  public function listGroups($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "YouTubeAnalytics_GroupListResponse");
  }
   ...
   * @return YouTubeAnalytics_Group
   */
  public function update(YouTubeAnalytics_Group $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "YouTubeAnalytics_Group");
  }
}
 ...
 *  </code>
 */
class YouTubeAnalytics_Reports_Resource extends Resource
{
   ...
   * @return YouTubeAnalytics_ResultTable
   */
  public function query($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "YouTubeAnalytics_ResultTable");
  }
}
...
class YouTubeAnalytics_BatchReport extends Collection
{
  ...
  public $id;
  public $kind;
  protected $outputsType = 'YouTubeAnalytics_BatchReportOutputs';
  protected $outputsDataType = 'array';
  public $reportId;
  protected $timeSpanType = 'YouTubeAnalytics_BatchReportTimeSpan';
  ...
  public function setTimeSpan(YouTubeAnalytics_BatchReportTimeSpan $timeSpan)
  {
...
class YouTubeAnalytics_BatchReportDefinition extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class YouTubeAnalytics_BatchReportDefinitionList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'YouTubeAnalytics_BatchReportDefinition';
...
class YouTubeAnalytics_BatchReportList extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'YouTubeAnalytics_BatchReport';
  protected $itemsDataType = 'array';
  public $kind;
...
class YouTubeAnalytics_BatchReportOutputs extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $downloadUrl;
...
class YouTubeAnalytics_BatchReportTimeSpan extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTime;
...
class YouTubeAnalytics_Group extends Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $contentDetailsType = 'YouTubeAnalytics_GroupContentDetails';
  protected $contentDetailsDataType = '';
  public $etag;
  public $id;
  public $kind;
  protected $snippetType = 'YouTubeAnalytics_GroupSnippet';
  protected $snippetDataType = '';


  public function setContentDetails(YouTubeAnalytics_GroupContentDetails $contentDetails)
  {
  ...
  public function setSnippet(YouTubeAnalytics_GroupSnippet $snippet)
  {
...
class YouTubeAnalytics_GroupContentDetails extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $itemCount;
...
class YouTubeAnalytics_GroupItem extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  ...
  public $id;
  public $kind;
  protected $resourceType = 'YouTubeAnalytics_GroupItemResource';
  ...
  public function setResource(YouTubeAnalytics_GroupItemResource $resource)
  {
...
class YouTubeAnalytics_GroupItemListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'YouTubeAnalytics_GroupItem';
  protected $itemsDataType = 'array';
  public $kind;
...
class YouTubeAnalytics_GroupItemResource extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class YouTubeAnalytics_GroupListResponse extends Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'YouTubeAnalytics_Group';
  protected $itemsDataType = 'array';
  public $kind;
...
class YouTubeAnalytics_GroupSnippet extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $publishedAt;
...
class YouTubeAnalytics_ResultTable extends Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
  protected $columnHeadersType = 'YouTubeAnalytics_ResultTableColumnHeaders';
...
class YouTubeAnalytics_ResultTableColumnHeaders extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $columnType;

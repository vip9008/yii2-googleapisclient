 ...
 * @author Google, Inc.
 */
class YouTubeReporting extends Service
{
  ...
  public function __construct(Client $client)
  {
    ...
    $this->jobs = new YouTubeReporting_Jobs_Resource(
        $this,
        $this->serviceName,
        'jobs',
        array(
    ...
    $this->jobs_reports = new YouTubeReporting_JobsReports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
    ...
    $this->media = new YouTubeReporting_Media_Resource(
        $this,
        $this->serviceName,
        'media',
        array(
    ...
    $this->reportTypes = new YouTubeReporting_ReportTypes_Resource(
        $this,
        $this->serviceName,
        'reportTypes',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $youtubereportingService = new YouTubeReporting(...);
 *   $jobs = $youtubereportingService->jobs;
 *  </code>
 */
class YouTubeReporting_Jobs_Resource extends Resource
{
   ...
   * @return YouTubeReporting_Job
   */
  public function create(YouTubeReporting_Job $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "YouTubeReporting_Job");
  }
   ...
   * which behalf the user is acting on. If not set, the user is acting for
   * himself (his own channel).
   * @return YouTubeReporting_Empty
   */
  public function delete($jobId, $optParams = array())
  {
    $params = array('jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "YouTubeReporting_Empty");
  }
  ...
  public function get($jobId, $optParams = array())
  {
    $params = array('jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "YouTubeReporting_Job");
  }
   ...
   * @return YouTubeReporting_ListJobsResponse
   */
  public function listJobs($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "YouTubeReporting_ListJobsResponse");
  }
}
 ...
 *  </code>
 */
class YouTubeReporting_JobsReports_Resource extends Resource
{
   ...
   * default.
   * @return YouTubeReporting_ListReportsResponse
   */
  public function listJobsReports($jobId, $optParams = array())
  {
    $params = array('jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "YouTubeReporting_ListReportsResponse");
  }
}
 ...
 *  </code>
 */
class YouTubeReporting_Media_Resource extends Resource
{
 ...
 *  </code>
 */
class YouTubeReporting_ReportTypes_Resource extends Resource
{
   ...
   * types than requested. If unspecified, server will pick an appropriate
   * default.
   * @return YouTubeReporting_ListReportTypesResponse
   */
  public function listReportTypes($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "YouTubeReporting_ListReportTypesResponse");
  }
}
...
class YouTubeReporting_Empty extends Model
{
}

class YouTubeReporting_Job extends Model
{
...
class YouTubeReporting_ListJobsResponse extends Collection
{
  protected $collection_key = 'jobs';
  protected $internal_gapi_mappings = array(
  );
  protected $jobsType = 'YouTubeReporting_Job';
...
class YouTubeReporting_ListReportTypesResponse extends Collection
{
  protected $collection_key = 'reportTypes';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $reportTypesType = 'YouTubeReporting_ReportType';
...
class YouTubeReporting_ListReportsResponse extends Collection
{
  protected $collection_key = 'reports';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $reportsType = 'YouTubeReporting_Report';
...
class YouTubeReporting_Media extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $resourceName;
...
class YouTubeReporting_Report extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $createTime;
...
class YouTubeReporting_ReportType extends Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
